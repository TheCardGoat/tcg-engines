		...
		<div class="grid grid-cols-1 gap-8 lg:grid-cols-4">
			...
			<aside class="space-y-8 lg:col-span-1">
				...
				<div class="rounded-xl border border-slate-700/50 bg-slate-800/50 p-4 backdrop-blur-sm">
					<span class="mb-3 block text-xs font-semibold tracking-wider text-slate-500 uppercase"
						>Logic</span
					>
				...
				<!-- Ink Filter -->
				<div>
					<h3 class="mb-3 text-sm font-semibold tracking-wider text-slate-500 uppercase">Ink</h3>
				...
				<!-- Cost Filter -->
				<div>
					<h3 class="mb-3 text-sm font-semibold tracking-wider text-slate-500 uppercase">Cost</h3>
					<div class="flex flex-wrap gap-2">
						{#each costs as cost}
							<button
				...
				<!-- Type Filter -->
				<div>
					<h3 class="mb-3 text-sm font-semibold tracking-wider text-slate-500 uppercase">Type</h3>
				...
				<!-- Set Filter -->
				<div>
					<h3 class="mb-3 text-sm font-semibold tracking-wider text-slate-500 uppercase">Set</h3>
					<div class="flex flex-col gap-2">
			...
			<section class="lg:col-span-3">
				...
				<div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
					{#each filteredCards.slice(0, 100) as card (card.id)}
						...
						>
							<!-- Image -->
							<div class="relative aspect-[2.5/3.5] overflow-hidden bg-slate-900">
								<CardImage
							...
							<div class="flex flex-1 flex-col gap-2 bg-slate-800 p-4">
								<div>
									...
									{#if card.version}
										<p class="text-xs font-medium text-slate-500">{card.version}</p>
									{/if}
								</div>
