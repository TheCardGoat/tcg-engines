# Lorcana Test Harness Reference

Write focused Bun tests for Lorcana card behavior using the current engine helpers in `packages/lorcana/lorcana-cards`.

This reference supports the canonical
[`lorcana-test-generation`](../SKILL.md) entrypoint. The full card lifecycle is
owned by [`lorcana-cards`](../../lorcana-cards/SKILL.md).

## Contents

- [Required context and scope](#required-memory-step)
- [Imports, harness choice, and fixtures](#imports)
- [Workflow and naming](#quick-workflow)
- [Player API](#player-handle-api-reference)
- [Custom matchers](#custom-matchers-reference)
- [Common patterns](#common-test-patterns)
- [Pitfalls and blocker tests](#pitfalls)
