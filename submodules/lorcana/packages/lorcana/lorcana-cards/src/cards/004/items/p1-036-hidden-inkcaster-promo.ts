...
import { hiddenInkcasterP1PromoI18n } from "./p1-036-hidden-inkcaster-promo.i18n";

export const hiddenInkcasterP1Promo: ItemCard = {
  id: "06I",
  canonicalId: "ci_SVb",
  slug: "lorcana-ci_SVb",
  printings: [
    {
      id: "set4-p1-036-promo",
      artId: "ci_SVb-promo",
      setCode: "set4",
      collectorNumber: "36",
      rarity: "promo",
  ...
  i18n: hiddenInkcasterP1PromoI18n,
};
