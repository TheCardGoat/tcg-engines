...
import { zeusMissingHisSparkP3ChallengeI18n } from "./p3-018-zeus-missing-his-spark-challenge.i18n";

import { boost } from "../../../helpers/abilities/boost";

export const zeusMissingHisSparkP3Challenge: CharacterCard = {
  id: "BPf",
  canonicalId: "ci_sYz",
  slug: "lorcana-ci_sYz",
  printings: [
    {
      id: "set10-p3-018-challenge",
      artId: "ci_sYz-challenge",
      setCode: "set10",
      collectorNumber: "18",
      rarity: "challenge",
      imageUrl: "",
  ...
  i18n: zeusMissingHisSparkP3ChallengeI18n,
};
