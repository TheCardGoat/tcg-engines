...
import { kitCloudkickerToughGuyP1PromoI18n } from "./p1-026-kit-cloudkicker-tough-guy-promo.i18n";

export const kitCloudkickerToughGuyP1Promo: CharacterCard = {
  id: "OeN",
  canonicalId: "ci_tgU",
  slug: "lorcana-ci_tgU",
  printings: [
    {
      id: "set3-p1-026-promo",
      artId: "ci_tgU-promo",
      setCode: "set3",
      collectorNumber: "26",
      rarity: "promo",
  ...
  i18n: kitCloudkickerToughGuyP1PromoI18n,
};
