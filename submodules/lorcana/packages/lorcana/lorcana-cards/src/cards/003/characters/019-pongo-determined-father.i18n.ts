...
export const pongoDeterminedFatherI18n: Record<Languages, I18nProperties> = {
  en: {
    name: "Pongo",
    ...
    text: [
      {
        ...
        description:
          "Una vez por turno, puedes pagar 2 {I} para revelar la carta superior de tu mazo. Si es una carta de personaje, ponla en tu mano. De lo contrario, colóquelo en el fondo de su plataforma.",
      },
    ],
  },
};
