...
export const arielSpectacularSingerI18n: Record<Languages, I18nProperties> = {
  en: {
    name: "Ariel",
  ...
  fr: {
    ...
    text: [
      ...
      },
      {
        ...
        description:
          "Lorsque vous jouez ce personnage, regardez les 4 premières cartes de votre pioche. Vous pouvez révéler une carte chanson parmi elles et l'ajouter à votre main. Remettez les autres sous votre pioche, dans l'ordre de votre choix.",
      },
    ],
  },
  it: {
