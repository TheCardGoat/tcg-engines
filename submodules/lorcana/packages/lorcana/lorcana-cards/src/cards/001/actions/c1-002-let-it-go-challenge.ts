...
import { letItGoC1ChallengeI18n } from "./c1-002-let-it-go-challenge.i18n";

export const letItGoC1Challenge: ActionCard = {
  id: "sDF",
  canonicalId: "ci_xdR",
  slug: "lorcana-ci_xdR",
  printings: [
    {
      id: "set1-c1-002-challenge",
