...
export const cinderellaBallroomSensationEnchantedI18n: Record<Languages, I18nProperties> = {
  en: {
    name: "Cinderella",
  ...
  de: {
    ...
    text: "<Singen> 3 (Die Kosten dieses Charakters gelten als 3 für das Singen von Liedern.)",
  },
  fr: {
    name: "Cendrillon",
