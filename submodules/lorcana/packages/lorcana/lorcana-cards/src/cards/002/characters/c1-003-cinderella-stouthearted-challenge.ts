...
import { cinderellaStoutheartedC1ChallengeI18n } from "./c1-003-cinderella-stouthearted-challenge.i18n";

import { resist } from "../../../helpers/abilities/resist";
import { shift } from "../../../helpers/abilities/shift";

export const cinderellaStoutheartedC1Challenge: CharacterCard = {
  id: "hEZ",
  canonicalId: "ci_T3C",
  slug: "lorcana-ci_T3C",
  printings: [
    {
      id: "set2-c1-003-challenge",
      artId: "ci_T3C-challenge",
      setCode: "set2",
      collectorNumber: "3",
      rarity: "challenge",
      imageUrl: "",
  ...
  i18n: cinderellaStoutheartedC1ChallengeI18n,
};
