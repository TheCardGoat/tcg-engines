...
export const gruesomeAndGrimI18n: Record<Languages, I18nProperties> = {
  en: {
  ...
  fr: {
    ...
    text: [
      ...
      {
        title:
          "Jouez gratuitement un personnage coûtant 4 ou moins. Celui-ci gagne <Charge>. À la fin de votre tour, bannissez-le.",
      },
    ],
  },
  it: {
