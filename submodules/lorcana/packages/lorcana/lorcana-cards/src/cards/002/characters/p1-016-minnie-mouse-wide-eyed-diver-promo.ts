...
import { minnieMouseWideeyedDiverP1PromoI18n } from "./p1-016-minnie-mouse-wide-eyed-diver-promo.i18n";

import { evasive } from "../../../helpers/abilities/evasive";
import { shift } from "../../../helpers/abilities/shift";

export const minnieMouseWideeyedDiverP1Promo: CharacterCard = {
  id: "X42",
  canonicalId: "ci_OUg",
  slug: "lorcana-ci_OUg",
  printings: [
    {
      id: "set2-p1-016-promo",
      artId: "ci_OUg-promo",
      setCode: "set2",
      collectorNumber: "16",
      rarity: "promo",
  ...
  i18n: minnieMouseWideeyedDiverP1PromoI18n,
};
