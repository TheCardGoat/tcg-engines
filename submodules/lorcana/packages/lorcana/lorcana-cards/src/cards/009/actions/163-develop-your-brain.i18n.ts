...
export const developYourBrainI18n: Record<Languages, I18nProperties> = {
  en: {
  ...
  es: {
    name: "Desarrolla tu cerebro",
    text: "Mira las 2 primeras cartas de tu mazo. Pon uno en tu mano y el otro en el fondo de tu mazo.",
  },
};
