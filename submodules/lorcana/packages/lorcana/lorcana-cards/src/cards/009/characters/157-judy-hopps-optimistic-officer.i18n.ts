...
export const judyHoppsOptimisticOfficerI18n: Record<Languages, I18nProperties> = {
  en: {
    name: "Judy Hopps",
    ...
    text: [
      {
        ...
        description:
          "Cuando juegas con este personaje, puedes desterrar el objeto elegido. Si lo haces, su jugador roba una carta.",
      },
    ],
  },
};
