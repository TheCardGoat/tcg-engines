...
import { tinkerBellGiantFairyP3PromoI18n } from "./p3-011-tinker-bell-giant-fairy-promo.i18n";

import { shift } from "../../../helpers/abilities";

export const tinkerBellGiantFairyP3Promo: CharacterCard = {
  id: "Ogs",
  canonicalId: "ci_6gQ",
  slug: "lorcana-ci_6gQ",
  printings: [
    {
      id: "set9-p3-011-promo",
      artId: "ci_6gQ-promo",
      setCode: "set9",
      collectorNumber: "11",
      rarity: "promo",
  ...
  i18n: tinkerBellGiantFairyP3PromoI18n,
};
