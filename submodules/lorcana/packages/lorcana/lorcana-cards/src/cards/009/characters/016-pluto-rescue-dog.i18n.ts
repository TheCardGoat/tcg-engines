...
export const plutoRescueDogI18n: Record<Languages, I18nProperties> = {
  en: {
    name: "Pluto",
    version: "Rescue Dog",
    text: [
    ...
    text: [
      {
        title: "AL RESCATE",
        description:
          "Cuando juegas con este personaje, puedes eliminar hasta 3 daños del personaje que elijas.",
      },
    ],
  },
};
