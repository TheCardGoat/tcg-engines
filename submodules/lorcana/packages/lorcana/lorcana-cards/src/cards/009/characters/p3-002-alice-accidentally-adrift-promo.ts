...
import { aliceAccidentallyAdriftP3PromoI18n } from "./p3-002-alice-accidentally-adrift-promo.i18n";

export const aliceAccidentallyAdriftP3Promo: CharacterCard = {
  id: "zun",
  canonicalId: "ci_IoY",
  slug: "lorcana-ci_IoY",
  printings: [
    {
      id: "set9-p3-002-promo",
      artId: "ci_IoY-promo",
      setCode: "set9",
      collectorNumber: "2",
      rarity: "promo",
  ...
  i18n: aliceAccidentallyAdriftP3PromoI18n,
};
