...
import { goofySetForAdventureP3PromoI18n } from "./p3-039-goofy-set-for-adventure-promo.i18n";

export const goofySetForAdventureP3Promo: CharacterCard = {
  id: "UEJ",
  canonicalId: "ci_uui",
  slug: "lorcana-ci_uui",
  printings: [
    {
      id: "set9-p3-039-promo",
      artId: "ci_uui-promo",
      setCode: "set9",
      collectorNumber: "39",
      rarity: "promo",
  ...
  i18n: goofySetForAdventureP3PromoI18n,
};
