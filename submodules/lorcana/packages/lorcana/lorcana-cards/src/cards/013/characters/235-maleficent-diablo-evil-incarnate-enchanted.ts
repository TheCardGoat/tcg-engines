...
import { maleficentDiabloEvilIncarnateEnchantedI18n } from "./235-maleficent-diablo-evil-incarnate-enchanted.i18n";

import { shift } from "../../../helpers/abilities/shift";

export const maleficentDiabloEvilIncarnateEnchanted: CharacterCard = {
  id: "a1i",
  canonicalId: "ci_yFO",
  slug: "lorcana-ci_yFO",
  printings: [
    {
      id: "set13-235-enchanted",
      artId: "ci_yFO-enchanted",
      setCode: "set13",
      collectorNumber: "235",
      rarity: "enchanted",
      imageUrl: "",
  ...
  i18n: maleficentDiabloEvilIncarnateEnchantedI18n,
};
