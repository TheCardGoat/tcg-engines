...
export const liloPatientWeaverI18n: Record<Languages, I18nProperties> = {
  en: {
    name: "Lilo",
  ...
  it: {
    name: "Lilo",
    version: "Intrecciatrice Paziente",
