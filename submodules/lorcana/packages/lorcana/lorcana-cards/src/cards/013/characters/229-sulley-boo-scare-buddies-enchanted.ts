...
import { sulleyBooScareBuddiesEnchantedI18n } from "./229-sulley-boo-scare-buddies-enchanted.i18n";

import { comboShift } from "../../../helpers/abilities/shift";

export const sulleyBooScareBuddiesEnchanted: CharacterCard = {
  id: "eNg",
  canonicalId: "ci_1Iy",
  slug: "lorcana-ci_1Iy",
  printings: [
    {
      id: "set13-229-enchanted",
      artId: "ci_1Iy-enchanted",
      setCode: "set13",
      collectorNumber: "229",
      rarity: "enchanted",
      imageUrl: "",
  ...
  i18n: sulleyBooScareBuddiesEnchantedI18n,
};
