...
import { merlinEnvisioningTheFutureI18n } from "./146-merlin-envisioning-the-future.i18n";

export const merlinEnvisioningTheFuture: CharacterCard = {
  id: "ZPO",
  canonicalId: "ci_7cP",
  slug: "lorcana-ci_7cP",
  printings: [
  ...
  i18n: merlinEnvisioningTheFutureI18n,
};
