...
import { aladdinGenieMischievousPalsI18n } from "./059-aladdin-genie-mischievous-pals.i18n";

import { shift } from "../../../helpers/abilities/shift";

export const aladdinGenieMischievousPals: CharacterCard = {
  id: "qev",
  canonicalId: "ci_qev",
  slug: "lorcana-ci_qev",
  printings: [
  ...
  i18n: aladdinGenieMischievousPalsI18n,
};
