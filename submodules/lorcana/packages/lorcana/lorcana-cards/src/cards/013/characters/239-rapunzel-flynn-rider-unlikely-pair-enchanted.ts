...
import { rapunzelFlynnRiderUnlikelyPairEnchantedI18n } from "./239-rapunzel-flynn-rider-unlikely-pair-enchanted.i18n";

import { shift } from "../../../helpers/abilities/shift";

export const rapunzelFlynnRiderUnlikelyPairEnchanted: CharacterCard = {
  id: "8NM",
  canonicalId: "ci_xno",
  slug: "lorcana-ci_xno",
  printings: [
    {
      id: "set13-239-enchanted",
      artId: "ci_xno-enchanted",
      setCode: "set13",
      collectorNumber: "239",
      rarity: "enchanted",
      imageUrl: "",
  ...
  i18n: rapunzelFlynnRiderUnlikelyPairEnchantedI18n,
};
