...
import { carlFredricksenRussellIntrepidExplorersEnchantedI18n } from "./237-carl-fredricksen-russell-intrepid-explorers-enchanted.i18n";

import { shift } from "../../../helpers/abilities/shift";

export const carlFredricksenRussellIntrepidExplorersEnchanted: CharacterCard = {
  id: "Lco",
  canonicalId: "ci_QUJ",
  slug: "lorcana-ci_QUJ",
  printings: [
    {
      id: "set13-237-enchanted",
      artId: "ci_QUJ-enchanted",
      setCode: "set13",
      collectorNumber: "237",
      rarity: "enchanted",
      imageUrl: "",
  ...
  i18n: carlFredricksenRussellIntrepidExplorersEnchantedI18n,
};
