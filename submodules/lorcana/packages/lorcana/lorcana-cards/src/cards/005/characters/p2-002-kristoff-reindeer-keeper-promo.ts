...
import { kristoffReindeerKeeperP2PromoI18n } from "./p2-002-kristoff-reindeer-keeper-promo.i18n";

import { bodyguard } from "../../../helpers/abilities/bodyguard";

export const kristoffReindeerKeeperP2Promo: CharacterCard = {
  id: "2wu",
  canonicalId: "ci_8g7",
  slug: "lorcana-ci_8g7",
  printings: [
    {
      id: "set5-p2-002-promo",
      artId: "ci_8g7-promo",
      setCode: "set5",
      collectorNumber: "2",
      rarity: "promo",
  ...
  i18n: kristoffReindeerKeeperP2PromoI18n,
};
