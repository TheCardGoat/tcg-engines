...
import { beastSnowfieldTroublemakerPD1PromoI18n } from "./pd1-001-beast-snowfield-troublemaker-promo.i18n";

import { rush } from "../../../helpers/abilities/rush";

export const beastSnowfieldTroublemakerPD1Promo: CharacterCard = {
  id: "Moh",
  canonicalId: "ci_dg5",
  slug: "lorcana-ci_dg5",
  printings: [
    {
      id: "set11-pd1-001-promo",
      artId: "ci_dg5-promo",
      setCode: "set11",
      collectorNumber: "1",
      rarity: "promo",
  ...
  i18n: beastSnowfieldTroublemakerPD1PromoI18n,
};
