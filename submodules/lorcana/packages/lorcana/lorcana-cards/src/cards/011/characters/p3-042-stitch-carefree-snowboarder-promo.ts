...
import { stitchCarefreeSnowboarderP3PromoI18n } from "./p3-042-stitch-carefree-snowboarder-promo.i18n";

export const stitchCarefreeSnowboarderP3Promo: CharacterCard = {
  id: "01A",
  canonicalId: "ci_vWQ",
  slug: "lorcana-ci_vWQ",
  printings: [
    {
      id: "set11-p3-042-promo",
      artId: "ci_vWQ-promo",
      setCode: "set11",
      collectorNumber: "42",
      rarity: "promo",
  ...
  i18n: stitchCarefreeSnowboarderP3PromoI18n,
};
