...
export const agustinMadrigalExceptionallyKindI18n: Record<Languages, I18nProperties> = {
  en: {
  ...
  de: {
    ...
    version: "Außergewöhnlich freundlich",
  ...
  fr: {
    name: "Agustín Madrigal",
    version: "D'une gentillesse exceptionnelle",
