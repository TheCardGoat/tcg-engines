...
export const jockAttentiveUncleI18n: Record<Languages, I18nProperties> = {
  en: {
    name: "Jock",
  ...
  es: {
    ...
    text: [
      {
        title: "VOZ DE EXPERIENCIA",
        description:
          "Cuando juegas con este personaje, si tienes 3 o más personajes en juego, obtienes 2 conocimientos.",
      },
    ],
  },
};
