...
export const flashFreeze: GrandArchiveCard<GrandArchiveAbilityDefinition, "card"> = {
  canonicalId: "w3rrii17fz",
  slug: "flash-freeze",
  definitionKind: "card",
  layout: {
    kind: "single-faced",
    face: {
      id: "w3rrii17fz:face:default",
      catalogId: "w3rrii17fz",
      name: "Flash Freeze",
      cost: {
        kind: "reserve",
        amount: 4,
      ...
      abilities: [
        ...
        },
        {
          ...
          text: "Negate target card activation unless its controller pays (LV). Banish the card that had its activation negated this way.",
          targets: [
            {
