...
export const namelessChampionMr: GrandArchiveCard<GrandArchiveAbilityDefinition, "card"> = {
  canonicalId: "9tmr8iel1m",
  slug: "nameless-champion-mr",
  definitionKind: "card",
  layout: {
    kind: "single-faced",
    face: {
      id: "9tmr8iel1m:face:default",
      catalogId: "9tmr8iel1m",
...
export default namelessChampionMr;
