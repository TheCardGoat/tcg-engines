...
export const namelessChampionCw: GrandArchiveCard<GrandArchiveAbilityDefinition, "card"> = {
  canonicalId: "f4rlv5dsrb",
  slug: "nameless-champion-cw",
  definitionKind: "card",
  layout: {
    kind: "single-faced",
    face: {
      id: "f4rlv5dsrb:face:default",
      catalogId: "f4rlv5dsrb",
...
export default namelessChampionCw;
