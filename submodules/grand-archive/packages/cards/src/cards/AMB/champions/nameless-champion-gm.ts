...
export const namelessChampionGm: GrandArchiveCard<GrandArchiveAbilityDefinition, "card"> = {
  canonicalId: "as8yfa8ptg",
  slug: "nameless-champion-gm",
  definitionKind: "card",
  layout: {
    kind: "single-faced",
    face: {
      id: "as8yfa8ptg:face:default",
      catalogId: "as8yfa8ptg",
...
export default namelessChampionGm;
