...
export const namelessChampionAc: GrandArchiveCard<GrandArchiveAbilityDefinition, "card"> = {
  canonicalId: "86flbytki3",
  slug: "nameless-champion-ac",
  definitionKind: "card",
  layout: {
    kind: "single-faced",
    face: {
      id: "86flbytki3:face:default",
      catalogId: "86flbytki3",
...
export default namelessChampionAc;
