...
export const namelessChampionAt: GrandArchiveCard<GrandArchiveAbilityDefinition, "card"> = {
  canonicalId: "0794z3ffck",
  slug: "nameless-champion-at",
  definitionKind: "card",
  layout: {
    kind: "single-faced",
    face: {
      id: "0794z3ffck:face:default",
      catalogId: "0794z3ffck",
...
export default namelessChampionAt;
