...
export const namelessChampionGt: GrandArchiveCard<GrandArchiveAbilityDefinition, "card"> = {
  canonicalId: "nq6nhjy85f",
  slug: "nameless-champion-gt",
  definitionKind: "card",
  layout: {
    kind: "single-faced",
    face: {
      id: "nq6nhjy85f:face:default",
      catalogId: "nq6nhjy85f",
...
export default namelessChampionGt;
