...
export const namelessChampionMw: GrandArchiveCard<GrandArchiveAbilityDefinition, "card"> = {
  canonicalId: "thaqwi9apy",
  slug: "nameless-champion-mw",
  definitionKind: "card",
  layout: {
    kind: "single-faced",
    face: {
      id: "thaqwi9apy:face:default",
      catalogId: "thaqwi9apy",
...
export default namelessChampionMw;
