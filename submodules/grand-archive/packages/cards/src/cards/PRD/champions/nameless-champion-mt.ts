...
export const namelessChampionMt: GrandArchiveCard<GrandArchiveAbilityDefinition, "card"> = {
  canonicalId: "K7jYO9IibV",
  slug: "nameless-champion-mt",
  definitionKind: "card",
  layout: {
    kind: "single-faced",
    face: {
      id: "K7jYO9IibV:face:default",
      catalogId: "K7jYO9IibV",
...
export default namelessChampionMt;
