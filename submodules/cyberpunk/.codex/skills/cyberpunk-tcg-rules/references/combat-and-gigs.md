...
- Remember that ready Units do not automatically protect Gigs. They only interfere with attacks if they have `BLOCKER` or another explicit effect.
...
3. Give the defender a chance to call a Legend or assign a ready `BLOCKER`.
