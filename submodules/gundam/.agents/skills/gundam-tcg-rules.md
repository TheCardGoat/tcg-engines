...
Treat the comprehensive rules document at `./gundam-rules.md` (Ver. 1.5.0) as the source of truth for the current rules. Keep the glossary in this file in working context for every substantive task in this repository, then load only the matching reference files for the mechanic you are touching.
...
- Source document: `./gundam-rules.md`
