# Gundam Card Game Comprehensive Rules Ver. 1.7.0
...
1-3-7. Unless specified otherwise, a card’s effects are performed in the order they

appear in the text on the card.
...
2-5-4. Traits are typically found on Unit, Pilot, and Base cards, as well as
...
3-2-6-1. These are conditions that are necessary to create a Link Unit, such as

Pilot names or traits.
...
3-3-9-2-1. If an effect specifies a location such as the hand or trash where

it activates, the Pilot card activates that effect.
...
3-4-5. 【Main】 and 【Action】 timing on command effects show when they canbe played. (See 12-2. Keywords)
...
4-6-4. The cards that become your Shields are placed face down in the shield
...
5-17-3-1. EX Base 5-17-3-1-1. An EX Base is a Base token with 0 AP and 3 HP.
...
10-1-5-6. When multiple constant effects with conflicting contents are active,

effects that state other effects “can’t” have an effect, or otherwise disallow them, take precedence.
...
10-1-7-2. When an activated effect’s timing permits activation, satisfying the actions described before the colon will activate the effect described
...
10-1-7-4. Some activated effects have two or more conditions which appear as
...
12-3-4. Team members are free to share information and strategies. If there is a

disagreement, the team leader has the final say.
...
12-3-14-1. If the battle area is at its upper limit when a Unit card is being played or a Unit is being deployed by an effect, choose one of the team’s Units already in the battle area and place it into its owner’s
...
13-2-10-2. 【During Pair】 can appear as “【During Pair･(qualifications)】 (text).” This means while a Pilot fulfilling the (qualifications) is paired

with this Unit, perform (text).
