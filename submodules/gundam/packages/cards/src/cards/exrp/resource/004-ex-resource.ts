...
export const exrpExResource004: ResourceCard = {
  cardNumber: "EXRP-004",
  name: "EX Resource",
  type: "resource",
  traits: [],
  ...
  printings: [
    {
      ...
      rarity: "promo",
      finish: "standard",
      imageUrl: "https://cdn.tcg.online/public/gundam/cards/exrp/EXRP-004.webp",
      productName:
...
export const pc01aExResource004 = exrpExResource004;
