...
import { op12SilversRayleigh001I18n } from "./op12-001-silvers-rayleigh.i18n.ts";

export const op12SilversRayleigh001: LeaderCard = {
  id: "OP12-001",
  canonicalId: "OP12-001",
  slug: "silvers-rayleigh/op12-001",
  ...
  printings: [
    {
      ...
      collectorNumber: "001",
      rarity: "L",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP12-001_084ObtK.jpg",
    },
    {
      id: "OP12-001_p1",
      artId: "OP12-001_p1",
