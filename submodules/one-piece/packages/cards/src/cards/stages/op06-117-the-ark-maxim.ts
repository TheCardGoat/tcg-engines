...
import { op06TheArkMaxim117I18n } from "./op06-117-the-ark-maxim.i18n.ts";

export const op06TheArkMaxim117: StageCard = {
  id: "OP06-117",
  canonicalId: "OP06-117",
  slug: "the-ark-maxim",
  name: "The Ark Maxim",
  printings: [
    {
      ...
      collectorNumber: "117",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP06-117.jpg",
    },
  ],
  cardType: "stage",
  color: ["yellow"],
