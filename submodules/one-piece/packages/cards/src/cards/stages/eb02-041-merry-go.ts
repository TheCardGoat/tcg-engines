...
import { eb02MerryGo041I18n } from "./eb02-041-merry-go.i18n.ts";

export const eb02MerryGo041: StageCard = {
  id: "EB02-041",
  canonicalId: "EB02-041",
  slug: "merry-go/eb02-041",
  name: "Merry Go",
  printings: [
    {
      id: "EB02-041",
      ...
      collectorNumber: "041",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/EB02-041.jpg",
    },
  ],
  cardType: "stage",
  color: ["purple"],
