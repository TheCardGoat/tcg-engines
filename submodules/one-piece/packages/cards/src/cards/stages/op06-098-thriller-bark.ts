...
import { op06ThrillerBark098I18n } from "./op06-098-thriller-bark.i18n.ts";

export const op06ThrillerBark098: StageCard = {
  id: "OP06-098",
  canonicalId: "OP06-098",
  slug: "thriller-bark",
  name: "Thriller Bark",
  printings: [
    {
      ...
      collectorNumber: "098",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP06-098.jpg",
    },
  ],
  cardType: "stage",
  color: ["black"],
