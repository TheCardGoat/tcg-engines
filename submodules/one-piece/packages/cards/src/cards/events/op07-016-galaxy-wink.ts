...
import { op07GalaxyWink016I18n } from "./op07-016-galaxy-wink.i18n.ts";

export const op07GalaxyWink016: EventCard = {
  id: "OP07-016",
  canonicalId: "OP07-016",
  slug: "galaxy-wink",
  name: "Galaxy Wink",
  printings: [
    {
      ...
      collectorNumber: "016",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP07-016.jpg",
    },
  ],
  cardType: "event",
  color: ["red"],
