...
import { op08Heliceratops097I18n } from "./op08-097-heliceratops.i18n.ts";

export const op08Heliceratops097: EventCard = {
  id: "OP08-097",
  canonicalId: "OP08-097",
  slug: "heliceratops",
  name: "Heliceratops",
  printings: [
    {
      ...
      collectorNumber: "097",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP08-097.jpg",
    },
  ],
  cardType: "event",
  color: ["black"],
