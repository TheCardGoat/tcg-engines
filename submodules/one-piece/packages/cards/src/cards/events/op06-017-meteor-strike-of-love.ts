...
import { op06MeteorStrikeOfLove017I18n } from "./op06-017-meteor-strike-of-love.i18n.ts";

export const op06MeteorStrikeOfLove017: EventCard = {
  id: "OP06-017",
  canonicalId: "OP06-017",
  slug: "meteor-strike-of-love",
  ...
  printings: [
    {
      ...
      collectorNumber: "017",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP06-017.jpg",
    },
  ],
  cardType: "event",
  color: ["red"],
