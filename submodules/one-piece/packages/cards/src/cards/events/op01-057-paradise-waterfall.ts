...
import { op01ParadiseWaterfall057I18n } from "./op01-057-paradise-waterfall.i18n.ts";

export const op01ParadiseWaterfall057: EventCard = {
  id: "OP01-057",
  canonicalId: "OP01-057",
  slug: "paradise-waterfall",
  ...
  printings: [
    {
      ...
      collectorNumber: "057",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP01-057.jpg",
    },
  ],
  cardType: "event",
  color: ["green"],
