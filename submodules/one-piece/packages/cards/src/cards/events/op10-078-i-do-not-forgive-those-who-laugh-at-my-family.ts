...
import { op10IDoNotForgiveThoseWhoLaughAtMyFamily078I18n } from "./op10-078-i-do-not-forgive-those-who-laugh-at-my-family.i18n.ts";

export const op10IDoNotForgiveThoseWhoLaughAtMyFamily078: EventCard = {
  id: "OP10-078",
  canonicalId: "OP10-078",
  slug: "i-do-not-forgive-those-who-laugh-at-my-family",
  ...
  printings: [
    {
      ...
      collectorNumber: "078",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP10-078.jpg",
    },
  ],
  cardType: "event",
  color: ["purple"],
