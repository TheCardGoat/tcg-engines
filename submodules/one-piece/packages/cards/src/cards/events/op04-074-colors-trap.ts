...
import { op04ColorsTrap074I18n } from "./op04-074-colors-trap.i18n.ts";

export const op04ColorsTrap074: EventCard = {
  id: "OP04-074",
  canonicalId: "OP04-074",
  slug: "colors-trap",
  name: "Colors Trap",
  printings: [
    {
      ...
      collectorNumber: "074",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP04-074.jpg",
    },
  ],
  cardType: "event",
  color: ["purple"],
