...
import { op03DeathlyPoisonGasBombMh5038I18n } from "./op03-038-deathly-poison-gas-bomb-mh5.i18n.ts";

export const op03DeathlyPoisonGasBombMh5038: EventCard = {
  id: "OP03-038",
  canonicalId: "OP03-038",
  slug: "deathly-poison-gas-bomb-mh5",
  ...
  printings: [
    {
      ...
      collectorNumber: "038",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP03-038.jpg",
    },
  ],
  cardType: "event",
  color: ["green"],
