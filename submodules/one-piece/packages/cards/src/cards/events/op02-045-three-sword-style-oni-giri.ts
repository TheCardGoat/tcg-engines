...
import { op02ThreeSwordStyleOniGiri045I18n } from "./op02-045-three-sword-style-oni-giri.i18n.ts";

export const op02ThreeSwordStyleOniGiri045: EventCard = {
  id: "OP02-045",
  canonicalId: "OP02-045",
  slug: "three-sword-style-oni-giri",
  ...
  printings: [
    {
      ...
      collectorNumber: "045",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP02-045.jpg",
    },
  ],
  cardType: "event",
  color: ["green"],
