...
import { op02ParadiseTotsuka047I18n } from "./op02-047-paradise-totsuka.i18n.ts";

export const op02ParadiseTotsuka047: EventCard = {
  id: "OP02-047",
  canonicalId: "OP02-047",
  slug: "paradise-totsuka",
  ...
  printings: [
    {
      ...
      collectorNumber: "047",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP02-047.jpg",
    },
  ],
  cardType: "event",
  color: ["green"],
