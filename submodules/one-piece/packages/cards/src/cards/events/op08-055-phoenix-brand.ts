...
import { op08PhoenixBrand055I18n } from "./op08-055-phoenix-brand.i18n.ts";

export const op08PhoenixBrand055: EventCard = {
  id: "OP08-055",
  canonicalId: "OP08-055",
  slug: "phoenix-brand",
  name: "Phoenix Brand",
  printings: [
    {
      ...
      collectorNumber: "055",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP08-055.jpg",
    },
  ],
  cardType: "event",
  color: ["blue"],
