...
import { op12Concasser059I18n } from "./op12-059-concasser.i18n.ts";

export const op12Concasser059: EventCard = {
  id: "OP12-059",
  canonicalId: "OP12-059",
  slug: "concasser",
  name: "Concasser",
  printings: [
    {
      ...
      collectorNumber: "059",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP12-059_mD2d62p.jpg",
    },
  ],
  cardType: "event",
  color: ["blue"],
