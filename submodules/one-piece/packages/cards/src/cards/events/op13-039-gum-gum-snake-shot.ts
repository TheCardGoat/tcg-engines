...
import { op13GumGumSnakeShot039I18n } from "./op13-039-gum-gum-snake-shot.i18n.ts";

export const op13GumGumSnakeShot039: EventCard = {
  id: "OP13-039",
  canonicalId: "OP13-039",
  slug: "gum-gum-snake-shot",
  ...
  printings: [
    {
      ...
      collectorNumber: "039",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP13-039_kalbkOx.jpg",
    },
  ],
  cardType: "event",
  color: ["green"],
