...
import { op04TheWeakDoNotHaveTheRightToChooseHowTheyDie038I18n } from "./op04-038-the-weak-do-not-have-the-right-to-choose-how-they-die.i18n.ts";

export const op04TheWeakDoNotHaveTheRightToChooseHowTheyDie038: EventCard = {
  id: "OP04-038",
  canonicalId: "OP04-038",
  slug: "the-weak-do-not-have-the-right-to-choose-how-they-die/op04-038",
  ...
  printings: [
    {
      ...
      collectorNumber: "038",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP04-038.jpg",
    },
  ],
  cardType: "event",
  color: ["green"],
