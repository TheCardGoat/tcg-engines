...
import { op03ToothAttack037I18n } from "./op03-037-tooth-attack.i18n.ts";

export const op03ToothAttack037: EventCard = {
  id: "OP03-037",
  canonicalId: "OP03-037",
  slug: "tooth-attack",
  name: "Tooth Attack",
  printings: [
    {
      ...
      collectorNumber: "037",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP03-037.jpg",
    },
  ],
  cardType: "event",
  color: ["green"],
