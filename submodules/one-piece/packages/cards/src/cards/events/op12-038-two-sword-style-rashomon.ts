...
import { op12TwoSwordStyleRashomon038I18n } from "./op12-038-two-sword-style-rashomon.i18n.ts";

export const op12TwoSwordStyleRashomon038: EventCard = {
  id: "OP12-038",
  canonicalId: "OP12-038",
  slug: "two-sword-style-rashomon",
  ...
  printings: [
    {
      ...
      collectorNumber: "038",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP12-038_XRTDA0A.jpg",
    },
  ],
  cardType: "event",
  color: ["green"],
