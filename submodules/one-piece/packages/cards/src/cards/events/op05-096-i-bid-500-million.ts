...
import { op05IBid500Million096I18n } from "./op05-096-i-bid-500-million.i18n.ts";

export const op05IBid500Million096: EventCard = {
  id: "OP05-096",
  canonicalId: "OP05-096",
  slug: "i-bid-500-million",
  ...
  printings: [
    {
      ...
      collectorNumber: "096",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP05-096.jpg",
    },
  ],
  cardType: "event",
  color: ["black"],
