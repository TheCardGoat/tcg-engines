...
import { op05FourThousandBrickFist020I18n } from "./op05-020-four-thousand-brick-fist.i18n.ts";

export const op05FourThousandBrickFist020: EventCard = {
  id: "OP05-020",
  canonicalId: "OP05-020",
  slug: "four-thousand-brick-fist",
  ...
  printings: [
    {
      ...
      collectorNumber: "020",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP05-020.jpg",
    },
  ],
  cardType: "event",
  color: ["red"],
