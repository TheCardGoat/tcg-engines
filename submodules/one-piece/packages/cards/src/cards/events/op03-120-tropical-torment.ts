...
import { op03TropicalTorment120I18n } from "./op03-120-tropical-torment.i18n.ts";

export const op03TropicalTorment120: EventCard = {
  id: "OP03-120",
  canonicalId: "OP03-120",
  slug: "tropical-torment",
  ...
  printings: [
    {
      ...
      collectorNumber: "120",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP03-120.jpg",
    },
  ],
  cardType: "event",
  color: ["yellow"],
