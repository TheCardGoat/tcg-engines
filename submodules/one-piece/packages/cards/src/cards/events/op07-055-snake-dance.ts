...
import { op07SnakeDance055I18n } from "./op07-055-snake-dance.i18n.ts";

export const op07SnakeDance055: EventCard = {
  id: "OP07-055",
  canonicalId: "OP07-055",
  slug: "snake-dance",
  name: "Snake Dance",
  printings: [
    {
      ...
      collectorNumber: "055",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP07-055.jpg",
    },
  ],
  cardType: "event",
  color: ["blue"],
