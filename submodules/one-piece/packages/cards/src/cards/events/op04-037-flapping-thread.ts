...
import { op04FlappingThread037I18n } from "./op04-037-flapping-thread.i18n.ts";

export const op04FlappingThread037: EventCard = {
  id: "OP04-037",
  canonicalId: "OP04-037",
  slug: "flapping-thread",
  ...
  printings: [
    {
      ...
      collectorNumber: "037",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP04-037.jpg",
    },
  ],
  cardType: "event",
  color: ["green"],
