...
import { eb01SorryIMAGoner029I18n } from "./eb01-029-sorry-i-m-a-goner.i18n.ts";

export const eb01SorryIMAGoner029: EventCard = {
  id: "EB01-029",
  canonicalId: "EB01-029",
  slug: "sorry-i-m-a-goner",
  ...
  printings: [
    {
      ...
      collectorNumber: "029",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/EB01-029.jpg",
    },
  ],
  cardType: "event",
  color: ["blue"],
