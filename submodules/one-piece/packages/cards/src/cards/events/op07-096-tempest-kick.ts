...
import { op07TempestKick096I18n } from "./op07-096-tempest-kick.i18n.ts";

export const op07TempestKick096: EventCard = {
  id: "OP07-096",
  canonicalId: "OP07-096",
  slug: "tempest-kick",
  name: "Tempest Kick",
  printings: [
    {
      ...
      collectorNumber: "096",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP07-096.jpg",
    },
  ],
  cardType: "event",
  color: ["black"],
