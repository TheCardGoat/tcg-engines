...
import { op01InTwoYearsAtTheSabaodyArchipelago030I18n } from "./op01-030-in-two-years-at-the-sabaody-archipelago.i18n.ts";

export const op01InTwoYearsAtTheSabaodyArchipelago030: EventCard = {
  id: "OP01-030",
  canonicalId: "OP01-030",
  slug: "in-two-years-at-the-sabaody-archipelago",
  ...
  printings: [
    {
      ...
      collectorNumber: "030",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP01-030.jpg",
    },
  ],
  cardType: "event",
  color: ["red"],
