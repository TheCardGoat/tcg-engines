...
import { op02WhitebeardPirates022I18n } from "./op02-022-whitebeard-pirates.i18n.ts";

export const op02WhitebeardPirates022: EventCard = {
  id: "OP02-022",
  canonicalId: "OP02-022",
  ...
  printings: [
    {
      ...
      collectorNumber: "022",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP02-022.jpg",
    },
  ],
  cardType: "event",
  color: ["red"],
