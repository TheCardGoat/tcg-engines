...
import { eb03IKnewYouPeopleWereBehindThis049I18n } from "./eb03-049-i-knew-you-people-were-behind-this.i18n.ts";

export const eb03IKnewYouPeopleWereBehindThis049: EventCard = {
  id: "EB03-049",
  canonicalId: "EB03-049",
  slug: "i-knew-you-people-were-behind-this",
  ...
  printings: [
    {
      ...
      collectorNumber: "049",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/EB03-049_pm5E11N.jpg",
    },
  ],
  cardType: "event",
  color: ["black"],
