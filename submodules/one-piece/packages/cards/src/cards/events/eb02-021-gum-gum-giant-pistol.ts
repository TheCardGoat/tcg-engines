...
import { eb02GumGumGiantPistol021I18n } from "./eb02-021-gum-gum-giant-pistol.i18n.ts";

export const eb02GumGumGiantPistol021: EventCard = {
  id: "EB02-021",
  canonicalId: "EB02-021",
  slug: "gum-gum-giant-pistol",
  ...
  printings: [
    {
      ...
      collectorNumber: "021",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/EB02-021.jpg",
    },
  ],
  cardType: "event",
  color: ["green"],
