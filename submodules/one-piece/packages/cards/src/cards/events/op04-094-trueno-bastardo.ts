...
import { op04TruenoBastardo094I18n } from "./op04-094-trueno-bastardo.i18n.ts";

export const op04TruenoBastardo094: EventCard = {
  id: "OP04-094",
  canonicalId: "OP04-094",
  slug: "trueno-bastardo",
  ...
  printings: [
    {
      ...
      collectorNumber: "094",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP04-094.jpg",
    },
  ],
  cardType: "event",
  color: ["black"],
