...
import { op04DragonTwisterDemolitionBreath057I18n } from "./op04-057-dragon-twister-demolition-breath.i18n.ts";

export const op04DragonTwisterDemolitionBreath057: EventCard = {
  id: "OP04-057",
  canonicalId: "OP04-057",
  slug: "dragon-twister-demolition-breath",
  ...
  printings: [
    {
      ...
      collectorNumber: "057",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP04-057.jpg",
    },
  ],
  cardType: "event",
  color: ["blue"],
