...
import { op04WeaknessIsAnUnforgivableSin076I18n } from "./op04-076-weakness-is-an-unforgivable-sin.i18n.ts";

export const op04WeaknessIsAnUnforgivableSin076: EventCard = {
  id: "OP04-076",
  canonicalId: "OP04-076",
  slug: "weakness-is-an-unforgivable-sin",
  ...
  printings: [
    {
      ...
      collectorNumber: "076",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP04-076.jpg",
    },
  ],
  cardType: "event",
  color: ["purple"],
