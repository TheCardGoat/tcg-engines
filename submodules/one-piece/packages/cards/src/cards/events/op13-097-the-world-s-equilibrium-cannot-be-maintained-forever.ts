...
import { op13TheWorldSEquilibriumCannotBeMaintainedForever097I18n } from "./op13-097-the-world-s-equilibrium-cannot-be-maintained-forever.i18n.ts";

export const op13TheWorldSEquilibriumCannotBeMaintainedForever097: EventCard = {
  id: "OP13-097",
  canonicalId: "OP13-097",
  slug: "the-world-s-equilibrium-cannot-be-maintained-forever",
  ...
  printings: [
    {
      ...
      collectorNumber: "097",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP13-097_w3lAhtv.jpg",
    },
  ],
  cardType: "event",
  color: ["black"],
