...
import { op03IkokuSovereignty118I18n } from "./op03-118-ikoku-sovereignty.i18n.ts";

export const op03IkokuSovereignty118: EventCard = {
  id: "OP03-118",
  canonicalId: "OP03-118",
  slug: "ikoku-sovereignty",
  ...
  printings: [
    {
      ...
      collectorNumber: "118",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP03-118.jpg",
    },
  ],
  cardType: "event",
  color: ["yellow"],
