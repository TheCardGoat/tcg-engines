...
import { op01GreenStarRafflesia028I18n } from "./op01-028-green-star-rafflesia.i18n.ts";

export const op01GreenStarRafflesia028: EventCard = {
  id: "OP01-028",
  canonicalId: "OP01-028",
  slug: "green-star-rafflesia",
  ...
  printings: [
    {
      ...
      collectorNumber: "028",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP01-028.jpg",
    },
  ],
  cardType: "event",
  color: ["red"],
