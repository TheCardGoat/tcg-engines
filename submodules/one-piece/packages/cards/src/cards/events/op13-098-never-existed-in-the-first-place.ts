...
import { op13NeverExistedInTheFirstPlace098I18n } from "./op13-098-never-existed-in-the-first-place.i18n.ts";

export const op13NeverExistedInTheFirstPlace098: EventCard = {
  id: "OP13-098",
  canonicalId: "OP13-098",
  slug: "never-existed-in-the-first-place",
  ...
  printings: [
    {
      ...
      collectorNumber: "098",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP13-098_HPLmiCG.jpg",
    },
  ],
  cardType: "event",
  color: ["black"],
