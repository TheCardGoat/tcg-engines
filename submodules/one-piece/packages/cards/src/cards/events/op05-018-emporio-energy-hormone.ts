...
import { op05EmporioEnergyHormone018I18n } from "./op05-018-emporio-energy-hormone.i18n.ts";

export const op05EmporioEnergyHormone018: EventCard = {
  id: "OP05-018",
  canonicalId: "OP05-018",
  slug: "emporio-energy-hormone",
  ...
  printings: [
    {
      ...
      collectorNumber: "018",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP05-018.jpg",
    },
  ],
  cardType: "event",
  color: ["red"],
