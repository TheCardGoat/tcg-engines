...
import { op05StickStickemMeteora039I18n } from "./op05-039-stick-stickem-meteora.i18n.ts";

export const op05StickStickemMeteora039: EventCard = {
  id: "OP05-039",
  canonicalId: "OP05-039",
  slug: "stick-stickem-meteora",
  ...
  printings: [
    {
      ...
      collectorNumber: "039",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP05-039.jpg",
    },
  ],
  cardType: "event",
  color: ["green"],
