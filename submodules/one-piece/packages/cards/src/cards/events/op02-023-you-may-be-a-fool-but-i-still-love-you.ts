...
import { op02YouMayBeAFoolButIStillLoveYou023I18n } from "./op02-023-you-may-be-a-fool-but-i-still-love-you.i18n.ts";

export const op02YouMayBeAFoolButIStillLoveYou023: EventCard = {
  id: "OP02-023",
  canonicalId: "OP02-023",
  slug: "you-may-be-a-fool-but-i-still-love-you",
  ...
  printings: [
    {
      ...
      collectorNumber: "023",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP02-023.jpg",
    },
  ],
  cardType: "event",
  color: ["red"],
