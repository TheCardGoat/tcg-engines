...
import { op10Trebol070I18n } from "./op10-070-trebol.i18n.ts";

export const op10Trebol070: CharacterCard = {
  id: "OP10-070",
  canonicalId: "OP10-070",
  slug: "trebol/op10-070",
  name: "Trebol",
  printings: [
    {
      id: "OP10-070",
      ...
      collectorNumber: "070",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP10-070.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
