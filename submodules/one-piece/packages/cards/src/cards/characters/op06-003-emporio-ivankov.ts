...
import { op06EmporioIvankov003I18n } from "./op06-003-emporio-ivankov.i18n.ts";

export const op06EmporioIvankov003: CharacterCard = {
  id: "OP06-003",
  canonicalId: "OP06-003",
  slug: "emporio-ivankov/op06-003",
  ...
  printings: [
    {
      ...
      collectorNumber: "003",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP06-003.jpg",
    },
    {
      id: "OP06-003_p2",
      artId: "OP06-003_p2",
    ...
    },
    {
      ...
      label: "Emporio.Ivankov (Full Art)",
    },
    {
      id: "OP06-003_r1",
      artId: "OP06-003_r1",
      ...
      collectorNumber: "003",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP06-003_r1.jpg",
    },
  ],
  cardType: "character",
  color: ["red"],
