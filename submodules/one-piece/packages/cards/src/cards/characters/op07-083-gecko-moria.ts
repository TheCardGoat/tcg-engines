...
import { op07GeckoMoria083I18n } from "./op07-083-gecko-moria.i18n.ts";

export const op07GeckoMoria083: CharacterCard = {
  id: "OP07-083",
  canonicalId: "OP07-083",
  slug: "gecko-moria/op07-083",
  name: "Gecko Moria",
  printings: [
    {
      id: "OP07-083",
      ...
      collectorNumber: "083",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP07-083.jpg",
    },
  ],
  cardType: "character",
  color: ["black"],
