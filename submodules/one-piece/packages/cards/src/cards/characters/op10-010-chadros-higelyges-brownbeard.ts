...
import { op10ChadrosHigelygesBrownbeard010I18n } from "./op10-010-chadros-higelyges-brownbeard.i18n.ts";

export const op10ChadrosHigelygesBrownbeard010: CharacterCard = {
  id: "OP10-010",
  canonicalId: "OP10-010",
  slug: "chadros-higelyges-brownbeard",
  ...
  printings: [
    {
      ...
      collectorNumber: "010",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP10-010.jpg",
    },
  ],
  cardType: "character",
  color: ["red"],
