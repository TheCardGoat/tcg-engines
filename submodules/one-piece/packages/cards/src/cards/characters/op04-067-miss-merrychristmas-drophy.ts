...
import { op04MissMerrychristmasDrophy067I18n } from "./op04-067-miss-merrychristmas-drophy.i18n.ts";

export const op04MissMerrychristmasDrophy067: CharacterCard = {
  id: "OP04-067",
  canonicalId: "OP04-067",
  slug: "miss-merrychristmas-drophy/op04-067",
  ...
  printings: [
    {
      ...
      collectorNumber: "067",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP04-067.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
