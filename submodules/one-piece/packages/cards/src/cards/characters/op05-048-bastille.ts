...
import { op05Bastille048I18n } from "./op05-048-bastille.i18n.ts";

export const op05Bastille048: CharacterCard = {
  id: "OP05-048",
  canonicalId: "OP05-048",
  slug: "bastille/op05-048",
  name: "Bastille",
  printings: [
    {
      id: "OP05-048",
      ...
      collectorNumber: "048",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP05-048.jpg",
    },
  ],
  cardType: "character",
  color: ["blue"],
