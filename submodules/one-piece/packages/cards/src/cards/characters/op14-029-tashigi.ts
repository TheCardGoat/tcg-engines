...
import { op14eb04Tashigi029I18n } from "./op14-029-tashigi.i18n.ts";

export const op14eb04Tashigi029: CharacterCard = {
  id: "OP14-029",
  canonicalId: "OP14-029",
  slug: "tashigi/op14-029",
  name: "Tashigi",
  printings: [
    {
      id: "OP14-029",
      ...
      collectorNumber: "029",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP14-029_MfInjhQ.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
