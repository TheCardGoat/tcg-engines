...
import { op11Carrot049I18n } from "./op11-049-carrot.i18n.ts";

export const op11Carrot049: CharacterCard = {
  id: "OP11-049",
  canonicalId: "OP11-049",
  slug: "carrot/op11-049",
  name: "Carrot",
  printings: [
    {
      id: "OP11-049",
      ...
      collectorNumber: "049",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP11-049.jpg",
    },
  ],
  cardType: "character",
  color: ["blue"],
