...
import { op05NefeltariCobra085I18n } from "./op05-085-nefeltari-cobra.i18n.ts";

export const op05NefeltariCobra085: CharacterCard = {
  id: "OP05-085",
  canonicalId: "OP05-085",
  slug: "nefeltari-cobra/op05-085",
  ...
  printings: [
    {
      ...
      collectorNumber: "085",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP05-085.jpg",
    },
  ],
  cardType: "character",
  color: ["black"],
