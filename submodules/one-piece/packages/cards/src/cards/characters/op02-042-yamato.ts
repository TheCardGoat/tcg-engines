...
import { op02Yamato042I18n } from "./op02-042-yamato.i18n.ts";

export const op02Yamato042: CharacterCard = {
  id: "OP02-042",
  canonicalId: "OP02-042",
  slug: "yamato/op02-042",
  name: "Yamato",
  printings: [
    {
      id: "OP02-042",
      ...
      collectorNumber: "042",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP02-042.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
