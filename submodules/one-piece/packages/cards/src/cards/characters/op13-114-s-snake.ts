...
import { op13SSnake114I18n } from "./op13-114-s-snake.i18n.ts";

export const op13SSnake114: CharacterCard = {
  id: "OP13-114",
  canonicalId: "OP13-114",
  slug: "s-snake/op13-114",
  name: "S-Snake",
  printings: [
    {
      id: "OP13-114",
      ...
      collectorNumber: "114",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP13-114_3xn0b40.jpg",
    },
    {
      id: "OP13-114_p1",
      artId: "OP13-114_p1",
