...
import { eb03Alvida021I18n } from "./eb03-021-alvida.i18n.ts";

export const eb03Alvida021: CharacterCard = {
  id: "EB03-021",
  canonicalId: "EB03-021",
  slug: "alvida/eb03-021",
  name: "Alvida",
  printings: [
    {
      id: "EB03-021",
      ...
      collectorNumber: "021",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/EB03-021_iiAXpJW.jpg",
    },
  ],
  cardType: "character",
  color: ["blue"],
