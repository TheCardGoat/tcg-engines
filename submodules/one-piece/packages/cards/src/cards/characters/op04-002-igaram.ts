...
import { op04Igaram002I18n } from "./op04-002-igaram.i18n.ts";

export const op04Igaram002: CharacterCard = {
  id: "OP04-002",
  canonicalId: "OP04-002",
  slug: "igaram/op04-002",
  name: "Igaram",
  printings: [
    {
      id: "OP04-002",
      ...
      collectorNumber: "002",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP04-002.jpg",
    },
  ],
  cardType: "character",
  color: ["red"],
