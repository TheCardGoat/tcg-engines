...
import { op01Mr2BonKureiBentham084I18n } from "./op01-084-mr-2-bon-kurei-bentham.i18n.ts";
  ...
  printings: [
    {
      ...
      collectorNumber: "084",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP01-084.jpg",
    },
  ],
  cardType: "character",
  color: ["blue"],
