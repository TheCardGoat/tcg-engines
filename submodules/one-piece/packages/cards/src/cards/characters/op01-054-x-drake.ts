...
import { op01XDrake054I18n } from "./op01-054-x-drake.i18n.ts";

export const op01XDrake054: CharacterCard = {
  id: "OP01-054",
  canonicalId: "OP01-054",
  slug: "x-drake/op01-054",
  name: "X.Drake",
  printings: [
    {
      id: "OP01-054",
      ...
      collectorNumber: "054",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP01-054.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
