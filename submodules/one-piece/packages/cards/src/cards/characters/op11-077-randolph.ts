...
import { op11Randolph077I18n } from "./op11-077-randolph.i18n.ts";

export const op11Randolph077: CharacterCard = {
  id: "OP11-077",
  canonicalId: "OP11-077",
  slug: "randolph/op11-077",
  name: "Randolph",
  printings: [
    {
      id: "OP11-077",
      ...
      collectorNumber: "077",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP11-077.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
