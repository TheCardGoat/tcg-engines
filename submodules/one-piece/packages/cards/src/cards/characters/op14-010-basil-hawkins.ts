...
import { op14eb04BasilHawkins010I18n } from "./op14-010-basil-hawkins.i18n.ts";

export const op14eb04BasilHawkins010: CharacterCard = {
  id: "OP14-010",
  canonicalId: "OP14-010",
  slug: "basil-hawkins/op14-010",
  name: "Basil Hawkins",
  printings: [
    {
      id: "OP14-010",
      ...
      collectorNumber: "010",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP14-010_b5RNP0A.jpg",
    },
  ],
  cardType: "character",
  color: ["red"],
