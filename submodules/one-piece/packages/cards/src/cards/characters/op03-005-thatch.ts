...
import { op03Thatch005I18n } from "./op03-005-thatch.i18n.ts";

export const op03Thatch005: CharacterCard = {
  id: "OP03-005",
  canonicalId: "OP03-005",
  slug: "thatch/op03-005",
  name: "Thatch",
  printings: [
    {
      id: "OP03-005",
      ...
      collectorNumber: "005",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP03-005.jpg",
    },
  ],
  cardType: "character",
  color: ["red"],
