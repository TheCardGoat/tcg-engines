...
import { op11Shirley104I18n } from "./op11-104-shirley.i18n.ts";

export const op11Shirley104: CharacterCard = {
  id: "OP11-104",
  canonicalId: "OP11-104",
  slug: "shirley/op11-104",
  name: "Shirley",
  printings: [
    {
      id: "OP11-104",
      ...
      collectorNumber: "104",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP11-104.jpg",
    },
  ],
  cardType: "character",
  color: ["yellow"],
