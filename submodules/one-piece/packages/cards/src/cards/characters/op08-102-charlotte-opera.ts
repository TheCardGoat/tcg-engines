...
import { op08CharlotteOpera102I18n } from "./op08-102-charlotte-opera.i18n.ts";

export const op08CharlotteOpera102: CharacterCard = {
  id: "OP08-102",
  canonicalId: "OP08-102",
  slug: "charlotte-opera/op08-102",
  ...
  printings: [
    {
      ...
      collectorNumber: "102",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP08-102.jpg",
    },
  ],
  cardType: "character",
  color: ["yellow"],
