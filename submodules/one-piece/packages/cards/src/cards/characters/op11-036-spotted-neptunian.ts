...
import { op11SpottedNeptunian036I18n } from "./op11-036-spotted-neptunian.i18n.ts";

export const op11SpottedNeptunian036: CharacterCard = {
  id: "OP11-036",
  canonicalId: "OP11-036",
  slug: "spotted-neptunian",
  ...
  printings: [
    {
      ...
      collectorNumber: "036",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP11-036.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
