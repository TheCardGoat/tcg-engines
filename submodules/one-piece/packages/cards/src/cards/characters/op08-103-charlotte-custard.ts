...
import { op08CharlotteCustard103I18n } from "./op08-103-charlotte-custard.i18n.ts";

export const op08CharlotteCustard103: CharacterCard = {
  id: "OP08-103",
  canonicalId: "OP08-103",
  slug: "charlotte-custard",
  ...
  printings: [
    {
      ...
      collectorNumber: "103",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP08-103.jpg",
    },
  ],
  cardType: "character",
  color: ["yellow"],
