...
import { op02Morley061I18n } from "./op02-061-morley.i18n.ts";

export const op02Morley061: CharacterCard = {
  id: "OP02-061",
  canonicalId: "OP02-061",
  slug: "morley/op02-061",
  name: "Morley",
  printings: [
    {
      id: "OP02-061",
      ...
      collectorNumber: "061",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP02-061.jpg",
    },
  ],
  cardType: "character",
  color: ["blue"],
