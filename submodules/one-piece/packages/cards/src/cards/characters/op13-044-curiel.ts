...
import { op13Curiel044I18n } from "./op13-044-curiel.i18n.ts";

export const op13Curiel044: CharacterCard = {
  id: "OP13-044",
  canonicalId: "OP13-044",
  slug: "curiel/op13-044",
  name: "Curiel",
  printings: [
    {
      id: "OP13-044",
      ...
      collectorNumber: "044",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP13-044_2TEeOfQ.jpg",
    },
  ],
  cardType: "character",
  color: ["blue"],
