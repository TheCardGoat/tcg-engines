...
import { op01Komurasaki042I18n } from "./op01-042-komurasaki.i18n.ts";

export const op01Komurasaki042: CharacterCard = {
  id: "OP01-042",
  canonicalId: "OP01-042",
  slug: "komurasaki",
  name: "Komurasaki",
  printings: [
    {
      ...
      collectorNumber: "042",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP01-042.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
