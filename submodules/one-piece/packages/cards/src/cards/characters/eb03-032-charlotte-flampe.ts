...
import { eb03CharlotteFlampe032I18n } from "./eb03-032-charlotte-flampe.i18n.ts";

export const eb03CharlotteFlampe032: CharacterCard = {
  id: "EB03-032",
  canonicalId: "EB03-032",
  slug: "charlotte-flampe/eb03-032",
  ...
  printings: [
    {
      ...
      collectorNumber: "032",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/EB03-032_1U6q0Vd.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
