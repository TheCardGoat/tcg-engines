...
import { op07CaptainJohn082I18n } from "./op07-082-captain-john.i18n.ts";

export const op07CaptainJohn082: CharacterCard = {
  id: "OP07-082",
  canonicalId: "OP07-082",
  slug: "captain-john",
  name: "Captain John",
  printings: [
    {
      ...
      collectorNumber: "082",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP07-082.jpg",
    },
  ],
  cardType: "character",
  color: ["black"],
