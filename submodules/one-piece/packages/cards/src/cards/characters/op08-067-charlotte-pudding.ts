...
import { op08CharlottePudding067I18n } from "./op08-067-charlotte-pudding.i18n.ts";

export const op08CharlottePudding067: CharacterCard = {
  id: "OP08-067",
  canonicalId: "OP08-067",
  slug: "charlotte-pudding/op08-067",
  ...
  printings: [
    {
      ...
      collectorNumber: "067",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP08-067.jpg",
    },
    {
      id: "OP08-067_p1",
      artId: "OP08-067_p1",
