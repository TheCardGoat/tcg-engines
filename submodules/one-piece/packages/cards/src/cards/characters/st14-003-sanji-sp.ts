...
import { op10SanjiSp003I18n } from "./st14-003-sanji-sp.i18n.ts";

export const op10SanjiSp003: CharacterCard = {
  id: "ST14-003",
  canonicalId: "ST14-003",
  slug: "sanji-sp/st14-003",
  name: "Sanji",
  printings: [
    {
      id: "ST14-003",
      ...
      collectorNumber: "003",
      rarity: "SR",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/ST14-003_p1.jpg",
      label: "Sanji (SP)",
    },
  ],
  cardType: "character",
