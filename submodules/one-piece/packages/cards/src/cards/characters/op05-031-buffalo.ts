...
import { op05Buffalo031I18n } from "./op05-031-buffalo.i18n.ts";

export const op05Buffalo031: CharacterCard = {
  id: "OP05-031",
  canonicalId: "OP05-031",
  slug: "buffalo/op05-031",
  name: "Buffalo",
  printings: [
    {
      id: "OP05-031",
      ...
      collectorNumber: "031",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP05-031.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
