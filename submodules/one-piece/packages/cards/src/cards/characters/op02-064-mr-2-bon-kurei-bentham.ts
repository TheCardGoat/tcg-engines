...
import { op02Mr2BonKureiBentham064I18n } from "./op02-064-mr-2-bon-kurei-bentham.i18n.ts";
  ...
  printings: [
    {
      ...
      collectorNumber: "064",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP02-064.jpg",
    },
  ],
  cardType: "character",
  color: ["blue"],
