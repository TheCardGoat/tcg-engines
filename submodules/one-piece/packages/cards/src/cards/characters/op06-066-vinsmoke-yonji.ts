...
import { op06VinsmokeYonji066I18n } from "./op06-066-vinsmoke-yonji.i18n.ts";

export const op06VinsmokeYonji066: CharacterCard = {
  id: "OP06-066",
  canonicalId: "OP06-066",
  slug: "vinsmoke-yonji/op06-066",
  name: "Vinsmoke Yonji",
  printings: [
    {
      id: "OP06-066",
      ...
      collectorNumber: "066",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP06-066.jpg",
    },
    {
      id: "OP06-066_p2",
      artId: "OP06-066_p2",
    ...
    },
    {
      ...
      label: "Vinsmoke Yonji (OP06-066) (Full Art)",
    },
    {
      id: "OP06-066_r1",
      artId: "OP06-066_r1",
      ...
      collectorNumber: "066",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP06-066_r1.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
