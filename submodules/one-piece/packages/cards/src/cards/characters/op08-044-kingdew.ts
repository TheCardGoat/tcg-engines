...
import { op08Kingdew044I18n } from "./op08-044-kingdew.i18n.ts";

export const op08Kingdew044: CharacterCard = {
  id: "OP08-044",
  canonicalId: "OP08-044",
  slug: "kingdew/op08-044",
  name: "Kingdew",
  printings: [
    {
      id: "OP08-044",
      ...
      collectorNumber: "044",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP08-044.jpg",
    },
  ],
  cardType: "character",
  color: ["blue"],
