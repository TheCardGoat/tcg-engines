...
import { op07Spandam086I18n } from "./op07-086-spandam.i18n.ts";

export const op07Spandam086: CharacterCard = {
  id: "OP07-086",
  canonicalId: "OP07-086",
  slug: "spandam/op07-086",
  name: "Spandam",
  printings: [
    {
      id: "OP07-086",
      ...
      collectorNumber: "086",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP07-086.jpg",
    },
  ],
  cardType: "character",
  color: ["black"],
