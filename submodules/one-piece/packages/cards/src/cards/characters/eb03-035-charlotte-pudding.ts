...
import { eb03CharlottePudding035I18n } from "./eb03-035-charlotte-pudding.i18n.ts";

export const eb03CharlottePudding035: CharacterCard = {
  id: "EB03-035",
  canonicalId: "EB03-035",
  slug: "charlotte-pudding/eb03-035",
  ...
  printings: [
    {
      ...
      collectorNumber: "035",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/EB03-035_YunUEht.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
