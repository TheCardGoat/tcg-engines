...
import { op02Shishilian032I18n } from "./op02-032-shishilian.i18n.ts";

export const op02Shishilian032: CharacterCard = {
  id: "OP02-032",
  canonicalId: "OP02-032",
  slug: "shishilian/op02-032",
  name: "Shishilian",
  printings: [
    {
      id: "OP02-032",
      ...
      collectorNumber: "032",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP02-032.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
