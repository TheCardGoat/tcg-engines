...
import { op01BlackMaria111I18n } from "./op01-111-black-maria.i18n.ts";

export const op01BlackMaria111: CharacterCard = {
  id: "OP01-111",
  canonicalId: "OP01-111",
  slug: "black-maria/op01-111",
  name: "Black Maria",
  printings: [
    {
      id: "OP01-111",
      ...
      collectorNumber: "111",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP01-111.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
