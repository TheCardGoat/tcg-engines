...
import { op07MaskedDeuce013I18n } from "./op07-013-masked-deuce.i18n.ts";

export const op07MaskedDeuce013: CharacterCard = {
  id: "OP07-013",
  canonicalId: "OP07-013",
  slug: "masked-deuce/op07-013",
  name: "Masked Deuce",
  printings: [
    {
      id: "OP07-013",
      ...
      collectorNumber: "013",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP07-013.jpg",
    },
  ],
  cardType: "character",
  color: ["red"],
