...
import { op04DaddyMasterson027I18n } from "./op04-027-daddy-masterson.i18n.ts";

export const op04DaddyMasterson027: CharacterCard = {
  id: "OP04-027",
  canonicalId: "OP04-027",
  slug: "daddy-masterson",
  ...
  printings: [
    {
      ...
      collectorNumber: "027",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP04-027.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
