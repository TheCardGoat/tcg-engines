...
import { op01MsAllSunday079I18n } from "./op01-079-ms-all-sunday.i18n.ts";

export const op01MsAllSunday079: CharacterCard = {
  id: "OP01-079",
  canonicalId: "OP01-079",
  slug: "ms-all-sunday/op01-079",
  name: "Ms. All Sunday",
  printings: [
    {
      id: "OP01-079",
      ...
      collectorNumber: "079",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP01-079.jpg",
    },
  ],
  cardType: "character",
  color: ["blue"],
