...
import { op06VinsmokeIchiji061I18n } from "./op06-061-vinsmoke-ichiji.i18n.ts";

export const op06VinsmokeIchiji061: CharacterCard = {
  id: "OP06-061",
  canonicalId: "OP06-061",
  slug: "vinsmoke-ichiji/op06-061",
  ...
  printings: [
    {
      ...
      collectorNumber: "061",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP06-061.jpg",
    },
    {
      id: "OP06-061_p1",
      artId: "OP06-061_p1",
