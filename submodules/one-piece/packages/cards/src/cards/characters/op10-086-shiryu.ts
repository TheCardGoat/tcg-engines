...
import { op10Shiryu086I18n } from "./op10-086-shiryu.i18n.ts";

export const op10Shiryu086: CharacterCard = {
  id: "OP10-086",
  canonicalId: "OP10-086",
  slug: "shiryu/op10-086",
  name: "Shiryu",
  printings: [
    {
      id: "OP10-086",
      ...
      collectorNumber: "086",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP10-086.jpg",
    },
  ],
  cardType: "character",
  color: ["black"],
