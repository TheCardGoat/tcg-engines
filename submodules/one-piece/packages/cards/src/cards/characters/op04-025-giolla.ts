...
import { op04Giolla025I18n } from "./op04-025-giolla.i18n.ts";

export const op04Giolla025: CharacterCard = {
  id: "OP04-025",
  canonicalId: "OP04-025",
  slug: "giolla/op04-025",
  name: "Giolla",
  printings: [
    {
      id: "OP04-025",
      ...
      collectorNumber: "025",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP04-025.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
