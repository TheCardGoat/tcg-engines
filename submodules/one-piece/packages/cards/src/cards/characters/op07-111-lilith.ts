...
import { op07Lilith111I18n } from "./op07-111-lilith.i18n.ts";

export const op07Lilith111: CharacterCard = {
  id: "OP07-111",
  canonicalId: "OP07-111",
  slug: "lilith/op07-111",
  name: "Lilith",
  printings: [
    {
      id: "OP07-111",
      ...
      collectorNumber: "111",
      rarity: "SR",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP07-111.jpg",
    },
    {
      id: "OP07-111_p1",
      artId: "OP07-111_p1",
    ...
    },
    {
      ...
      collectorNumber: "111",
      rarity: "SR",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP07-111_p2.jpg",
    },
  ],
  cardType: "character",
  color: ["yellow"],
