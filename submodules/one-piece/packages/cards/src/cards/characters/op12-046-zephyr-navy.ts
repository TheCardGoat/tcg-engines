...
import { op12ZephyrNavy046I18n } from "./op12-046-zephyr-navy.i18n.ts";

export const op12ZephyrNavy046: CharacterCard = {
  id: "OP12-046",
  canonicalId: "OP12-046",
  slug: "zephyr-navy/op12-046",
  name: "Zephyr(Navy)",
  printings: [
    {
      id: "OP12-046",
      ...
      collectorNumber: "046",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP12-046_HVRUPMF.jpg",
    },
  ],
  cardType: "character",
  color: ["blue"],
