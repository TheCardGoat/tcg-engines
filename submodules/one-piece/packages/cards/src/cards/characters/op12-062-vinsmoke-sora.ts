...
import { op12VinsmokeSora062I18n } from "./op12-062-vinsmoke-sora.i18n.ts";

export const op12VinsmokeSora062: CharacterCard = {
  id: "OP12-062",
  canonicalId: "OP12-062",
  slug: "vinsmoke-sora/op12-062",
  name: "Vinsmoke Sora",
  printings: [
    {
      id: "OP12-062",
      ...
      collectorNumber: "062",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP12-062_Od3rO5R.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
