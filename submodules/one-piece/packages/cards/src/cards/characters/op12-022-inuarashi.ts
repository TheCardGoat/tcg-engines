...
import { op12Inuarashi022I18n } from "./op12-022-inuarashi.i18n.ts";

export const op12Inuarashi022: CharacterCard = {
  id: "OP12-022",
  canonicalId: "OP12-022",
  slug: "inuarashi/op12-022",
  name: "Inuarashi",
  printings: [
    {
      id: "OP12-022",
      ...
      collectorNumber: "022",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP12-022_eOT3zft.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
