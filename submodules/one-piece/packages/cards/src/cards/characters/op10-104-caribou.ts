...
import { op10Caribou104I18n } from "./op10-104-caribou.i18n.ts";

export const op10Caribou104: CharacterCard = {
  id: "OP10-104",
  canonicalId: "OP10-104",
  slug: "caribou/op10-104",
  name: "Caribou",
  printings: [
    {
      id: "OP10-104",
      ...
      collectorNumber: "104",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP10-104.jpg",
    },
  ],
  cardType: "character",
  color: ["yellow"],
