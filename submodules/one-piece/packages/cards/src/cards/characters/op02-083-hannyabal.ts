...
import { op02Hannyabal083I18n } from "./op02-083-hannyabal.i18n.ts";

export const op02Hannyabal083: CharacterCard = {
  id: "OP02-083",
  canonicalId: "OP02-083",
  slug: "hannyabal/op02-083",
  name: "Hannyabal",
  printings: [
    {
      id: "OP02-083",
      ...
      collectorNumber: "083",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP02-083.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
