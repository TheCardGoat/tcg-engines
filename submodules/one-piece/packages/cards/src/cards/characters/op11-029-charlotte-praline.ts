...
import { op11CharlottePraline029I18n } from "./op11-029-charlotte-praline.i18n.ts";

export const op11CharlottePraline029: CharacterCard = {
  id: "OP11-029",
  canonicalId: "OP11-029",
  slug: "charlotte-praline/op11-029",
  ...
  printings: [
    {
      ...
      collectorNumber: "029",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP11-029.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
