...
import { op02TonyTonyChopper034I18n } from "./op02-034-tony-tony-chopper.i18n.ts";

export const op02TonyTonyChopper034: CharacterCard = {
  id: "OP02-034",
  canonicalId: "OP02-034",
  slug: "tony-tony-chopper/op02-034",
  ...
  printings: [
    {
      ...
      collectorNumber: "034",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP02-034.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
