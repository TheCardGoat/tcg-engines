...
import { op10CaesarClown006I18n } from "./op10-006-caesar-clown.i18n.ts";

export const op10CaesarClown006: CharacterCard = {
  id: "OP10-006",
  canonicalId: "OP10-006",
  slug: "caesar-clown/op10-006",
  name: "Caesar Clown",
  printings: [
    {
      id: "OP10-006",
      ...
      collectorNumber: "006",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP10-006.jpg",
    },
  ],
  cardType: "character",
  color: ["red"],
