...
import { op07GloriosaGrandmaNyon041I18n } from "./op07-041-gloriosa-grandma-nyon.i18n.ts";

export const op07GloriosaGrandmaNyon041: CharacterCard = {
  id: "OP07-041",
  canonicalId: "OP07-041",
  slug: "gloriosa-grandma-nyon/op07-041",
  ...
  printings: [
    {
      ...
      collectorNumber: "041",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP07-041.jpg",
    },
  ],
  cardType: "character",
  color: ["blue"],
