...
import { op14eb04Sugar063I18n } from "./op14-063-sugar.i18n.ts";

export const op14eb04Sugar063: CharacterCard = {
  id: "OP14-063",
  canonicalId: "OP14-063",
  slug: "sugar/op14-063",
  name: "Sugar",
  printings: [
    {
      ...
      collectorNumber: "063",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP14-063_9pEe2of.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
