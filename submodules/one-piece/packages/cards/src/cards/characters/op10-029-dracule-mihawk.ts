...
import { op10DraculeMihawk029I18n } from "./op10-029-dracule-mihawk.i18n.ts";

export const op10DraculeMihawk029: CharacterCard = {
  id: "OP10-029",
  canonicalId: "OP10-029",
  slug: "dracule-mihawk/op10-029",
  name: "Dracule Mihawk",
  printings: [
    {
      id: "OP10-029",
      ...
      collectorNumber: "029",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP10-029.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
