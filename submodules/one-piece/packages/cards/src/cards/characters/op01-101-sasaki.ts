...
import { op01Sasaki101I18n } from "./op01-101-sasaki.i18n.ts";

export const op01Sasaki101: CharacterCard = {
  id: "OP01-101",
  canonicalId: "OP01-101",
  slug: "sasaki/op01-101",
  name: "Sasaki",
  printings: [
    {
      id: "OP01-101",
      ...
      collectorNumber: "101",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP01-101.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
