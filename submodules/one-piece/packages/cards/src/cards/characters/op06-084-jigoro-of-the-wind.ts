...
import { op06JigoroOfTheWind084I18n } from "./op06-084-jigoro-of-the-wind.i18n.ts";

export const op06JigoroOfTheWind084: CharacterCard = {
  id: "OP06-084",
  canonicalId: "OP06-084",
  slug: "jigoro-of-the-wind",
  ...
  printings: [
    {
      ...
      collectorNumber: "084",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP06-084.jpg",
    },
  ],
  cardType: "character",
  color: ["black"],
