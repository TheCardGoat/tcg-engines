...
import { op08CharlotteCracker064I18n } from "./op08-064-charlotte-cracker.i18n.ts";

export const op08CharlotteCracker064: CharacterCard = {
  id: "OP08-064",
  canonicalId: "OP08-064",
  slug: "charlotte-cracker/op08-064",
  ...
  printings: [
    {
      ...
      collectorNumber: "064",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP08-064.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
