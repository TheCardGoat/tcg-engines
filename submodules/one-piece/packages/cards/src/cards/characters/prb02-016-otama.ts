...
import { prb02Otama016I18n } from "./prb02-016-otama.i18n.ts";

export const prb02Otama016: CharacterCard = {
  id: "PRB02-016",
  canonicalId: "PRB02-016",
  slug: "otama/prb02-016",
  name: "Otama",
  printings: [
    {
      id: "PRB02-016",
      ...
      collectorNumber: "016",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/PRB02-016.jpg",
    },
  ],
  cardType: "character",
  color: ["yellow"],
