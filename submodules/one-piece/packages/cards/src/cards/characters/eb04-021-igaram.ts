...
import { op14eb04Igaram021I18n } from "./eb04-021-igaram.i18n.ts";

export const op14eb04Igaram021: CharacterCard = {
  id: "EB04-021",
  canonicalId: "EB04-021",
  slug: "igaram/eb04-021",
  name: "Igaram",
  printings: [
    {
      id: "EB04-021",
      ...
      collectorNumber: "021",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/EB04-021_U8kjseP.jpg",
    },
  ],
  cardType: "character",
  color: ["blue"],
