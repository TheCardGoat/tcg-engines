...
import { op07DoguraMagura009I18n } from "./op07-009-dogura-magura.i18n.ts";

export const op07DoguraMagura009: CharacterCard = {
  id: "OP07-009",
  canonicalId: "OP07-009",
  slug: "dogura-magura",
  name: "Dogura & Magura",
  printings: [
    {
      ...
      collectorNumber: "009",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP07-009.jpg",
    },
  ],
  cardType: "character",
  color: ["red"],
