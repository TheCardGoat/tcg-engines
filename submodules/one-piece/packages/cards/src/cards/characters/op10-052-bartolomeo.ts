...
import { op10Bartolomeo052I18n } from "./op10-052-bartolomeo.i18n.ts";

export const op10Bartolomeo052: CharacterCard = {
  id: "OP10-052",
  canonicalId: "OP10-052",
  slug: "bartolomeo/op10-052",
  name: "Bartolomeo",
  printings: [
    {
      id: "OP10-052",
      ...
      collectorNumber: "052",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP10-052.jpg",
    },
  ],
  cardType: "character",
  color: ["blue"],
