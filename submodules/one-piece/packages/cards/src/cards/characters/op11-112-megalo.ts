...
import { op11Megalo112I18n } from "./op11-112-megalo.i18n.ts";

export const op11Megalo112: CharacterCard = {
  id: "OP11-112",
  canonicalId: "OP11-112",
  slug: "megalo/op11-112",
  name: "Megalo",
  printings: [
    {
      id: "OP11-112",
      ...
      collectorNumber: "112",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP11-112.jpg",
    },
  ],
  cardType: "character",
  color: ["yellow"],
