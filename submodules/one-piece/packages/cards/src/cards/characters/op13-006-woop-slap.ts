...
import { op13WoopSlap006I18n } from "./op13-006-woop-slap.i18n.ts";

export const op13WoopSlap006: CharacterCard = {
  id: "OP13-006",
  canonicalId: "OP13-006",
  slug: "woop-slap",
  name: "Woop Slap",
  printings: [
    {
      ...
      collectorNumber: "006",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP13-006_7BIDucC.jpg",
    },
  ],
  cardType: "character",
  color: ["red"],
