...
import { op13SaintMjosgard092I18n } from "./op13-092-saint-mjosgard.i18n.ts";

export const op13SaintMjosgard092: CharacterCard = {
  id: "OP13-092",
  canonicalId: "OP13-092",
  slug: "saint-mjosgard/op13-092",
  name: "Saint Mjosgard",
  printings: [
    {
      id: "OP13-092",
      ...
      collectorNumber: "092",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP13-092_NBO2Ijh.jpg",
    },
  ],
  cardType: "character",
  color: ["black"],
