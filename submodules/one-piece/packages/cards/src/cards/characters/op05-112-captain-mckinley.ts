...
import { op05CaptainMckinley112I18n } from "./op05-112-captain-mckinley.i18n.ts";

export const op05CaptainMckinley112: CharacterCard = {
  id: "OP05-112",
  canonicalId: "OP05-112",
  slug: "captain-mckinley",
  ...
  printings: [
    {
      ...
      collectorNumber: "112",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP05-112.jpg",
    },
  ],
  cardType: "character",
  color: ["yellow"],
