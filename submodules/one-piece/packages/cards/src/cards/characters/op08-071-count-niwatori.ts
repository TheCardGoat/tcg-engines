...
import { op08CountNiwatori071I18n } from "./op08-071-count-niwatori.i18n.ts";

export const op08CountNiwatori071: CharacterCard = {
  id: "OP08-071",
  canonicalId: "OP08-071",
  slug: "count-niwatori",
  name: "Count Niwatori",
  printings: [
    {
      ...
      collectorNumber: "071",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP08-071.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
