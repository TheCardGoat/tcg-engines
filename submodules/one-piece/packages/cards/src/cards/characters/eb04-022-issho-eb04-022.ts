...
import { op14eb04IsshoEb04022022I18n } from "./eb04-022-issho-eb04-022.i18n.ts";

export const op14eb04IsshoEb04022022: CharacterCard = {
  id: "EB04-022",
  canonicalId: "EB04-022",
  slug: "issho-eb04-022",
  name: "Issho",
  printings: [
    {
      ...
      collectorNumber: "022",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/EB04-022_hbROZbW.jpg",
      label: "Issho - EB04-022",
    },
    {
      id: "EB04-022_p1",
      artId: "EB04-022_p1",
      ...
      label: "Issho - EB04-022 (Alternate Art)",
    },
  ],
  cardType: "character",
  color: ["blue"],
