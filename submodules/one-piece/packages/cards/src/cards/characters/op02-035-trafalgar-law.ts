...
import { op02TrafalgarLaw035I18n } from "./op02-035-trafalgar-law.i18n.ts";

export const op02TrafalgarLaw035: CharacterCard = {
  id: "OP02-035",
  canonicalId: "OP02-035",
  slug: "trafalgar-law/op02-035",
  name: "Trafalgar Law",
  printings: [
    {
      id: "OP02-035",
      ...
      collectorNumber: "035",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP02-035.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
