...
import { op10EdwardNewgate024I18n } from "./op10-024-edward-newgate.i18n.ts";

export const op10EdwardNewgate024: CharacterCard = {
  id: "OP10-024",
  canonicalId: "OP10-024",
  slug: "edward-newgate/op10-024",
  name: "Edward.Newgate",
  printings: [
    {
      id: "OP10-024",
      ...
      collectorNumber: "024",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP10-024.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
