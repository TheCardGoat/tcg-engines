...
import { op13Makino015I18n } from "./op13-015-makino.i18n.ts";

export const op13Makino015: CharacterCard = {
  id: "OP13-015",
  canonicalId: "OP13-015",
  slug: "makino/op13-015",
  name: "Makino",
  printings: [
    {
      id: "OP13-015",
      ...
      collectorNumber: "015",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP13-015_kUxGSoS.jpg",
    },
  ],
  cardType: "character",
  color: ["red"],
