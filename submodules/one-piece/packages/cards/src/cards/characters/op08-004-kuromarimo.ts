...
import { op08Kuromarimo004I18n } from "./op08-004-kuromarimo.i18n.ts";

export const op08Kuromarimo004: CharacterCard = {
  id: "OP08-004",
  canonicalId: "OP08-004",
  slug: "kuromarimo",
  name: "Kuromarimo",
  printings: [
    {
      ...
      collectorNumber: "004",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP08-004.jpg",
    },
  ],
  cardType: "character",
  color: ["red"],
