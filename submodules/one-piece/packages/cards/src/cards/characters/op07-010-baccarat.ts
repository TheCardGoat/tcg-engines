...
import { op07Baccarat010I18n } from "./op07-010-baccarat.i18n.ts";

export const op07Baccarat010: CharacterCard = {
  id: "OP07-010",
  canonicalId: "OP07-010",
  slug: "baccarat/op07-010",
  name: "Baccarat",
  printings: [
    {
      id: "OP07-010",
      ...
      collectorNumber: "010",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP07-010.jpg",
    },
  ],
  cardType: "character",
  color: ["red"],
