...
import { op07VinsmokeReiju062I18n } from "./op07-062-vinsmoke-reiju.i18n.ts";

export const op07VinsmokeReiju062: CharacterCard = {
  id: "OP07-062",
  canonicalId: "OP07-062",
  slug: "vinsmoke-reiju/op07-062",
  name: "Vinsmoke Reiju",
  printings: [
    {
      id: "OP07-062",
      ...
      collectorNumber: "062",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP07-062.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
