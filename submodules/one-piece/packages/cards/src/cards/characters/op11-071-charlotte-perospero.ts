...
import { op11CharlottePerospero071I18n } from "./op11-071-charlotte-perospero.i18n.ts";

export const op11CharlottePerospero071: CharacterCard = {
  id: "OP11-071",
  canonicalId: "OP11-071",
  slug: "charlotte-perospero/op11-071",
  ...
  printings: [
    {
      ...
      collectorNumber: "071",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP11-071.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
