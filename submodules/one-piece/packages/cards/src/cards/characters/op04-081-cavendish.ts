...
import { op04Cavendish081I18n } from "./op04-081-cavendish.i18n.ts";

export const op04Cavendish081: CharacterCard = {
  id: "OP04-081",
  canonicalId: "OP04-081",
  slug: "cavendish/op04-081",
  name: "Cavendish",
  printings: [
    {
      id: "OP04-081",
      ...
      collectorNumber: "081",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP04-081.jpg",
    },
  ],
  cardType: "character",
  color: ["black"],
