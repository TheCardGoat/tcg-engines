...
import { op09DonquixoteDoflamingo031I18n } from "./op09-031-donquixote-doflamingo.i18n.ts";

export const op09DonquixoteDoflamingo031: CharacterCard = {
  id: "OP09-031",
  canonicalId: "OP09-031",
  slug: "donquixote-doflamingo/op09-031",
  ...
  printings: [
    {
      ...
      collectorNumber: "031",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP09-031.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
