...
import { op07CurlyDadan004I18n } from "./op07-004-curly-dadan.i18n.ts";

export const op07CurlyDadan004: CharacterCard = {
  id: "OP07-004",
  canonicalId: "OP07-004",
  slug: "curly-dadan/op07-004",
  name: "Curly.Dadan",
  printings: [
    {
      id: "OP07-004",
      ...
      collectorNumber: "004",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP07-004.jpg",
    },
  ],
  cardType: "character",
  color: ["red"],
