...
import { op05LieutenantSpacey107I18n } from "./op05-107-lieutenant-spacey.i18n.ts";

export const op05LieutenantSpacey107: CharacterCard = {
  id: "OP05-107",
  canonicalId: "OP05-107",
  slug: "lieutenant-spacey",
  ...
  printings: [
    {
      ...
      collectorNumber: "107",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP05-107.jpg",
    },
  ],
  cardType: "character",
  color: ["yellow"],
