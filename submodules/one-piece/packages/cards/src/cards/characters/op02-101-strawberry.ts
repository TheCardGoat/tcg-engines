...
import { op02Strawberry101I18n } from "./op02-101-strawberry.i18n.ts";

export const op02Strawberry101: CharacterCard = {
  id: "OP02-101",
  canonicalId: "OP02-101",
  slug: "strawberry",
  name: "Strawberry",
  printings: [
    {
      ...
      collectorNumber: "101",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP02-101.jpg",
    },
  ],
  cardType: "character",
  color: ["black"],
