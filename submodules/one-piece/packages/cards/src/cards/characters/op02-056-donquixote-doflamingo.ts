...
import { op02DonquixoteDoflamingo056I18n } from "./op02-056-donquixote-doflamingo.i18n.ts";

export const op02DonquixoteDoflamingo056: CharacterCard = {
  id: "OP02-056",
  canonicalId: "OP02-056",
  slug: "donquixote-doflamingo/op02-056",
  ...
  printings: [
    {
      ...
      collectorNumber: "056",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP02-056.jpg",
    },
  ],
  cardType: "character",
  color: ["blue"],
