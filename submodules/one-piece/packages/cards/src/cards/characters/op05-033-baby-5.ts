...
import { op05Baby5033I18n } from "./op05-033-baby-5.i18n.ts";

export const op05Baby5033: CharacterCard = {
  id: "OP05-033",
  canonicalId: "OP05-033",
  slug: "baby-5/op05-033",
  name: "Baby 5",
  printings: [
    {
      id: "OP05-033",
      ...
      collectorNumber: "033",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP05-033.jpg",
    },
  ],
  cardType: "character",
  color: ["green"],
