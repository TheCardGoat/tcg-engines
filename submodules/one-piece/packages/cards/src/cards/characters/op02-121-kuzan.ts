...
import { op02Kuzan121I18n } from "./op02-121-kuzan.i18n.ts";

export const op02Kuzan121: CharacterCard = {
  id: "OP02-121",
  canonicalId: "OP02-121",
  slug: "kuzan/op02-121",
  name: "Kuzan",
  printings: [
    {
      ...
      collectorNumber: "121",
      rarity: "SEC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP02-121.jpg",
    },
    {
      id: "OP02-121_p1",
      artId: "OP02-121_p1",
    ...
    },
    {
      ...
      label: "Kuzan (OP02-121) (Alternate Art)",
    },
    {
      id: "OP02-121_r1",
      artId: "OP02-121_r1",
