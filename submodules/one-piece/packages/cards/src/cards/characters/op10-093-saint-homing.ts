...
import { op10SaintHoming093I18n } from "./op10-093-saint-homing.i18n.ts";

export const op10SaintHoming093: CharacterCard = {
  id: "OP10-093",
  canonicalId: "OP10-093",
  slug: "saint-homing",
  name: "Saint Homing",
  printings: [
    {
      ...
      collectorNumber: "093",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP10-093.jpg",
    },
  ],
  cardType: "character",
  color: ["black"],
