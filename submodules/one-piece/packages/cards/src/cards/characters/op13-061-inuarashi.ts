...
import { op13Inuarashi061I18n } from "./op13-061-inuarashi.i18n.ts";

export const op13Inuarashi061: CharacterCard = {
  id: "OP13-061",
  canonicalId: "OP13-061",
  slug: "inuarashi/op13-061",
  name: "Inuarashi",
  printings: [
    {
      id: "OP13-061",
      ...
      collectorNumber: "061",
      rarity: "C",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP13-061_JJ2fDPe.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
