...
import { op13Crocus062I18n } from "./op13-062-crocus.i18n.ts";

export const op13Crocus062: CharacterCard = {
  id: "OP13-062",
  canonicalId: "OP13-062",
  slug: "crocus/op13-062",
  name: "Crocus",
  printings: [
    {
      id: "OP13-062",
      ...
      collectorNumber: "062",
      rarity: "UC",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/OP13-062_SRuM73G.jpg",
    },
  ],
  cardType: "character",
  color: ["purple"],
