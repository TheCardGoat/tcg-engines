...
import { eb03Stussy043I18n } from "./eb03-043-stussy.i18n.ts";

export const eb03Stussy043: CharacterCard = {
  id: "EB03-043",
  canonicalId: "EB03-043",
  slug: "stussy/eb03-043",
  name: "Stussy",
  printings: [
    {
      id: "EB03-043",
      ...
      collectorNumber: "043",
      rarity: "R",
      imageUrl: "https://www.optcgapi.com/media/static/Card_Images/EB03-043_IIrsmV2.jpg",
    },
  ],
  cardType: "character",
  color: ["black"],
