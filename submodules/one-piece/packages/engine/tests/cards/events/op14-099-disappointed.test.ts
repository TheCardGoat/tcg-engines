...
describe("OP14-099 Disappointed?", () => {
  test("Life Trigger activates Main, finds an included Baroque Works card other than itself, and trashes the rest", () => {
    const engine = OnePieceTestEngine.create(
      { character: [{ card: eb01MountainGod018, playedOnTurn: 0 }] },
      {
        life: [op14eb04Disappointed099],
        deck: [
          op14eb04MissDoublefingerZala086,
          op14eb04Disappointed099,
          eb01Doma005,
    ...
    const selectedId = engine.findCardInZone("north", "deck", op14eb04MissDoublefingerZala086);
    const excludedId = engine.findCardInZone("north", "deck", op14eb04Disappointed099);
