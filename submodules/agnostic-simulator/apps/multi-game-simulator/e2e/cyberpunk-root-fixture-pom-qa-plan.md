...
| `reactStep`                                 | core                     | Implemented | yes      | yes   | yes        |
...
| `reactStep`        | `packages/engine/tests/flow/two-turns-with-moves.test.ts`                                                                | Use a blocker or resolve the attack.                      | P1 React prompt exposes blocker/resolve actions only, blocker redirects direct attack into a fight, no gig is stolen when blocked.                     |
