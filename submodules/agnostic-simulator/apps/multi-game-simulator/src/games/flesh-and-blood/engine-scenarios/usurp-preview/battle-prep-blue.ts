...
import { battlePrepBlue as battlePrepBlueRules } from "@tcg/flesh-and-blood-cards/cards/actions/battle-prep";
...
const battlePrepBlue = previewCard(battlePrepBlueRules);
export const scenario: FabEngineScenario = {
  id: "usurp-preview-battle-prep-blue",
  label: "Battle Prep (blue)",
  description:
  ...
  group: "usurp-preview",
  tags: ["IAR", "preview", "battle-prep-blue"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    ...
    game.as(dash);
    Bravo.play(battlePrepBlue, { from: "arsenal", optBottom: 2 });
    game.helpers.resolveUntilIdle();
    Bravo.playAttack(valiantThrustRed, { optionals: "decline" });
    return matchFromEngine(engine, "usurp-preview-battle-prep-blue");
  },
};
