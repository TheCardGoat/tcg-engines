...
import { runicReavingBlue as runicReavingBlueRules } from "@tcg/flesh-and-blood-cards/cards/actions/runic-reaving";
import { matchFromEngine } from "../runtime";
import type { FabEngineScenario } from "../types";
const runechant = previewCard(runechantRules);
const viserai = previewCard(viseraiRules);
const dash = previewCard(dashRules);
const runicReavingBlue = previewCard(runicReavingBlueRules);
export const scenario: FabEngineScenario = {
  id: "usurp-preview-runic-reaving-blue",
  label: "Runic Reaving (blue)",
  description:
  ...
  group: "usurp-preview",
  tags: ["IAR", "preview", "runic-reaving-blue"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    const card = runicReavingBlue;
    ...
    return matchFromEngine(engine, "usurp-preview-runic-reaving-blue");
  },
};
