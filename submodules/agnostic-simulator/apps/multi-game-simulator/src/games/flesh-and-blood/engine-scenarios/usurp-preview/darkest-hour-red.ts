...
export const scenario: FabEngineScenario = {
  id: "usurp-preview-darkest-hour-red",
  label: "Darkest Hour (red)",
  description:
  ...
  group: "usurp-preview",
  tags: ["IAR", "preview", "darkest-hour-red"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    const card = darkestHourRed;
    const shadow = true;
    ...
    return matchFromEngine(engine, "usurp-preview-darkest-hour-red");
  },
};
