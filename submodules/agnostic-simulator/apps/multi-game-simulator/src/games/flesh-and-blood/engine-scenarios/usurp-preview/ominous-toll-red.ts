...
import { ominousTollRed as ominousTollRedRules } from "@tcg/flesh-and-blood-cards/cards/actions/ominous-toll";
import { matchFromEngine } from "../runtime";
import type { FabEngineScenario } from "../types";
const dash = previewCard(dashRules);
const restlessClericRed = previewCard(restlessClericRedRules);
const malice = previewCard(maliceRules);
const ominousTollRed = previewCard(ominousTollRedRules);
export const scenario: FabEngineScenario = {
  id: "usurp-preview-ominous-toll-red",
  label: "Ominous Toll (red)",
  description:
  ...
  group: "usurp-preview",
  tags: ["IAR", "preview", "ominous-toll-red"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    const card = ominousTollRed;
    const pay = true;
    ...
    return matchFromEngine(engine, "usurp-preview-ominous-toll-red");
  },
};
