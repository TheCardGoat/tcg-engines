...
// Preview fixture seeded from src/cards/instants/runechant-of-sloth.test.ts.
...
import { runechantOfSlothYellow as runechantOfSlothYellowRules } from "@tcg/flesh-and-blood-cards/cards/instants/runechant-of-sloth";
...
const runechantOfSlothYellow = previewCard(runechantOfSlothYellowRules);
export const scenario: FabEngineScenario = {
  id: "usurp-preview-runechant-of-sloth-yellow",
  label: "Runechant of Sloth (yellow)",
  description:
    "happy: destroyed by a yellow aura-destroy, a fresh Runechant is created. This counts as a Runechant. When an attack usurps this, it gets go again.\nWhen this is destroyed, create a Runechant token.\nAt the beginning of your action phase or when you play an attack action card, destroy this.",
  group: "usurp-preview",
  tags: ["IAR", "preview", "runechant-of-sloth-yellow"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    ...
    return matchFromEngine(engine, "usurp-preview-runechant-of-sloth-yellow");
  },
};
