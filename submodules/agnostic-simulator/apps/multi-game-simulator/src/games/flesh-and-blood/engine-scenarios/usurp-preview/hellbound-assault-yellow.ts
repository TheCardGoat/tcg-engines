...
export const scenario: FabEngineScenario = {
  id: "usurp-preview-hellbound-assault-yellow",
  label: "Hellbound Assault (yellow)",
  description:
    "happy: when this hits, it is banished instead of resting in the graveyard. When this hits, banish it.\nBlood Debt",
  group: "usurp-preview",
  tags: ["IAR", "preview", "hellbound-assault-yellow"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    ...
    Rhinar.playAttack(hellboundAssaultYellow);
    game.closeCombat();
    return matchFromEngine(engine, "usurp-preview-hellbound-assault-yellow");
  },
};
