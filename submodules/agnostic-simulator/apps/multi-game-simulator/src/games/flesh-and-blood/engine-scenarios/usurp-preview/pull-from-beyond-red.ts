...
import { pullFromBeyondRed as pullFromBeyondRedRules } from "@tcg/flesh-and-blood-cards/cards/actions/pull-from-beyond";
...
const pullFromBeyondRed = previewCard(pullFromBeyondRedRules);
export const scenario: FabEngineScenario = {
  id: "usurp-preview-pull-from-beyond-red",
  label: "Pull from Beyond (red)",
  description:
  ...
  group: "usurp-preview",
  tags: ["IAR", "preview", "pull-from-beyond-red"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    ...
    return matchFromEngine(engine, "usurp-preview-pull-from-beyond-red");
  },
};
