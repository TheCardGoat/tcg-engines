...
import { embraceUrsurBlue as embraceUrsurBlueRules } from "@tcg/flesh-and-blood-cards/cards/actions/embrace-ursur";
...
const embraceUrsurBlue = previewCard(embraceUrsurBlueRules);
export const scenario: FabEngineScenario = {
  id: "usurp-preview-embrace-ursur-blue",
  label: "Embrace Ursur (blue)",
  description:
  ...
  group: "usurp-preview",
  tags: ["IAR", "preview", "embrace-ursur-blue"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    const card = embraceUrsurBlue;
    ...
    return matchFromEngine(engine, "usurp-preview-embrace-ursur-blue");
  },
};
