...
import { embraceUrsurYellow as embraceUrsurYellowRules } from "@tcg/flesh-and-blood-cards/cards/actions/embrace-ursur";
...
const embraceUrsurYellow = previewCard(embraceUrsurYellowRules);
export const scenario: FabEngineScenario = {
  id: "usurp-preview-embrace-ursur-yellow",
  label: "Embrace Ursur (yellow)",
  description:
  ...
  group: "usurp-preview",
  tags: ["IAR", "preview", "embrace-ursur-yellow"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    const card = embraceUrsurYellow;
    ...
    return matchFromEngine(engine, "usurp-preview-embrace-ursur-yellow");
  },
};
