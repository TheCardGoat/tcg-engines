...
import { ominousTollYellow as ominousTollYellowRules } from "@tcg/flesh-and-blood-cards/cards/actions/ominous-toll";
import { matchFromEngine } from "../runtime";
import type { FabEngineScenario } from "../types";
const dash = previewCard(dashRules);
const restlessClericRed = previewCard(restlessClericRedRules);
const malice = previewCard(maliceRules);
const ominousTollYellow = previewCard(ominousTollYellowRules);
export const scenario: FabEngineScenario = {
  id: "usurp-preview-ominous-toll-yellow",
  label: "Ominous Toll (yellow)",
  description:
  ...
  group: "usurp-preview",
  tags: ["IAR", "preview", "ominous-toll-yellow"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    const card = ominousTollYellow;
    const pay = true;
    ...
    return matchFromEngine(engine, "usurp-preview-ominous-toll-yellow");
  },
};
