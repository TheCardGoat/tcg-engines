...
import { darkestHourYellow as darkestHourYellowRules } from "@tcg/flesh-and-blood-cards/cards/actions/darkest-hour";
...
const darkestHourYellow = previewCard(darkestHourYellowRules);
export const scenario: FabEngineScenario = {
  id: "usurp-preview-darkest-hour-yellow",
  label: "Darkest Hour (yellow)",
  description:
  ...
  group: "usurp-preview",
  tags: ["IAR", "preview", "darkest-hour-yellow"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    const card = darkestHourYellow;
    const shadow = true;
    ...
    return matchFromEngine(engine, "usurp-preview-darkest-hour-yellow");
  },
};
