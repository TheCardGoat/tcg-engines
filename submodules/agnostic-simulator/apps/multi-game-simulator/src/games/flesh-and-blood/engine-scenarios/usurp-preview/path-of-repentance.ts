...
// Preview fixture seeded from src/cards/equipment/path-of-repentance.test.ts.
...
import { pathOfRepentance as pathOfRepentanceRules } from "@tcg/flesh-and-blood-cards/cards/equipment/path-of-repentance";
...
const pathOfRepentance = previewCard(pathOfRepentanceRules);
export const scenario: FabEngineScenario = {
  id: "usurp-preview-path-of-repentance",
  label: "Path of Repentance",
  description:
  ...
  group: "usurp-preview",
  tags: ["IAR", "preview", "path-of-repentance"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    ...
    return matchFromEngine(engine, "usurp-preview-path-of-repentance");
  },
};
