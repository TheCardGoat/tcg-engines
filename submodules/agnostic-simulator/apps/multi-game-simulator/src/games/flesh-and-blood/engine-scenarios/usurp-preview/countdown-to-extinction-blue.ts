...
import { countdownToExtinctionBlue as countdownToExtinctionBlueRules } from "@tcg/flesh-and-blood-cards/cards/actions/countdown-to-extinction";
...
const countdownToExtinctionBlue = previewCard(countdownToExtinctionBlueRules);
export const scenario: FabEngineScenario = {
  id: "usurp-preview-countdown-to-extinction-blue",
  label: "Countdown to Extinction (blue)",
  description:
  ...
  group: "usurp-preview",
  tags: ["IAR", "preview", "countdown-to-extinction-blue"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    const card = countdownToExtinctionBlue;
    ...
    return matchFromEngine(engine, "usurp-preview-countdown-to-extinction-blue");
  },
};
