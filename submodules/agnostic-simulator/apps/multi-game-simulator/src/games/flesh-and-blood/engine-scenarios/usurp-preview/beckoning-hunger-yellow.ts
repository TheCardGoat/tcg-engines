...
import { beckoningHungerYellow as beckoningHungerYellowRules } from "@tcg/flesh-and-blood-cards/cards/actions/beckoning-hunger";
...
const beckoningHungerYellow = previewCard(beckoningHungerYellowRules);
export const scenario: FabEngineScenario = {
  id: "usurp-preview-beckoning-hunger-yellow",
  label: "Beckoning Hunger (yellow)",
  description:
  ...
  group: "usurp-preview",
  tags: ["IAR", "preview", "beckoning-hunger-yellow"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    ...
    game.as(dash);
    Levia.playAttack(beckoningHungerYellow);
    return matchFromEngine(engine, "usurp-preview-beckoning-hunger-yellow");
  },
};
