...
import { pullFromBeyondYellow as pullFromBeyondYellowRules } from "@tcg/flesh-and-blood-cards/cards/actions/pull-from-beyond";
...
const pullFromBeyondYellow = previewCard(pullFromBeyondYellowRules);
export const scenario: FabEngineScenario = {
  id: "usurp-preview-pull-from-beyond-yellow",
  label: "Pull from Beyond (yellow)",
  description:
  ...
  group: "usurp-preview",
  tags: ["IAR", "preview", "pull-from-beyond-yellow"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    ...
    Chane.play(pullFromBeyondYellow);
    game.untilIdle({ optBottom: 2 });
    return matchFromEngine(engine, "usurp-preview-pull-from-beyond-yellow");
  },
};
