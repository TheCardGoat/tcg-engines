...
import { beckoningHungerRed as beckoningHungerRedRules } from "@tcg/flesh-and-blood-cards/cards/actions/beckoning-hunger";
...
const beckoningHungerRed = previewCard(beckoningHungerRedRules);
export const scenario: FabEngineScenario = {
  id: "usurp-preview-beckoning-hunger-red",
  label: "Beckoning Hunger (red)",
  description:
  ...
  group: "usurp-preview",
  tags: ["IAR", "preview", "beckoning-hunger-red"],
  viewerId: "player-1",
  botMode: "pass-only",
  boot() {
    ...
    return matchFromEngine(engine, "usurp-preview-beckoning-hunger-red");
  },
};
