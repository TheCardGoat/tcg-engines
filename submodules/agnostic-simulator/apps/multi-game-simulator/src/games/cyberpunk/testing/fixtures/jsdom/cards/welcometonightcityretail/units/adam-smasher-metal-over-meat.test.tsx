...
describe("Adam Smasher (Retail) jsdom happy path", () => {
  test("adam Smasher (Retail) - play trigger defeats every other unit", async () => {
    ensureJsdomAnimationSupport();
    const view = renderCyberpunkSimulatorScenario({
      scenarioId: "unitAdamSmasherMetalOverMeatRetail",
    });
    try {
