...
describe("Placide - Voodoo Sentinel (Retail) jsdom happy path", () => {
  test("placide (Retail) - discards program to bottom-deck a rival unit", async () => {
    ensureJsdomAnimationSupport();
    const view = renderCyberpunkSimulatorScenario({
      scenarioId: "unitPlacideVoodooSentinelRetail",
    });
    try {
      ...
      await pom.resolveDiscardFromHand([program.instanceId], CYBERPUNK_P1);
