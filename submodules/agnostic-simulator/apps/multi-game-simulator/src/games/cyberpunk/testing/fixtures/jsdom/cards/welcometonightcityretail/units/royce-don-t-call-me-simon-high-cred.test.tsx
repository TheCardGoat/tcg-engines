...
describe("Royce high cred jsdom happy path (Retail)", () => {
  test("royce - high Street Cred targets power three units (Retail)", async () => {
    ensureJsdomAnimationSupport();
    const view = renderCyberpunkSimulatorScenario({
      scenarioId: "unitRoyceDonTCallMeSimonHighCredRetail",
    });
    try {
