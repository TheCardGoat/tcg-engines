...
export const endGameBehavior: CyberpunkFixtureBehavior = {
  scenarioId: "endGame",
  label: "End game - fully revealed",
  references: [
    "packages/engine/tests/win-condition-gigs.test.ts",
    "packages/engine/tests/win-condition-overtime.test.ts",
  ],
  async run(pom) {
