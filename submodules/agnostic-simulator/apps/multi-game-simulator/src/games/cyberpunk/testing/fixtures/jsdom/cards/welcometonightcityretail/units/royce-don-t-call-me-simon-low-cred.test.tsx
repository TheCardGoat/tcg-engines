...
describe("Royce low cred jsdom happy path (Retail)", () => {
  test("royce - low Street Cred targets power two or less (Retail)", async () => {
    ensureJsdomAnimationSupport();
    const view = renderCyberpunkSimulatorScenario({
      scenarioId: "unitRoyceDonTCallMeSimonLowCredRetail",
    });
    try {
