...
export const SCENARIO_SEEDS: Record<ScenarioId, string> = {
  ...
  deckSearchSketchyRipperPrompt: "scenario:deckSearchSketchyRipperPrompt",
  ...
  legendVStreetkidEquippedPower: "scenario:legendVStreetkidEquippedPower",
  legendRoycePsychoOnTheEdge: "scenario:legendRoycePsychoOnTheEdge",
  legendCallEquippedSelfPay: "scenario:legendCallEquippedSelfPay",
  ...
  legendDexterDeshawnOffTheGrid: "scenario:legendDexterDeshawnOffTheGrid",
  ...
  legendAltCunninghamUnaffordableTrashPlay: "scenario:legendAltCunninghamUnaffordableTrashPlay",
  ...
  legendDumDumDuplicateGearRetail: "scenario:legendDumDumDuplicateGearRetail",
  legendDumDumLegendGearRetail: "scenario:legendDumDumLegendGearRetail",
  ...
  progLiveWithTheAftermathNoUnitsRetail: "scenario:progLiveWithTheAftermathNoUnitsRetail",
