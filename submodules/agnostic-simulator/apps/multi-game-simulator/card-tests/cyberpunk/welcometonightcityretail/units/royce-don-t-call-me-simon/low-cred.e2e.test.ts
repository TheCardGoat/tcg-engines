...
import { unitRoyceDonTCallMeSimonLowCredRetail } from "@cyberpunk/testing/e2e-fixtures";

test("Royce - low Street Cred targets power two or less (Retail)", async ({ page }) => {
