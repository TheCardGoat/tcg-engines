...
import { unitSandayuOdaHanakoSGuardianRetail } from "@cyberpunk/testing/e2e-fixtures";

test("Sandayu Oda - value pairs spend units and allow unit attack (Retail)", async ({ page }) => {
