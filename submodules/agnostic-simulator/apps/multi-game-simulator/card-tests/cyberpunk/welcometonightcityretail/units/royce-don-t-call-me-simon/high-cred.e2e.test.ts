...
import { unitRoyceDonTCallMeSimonHighCredRetail } from "@cyberpunk/testing/e2e-fixtures";

const POWER_THREE_MOCK_ID = "scenario-royce-power-three-mock";

test("Royce - high Street Cred targets power three units (Retail)", async ({ page }) => {
