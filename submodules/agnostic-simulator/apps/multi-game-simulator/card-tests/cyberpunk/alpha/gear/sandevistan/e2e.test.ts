...
import { gearSandevistan } from "@cyberpunk/testing/e2e-fixtures";

test("Sandevistan - played unit can attack spent units", async ({ page }) => {
  const pom = await createPlaywrightCyberpunkSimulatorPom(page, gearSandevistan);
