...
import { legendSaburoArasakaStubbornPatriachRetail } from "@cyberpunk/testing/e2e-fixtures";

test("Saburo Arasaka - Stubborn Patriarch (Retail) - Arasaka attacker power", async ({ page }) => {
