...
describe("unitSandayuOdaHanakoSGuardian fixture behavior", () => {
  test("Sandayu Oda - value pairs spend units and allow unit attack in jsdom", async () => {
    ensureJsdomAnimationSupport();
    const view = renderCyberpunkSimulatorScenario({ scenarioId: "unitSandayuOdaHanakoSGuardian" });
    try {
