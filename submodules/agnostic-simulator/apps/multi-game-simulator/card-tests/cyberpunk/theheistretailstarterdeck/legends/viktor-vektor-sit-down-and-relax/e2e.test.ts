...
import { legendViktorVektorSitDownAndRelaxRetail } from "@cyberpunk/testing/e2e-fixtures";

test("Viktor Vektor (Retail) - call searches top deck for gear", async ({ page }) => {
