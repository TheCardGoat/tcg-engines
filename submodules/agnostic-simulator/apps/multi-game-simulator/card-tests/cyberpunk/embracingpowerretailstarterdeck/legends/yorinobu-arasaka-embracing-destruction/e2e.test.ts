...
import { legendEmbracingYorinobuArasakaEmbracingDestruction } from "@cyberpunk/testing/e2e-fixtures";
import { createPlaywrightCyberpunkSimulatorPom } from "@e2e/poms/CyberpunkPlaywrightHarnessClient";

test("Yorinobu Arasaka (Embracing Power) - first Arasaka attack draw/discard", async ({ page }) => {
