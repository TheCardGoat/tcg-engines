...
export const eventLog: SimulatorEventLogEntry[] = [
  ...
  },
  {
    ...
    message: "Attack: Signal Runner spent to attack Gate Guard.",
    tags: ["combat"],
  ...
  },
  {
    ...
    message: "React: Gate Guard used BLOCKER to redirect Signal Runner.",
    tags: ["combat"],
    entityIds: ["guard"],
  ...
  },
  {
    ...
    message: "Fight: Signal Runner (6) defeated Gate Guard (4).",
    tags: ["combat"],
    entityIds: ["runner", "guard"],
    section: { id: "fight", label: "Fight", tone: "fight" },
  },
];
