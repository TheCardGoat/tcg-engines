...
export const analyzeLines = {
  definition: {
    name: "analyze_lines",
    description:
      "Inspect enabled Gundam protocol actions for the current position. Returns action ids to rank.",
    parameters: {
      type: "object",
      properties: {
        rationale: {
          type: "string",
          description:
            "Optional free-form rationale. Stored for telemetry only; ignored by the engine.",
        },
      },
