...
export const swuDoctorPershingDedicatedToResearch = {
  ...
  cardType: "unit",
  canonicalId: "doctor-pershing#dedicated-to-research",
  slug: "doctor-pershing-dedicated-to-research",
  ...
  printings: [
    {
      ...
      collectorNumber: "72",
      rarity: "uncommon",
      imageUrl: "https://cdn.starwarsunlimited.com//08010072_EN_Doctor_Pershing_839ae00aa9.png",
    },
  ],
  abilities: [
    {
