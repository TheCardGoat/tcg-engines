...
export const swuPreVizslaStrongwilledRuler = {
  ...
  cardType: "unit",
  canonicalId: "pre-vizsla#strongwilled-ruler",
  slug: "pre-vizsla-strongwilled-ruler",
  name: "Pre Vizsla",
  printings: [
    {
      id: "ASH_053",
      ...
      collectorNumber: "53",
      rarity: "legendary",
      imageUrl: "https://cdn.starwarsunlimited.com//08010053_EN_Pre_Vizsla_04e122a1d3.png",
    },
  ],
  abilities: [
    {
