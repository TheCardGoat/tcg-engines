...
export const swuShinHatiEagerAdversary = {
  ...
  cardType: "leader",
  canonicalId: "shin-hati#eager-adversary",
  slug: "shin-hati-eager-adversary",
  name: "Shin Hati",
  printings: [
    {
      id: "ASH_016",
      ...
      collectorNumber: "16",
      rarity: "common",
      imageUrl: "https://cdn.starwarsunlimited.com//08010016_EN_Shin_Hati_Leader_3c9c7d1db0.png",
    },
  ],
  abilities: [
    {
