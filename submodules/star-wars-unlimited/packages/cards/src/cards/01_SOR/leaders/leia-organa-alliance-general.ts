...
export const swuLeiaOrganaAllianceGeneral = {
  ...
  cardType: "leader",
  canonicalId: "leia-organa#alliance-general",
  slug: "leia-organa-alliance-general",
  name: "Leia Organa",
  printings: [
    {
      id: "SOR_009",
      ...
      collectorNumber: "9",
      rarity: "common",
      imageUrl: "https://cdn.starwarsunlimited.com/SWH_01_009_Leia_Organa_Leader_d6e0eccc71.png",
    },
  ],
  abilities: [
    {
