...
import { dashingFlashfootYellow } from "./dashing-flashfoot.ts";

/**
 * Dashing Flashfoot Yellow (OMN053) — Lightning Runeblade Attack.
 *
...
describe("Dashing Flashfoot (OMN053) AAA", () => {
  it("happy+pin: printed damage green; first-damage Runechant trigger inert", () => {
    ...
    Vynnset.playAttack(dashingFlashfootYellow);
    Dash.defendWith();
    ...
    expectFabCard(Vynnset, dashingFlashfootYellow).toBeIn("graveyard");
  });
});
