...
import { crankshaftRed } from "./crankshaft.ts";

/**
 * Crankshaft, Red (DYN101) — Mechanologist Action - Attack, cost 2, 5{p},
 * 3{d}, Boost.
 * Printed: "When this is banished from boosting, put a steam counter on a
 * Hyper Driver you control."
 */

describe("Crankshaft family AAA", () => {
    ...
    const game = FabTestEngine.start(
      {
        ...
        actionPoints: 1,
        deck: [snatchRed, snatchRed, snatchRed, snatchRed, snatchRed, crankshaftRed],
      },
  ...
  it("boundary: an unboosted attack leaves this in the deck and the driver uncharged", () => {
    ...
    expect(Dash.zone("deck")).toContain(crankshaftRed.canonicalId);
