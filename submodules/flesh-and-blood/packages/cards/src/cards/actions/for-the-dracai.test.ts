...
import { forTheDracaiRed } from "./for-the-dracai.ts";

/**
 * For the Dracai (FNG008) — When this attacks a marked hero, create a Fealty token.
 */

describe("For the Dracai (FNG008) AAA", () => {
  it("happy: attacking a marked hero creates a Fealty token", () => {
    ...
    Dromai.playAttack(forTheDracaiRed, { stopAt: "on-attack" });
