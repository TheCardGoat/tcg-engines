...
/**
 * For the Realm (HNT160) — When this attacks a marked hero, create a Fealty token.
 */

describe("For the Realm (HNT160) AAA", () => {
  it("happy: attacking a marked hero creates a Fealty token", () => {
    ...
    Dromai.playAttack(forTheRealmRed, { stopAt: "on-attack" });
