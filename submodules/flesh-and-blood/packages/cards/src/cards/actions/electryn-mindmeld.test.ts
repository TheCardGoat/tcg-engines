...
import { electrynMindmeldYellow } from "./electryn-mindmeld.ts";

/**
 * Electryn Mindmeld Yellow (OMN054) — Lightning Runeblade Attack.
 *
...
describe("Dashing Flashfoot (OMN054) AAA", () => {
  it("happy+pin: printed damage green; first-damage Runechant trigger inert", () => {
    ...
    Vynnset.playAttack(electrynMindmeldYellow);
    Dash.defendWith();
    ...
    expectFabCard(Vynnset, electrynMindmeldYellow).toBeIn("graveyard");
  });
});
