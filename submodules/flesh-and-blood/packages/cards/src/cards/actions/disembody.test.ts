...
import { disembodyRed } from "./disembody.ts";

/**
 * Disembody (SUP031) — When this attacks, if you've been cheered this turn, create a Toughness token.
 */

describe("Disembody (SUP031) AAA", () => {
  it("happy: after being cheered this turn, attacking creates a Toughness token", () => {
    ...
    Tuffnut.playAttack(disembodyRed, { stopAt: "on-attack" });
    game.untilIdle({ optionals: "accept", ordering: "listed" });
