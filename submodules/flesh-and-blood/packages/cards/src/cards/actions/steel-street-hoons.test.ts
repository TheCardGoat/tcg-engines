...
for (const [color, card] of [["Blue", steelStreetHoonsBlue]] as const) {
  describe(`Steel Street Hoons ${color} galvanize`, () => {
...
describe("Steel Street Hoons no destroyed-item history", () => {
