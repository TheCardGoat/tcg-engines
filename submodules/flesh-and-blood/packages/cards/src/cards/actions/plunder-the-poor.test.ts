...
import { plunderThePoorRed } from "./plunder-the-poor.ts";

describe("Plunder the Poor family AAA", () => {
  it("happy: hitting a hero banishes the top card of their deck", () => {
    const game = FabTestEngine.start(
      { hero: bravo, hand: [plunderThePoorRed], actionPoints: 1, deck: 6 },
    ...
    Bravo.attackWith(plunderThePoorRed);
    ...
    expectFabCard(Bravo, plunderThePoorRed).toBeIn("graveyard");
  });
