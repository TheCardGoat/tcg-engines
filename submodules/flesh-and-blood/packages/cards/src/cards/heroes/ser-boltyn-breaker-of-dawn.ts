...
import { fabCardIdentitiesByCanonicalId } from "../../generated/card-identities/heroes/ser-boltyn-breaker-of-dawn.generated.ts";

export const serBoltynBreakerOfDawn = defineCard(
  fabCardIdentitiesByCanonicalId["QrKGJL7bHCFKbr9N9MNpm"],
  {
    abilities: {
