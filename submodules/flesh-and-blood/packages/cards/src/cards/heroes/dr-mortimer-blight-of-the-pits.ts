...
import { fabCardIdentitiesByCanonicalId } from "../../generated/card-identities/heroes/dr-mortimer-blight-of-the-pits.generated.ts";
import { goAgain } from "../shared/keywords.ts";

export const drMortimerBlightOfThePits = defineCard(
  fabCardIdentitiesByCanonicalId["TmJKLrtp6fCRtDcWMmRLf"],
  {
    abilities: {
