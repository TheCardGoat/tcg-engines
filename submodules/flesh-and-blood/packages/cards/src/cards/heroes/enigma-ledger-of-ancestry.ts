...
import { fabCardIdentitiesByCanonicalId } from "../../generated/card-identities/heroes/enigma-ledger-of-ancestry.generated.ts";

export const enigmaLedgerOfAncestry = defineCard(
  fabCardIdentitiesByCanonicalId["tJhRRN9kkMCnGQdQJ8TWg"],
  {
    abilities: {
