...
import { fabCardIdentitiesByCanonicalId } from "../../generated/card-identities/heroes/kassai-of-the-golden-sand.generated.ts";

export const kassaiOfTheGoldenSand = defineCard(
  fabCardIdentitiesByCanonicalId["ffKGNQcWnLkfQD7w66MRL"],
  {
    abilities: {
