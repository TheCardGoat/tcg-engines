...
import { fabCardIdentitiesByCanonicalId } from "../../generated/card-identities/heroes/briar.generated.ts";

export const briar = defineCard(fabCardIdentitiesByCanonicalId["7TjkgnbJ8tghfrkMRnTfW"], {
  keywords: [
    {
      name: "essence",
