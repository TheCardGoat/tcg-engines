...
import { fabCardIdentitiesByCanonicalId } from "../../generated/card-identities/heroes/victor-goldmane.generated.ts";

export const victorGoldmane = defineCard(fabCardIdentitiesByCanonicalId["kHmRR6Q7mJPjQgdQJcjpQ"], {
  abilities: {
