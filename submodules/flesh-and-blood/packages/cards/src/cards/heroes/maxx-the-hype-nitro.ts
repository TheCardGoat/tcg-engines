...
import { fabCardIdentitiesByCanonicalId } from "../../generated/card-identities/heroes/maxx-the-hype-nitro.generated.ts";

export const maxxTheHypeNitro = defineCard(
  fabCardIdentitiesByCanonicalId["tqBKqzRbFHWtBLQ7hhDgW"],
  {
    abilities: {
