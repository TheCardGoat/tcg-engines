...
import { fabCardIdentitiesByCanonicalId } from "../../generated/card-identities/heroes/azalea-ace-in-the-hole.generated.ts";

export const azaleaAceInTheHole = defineCard(
  fabCardIdentitiesByCanonicalId["PTFnJCdhWD9cFgMMNPqQj"],
  {
    abilities: {
