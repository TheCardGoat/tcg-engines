...
import { fabCardIdentitiesByCanonicalId } from "../../generated/card-identities/heroes/lyath-goldmane.generated.ts";

export const lyathGoldmane = defineCard(fabCardIdentitiesByCanonicalId["QrHJnzKzpMwgfJMcKQ8Dp"], {
  abilities: {
