...
import { fabCardIdentitiesByCanonicalId } from "../../generated/card-identities/heroes/dorinthea-ironsong.generated.ts";

export const dorintheaIronsong = defineCard(
  fabCardIdentitiesByCanonicalId["Djhg6DMpCpFHD9rcPNFrN"],
  {
    abilities: {
