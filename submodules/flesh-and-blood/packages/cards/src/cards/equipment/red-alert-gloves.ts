...
import { fabCardIdentitiesByCanonicalId } from "../../generated/card-identities/equipment/red-alert-gloves.generated.ts";
 ...
 *   Blade Break
 *
 * Model notes (hand-authored; arms twin of HNT192 red-alert-visor):
 ...
 */
export const redAlertGloves = defineCard(fabCardIdentitiesByCanonicalId["j9NnkHbJbdLdDLg9QtPht"], {
  keywords: [bladeBreak],
  abilities: {
