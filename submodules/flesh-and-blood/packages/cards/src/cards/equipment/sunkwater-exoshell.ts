...
import { fabCardIdentitiesByCanonicalId } from "../../generated/card-identities/equipment/sunkwater-exoshell.generated.ts";
 ...
 *   Blade Break
 *
 * Model notes (hand-authored; Sunkwater Lookout twin):
 ...
 */
export const sunkwaterExoshell = defineCard(
  fabCardIdentitiesByCanonicalId["D9zBtmGnckbkJ9TKNQfkj"],
  {
    keywords: [bladeBreak],
    abilities: {
