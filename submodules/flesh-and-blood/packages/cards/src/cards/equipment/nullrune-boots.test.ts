...
import { nullruneBoots } from "./nullrune-boots.ts";

describe("Nullrune Boots (ARC158) AAA", () => {
  it("happy: pay 1 resource to prevent 1 of Comet Collision's arcane damage", () => {
    const game = FabTestEngine.start(
      ...
      { hero: dash, life: 20, resourcePoints: 1, legs: [nullruneBoots], deck: 6 },
      FAB_MANUAL_HARNESS,
    );
    ...
    expectFabCard(Dash, nullruneBoots).toBeIn("legs");
  });
