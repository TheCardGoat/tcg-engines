...
import { leapFrogSlimeSkin } from "./leap-frog-slime-skin.ts";

/**
 * Leap Frog Slime Skin (ARK004) — Assassin Ninja Equipment - Chest.
 * (Blade Break)
...
describe("Leap Frog Slime Skin (ARK004) AAA", () => {
  it("happy: an opposing attack reaction may add this as a defending card", () => {
    const game = FabTestEngine.start(
      ...
      { hero: dash, hand: [], chest: [leapFrogSlimeSkin], life: 20, deck: 6 },
      FAB_MANUAL_HARNESS,
    );
