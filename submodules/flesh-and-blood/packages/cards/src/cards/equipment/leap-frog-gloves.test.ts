...
import { leapFrogGloves } from "./leap-frog-gloves.ts";

/**
 * Leap Frog Arms (HNT171) — Assassin Ninja Equipment - Arms.
 * (Blade Break)
...
describe("Leap Frog Arms (HNT171) AAA", () => {
  it("happy: an opposing attack reaction may add this as a defending card", () => {
    const game = FabTestEngine.start(
      ...
      { hero: dash, hand: [], arms: [leapFrogGloves], life: 20, deck: 6 },
      FAB_MANUAL_HARNESS,
    );
