...
import { leapFrogVocalSac } from "./leap-frog-vocal-sac.ts";

/**
 * Leap Frog Head (HNT169) — Assassin Ninja Equipment - Head.
 * (Blade Break)
...
describe("Leap Frog Head (HNT169) AAA", () => {
  it("happy: an opposing attack reaction may add this as a defending card", () => {
    const game = FabTestEngine.start(
      ...
      { hero: dash, hand: [], head: [leapFrogVocalSac], life: 20, deck: 6 },
      FAB_MANUAL_HARNESS,
    );
