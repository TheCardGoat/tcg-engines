...
<project_context_requirement>
  ...
  PURPOSE: Ensures product analysis is scoped to correct project and installs Agent OS in proper location
...
<execution_parameters>
  ...
  <execution_prompt>
    ...
    I'm installing Agent OS into an existing {PROJECT_TYPE} ({PROJECT_NAME}). Here's what I've gathered:
