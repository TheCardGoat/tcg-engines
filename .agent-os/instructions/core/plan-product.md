...
<project_context_requirement>
  ...
  PURPOSE: Ensures product documentation is created in correct project location
...
Use the file-creator subagent to create the file: {AGENT_OS_PATH}/product/mission.md and use the following template:
...
Use the file-creator subagent to create the file: {AGENT_OS_PATH}/product/tech-stack.md and use the following template:
