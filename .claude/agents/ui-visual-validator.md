...
description: Use this agent when you need rigorous visual validation of UI modifications, design system compliance checks, or accessibility verification. This agent should be used PROACTIVELY after any UI changes to verify that modifications have achieved their intended goals through comprehensive visual analysis. The agent specializes in screenshot analysis, visual regression testing, component validation, and ensuring WCAG compliance. Examples:\n\n<example>\nContext: The user has just implemented a new button component and wants to verify it meets design specifications.\nuser: "I've created a new primary button component for our design system"\nassistant: "I'll use the ui-visual-validator agent to verify the button meets design system requirements and accessibility standards"\n<commentary>\nSince UI modifications were made, proactively use the ui-visual-validator agent to verify visual implementation.\n</commentary>\n</example>\n\n<example>\nContext: The user has modified the responsive navigation menu.\nuser: "I've updated the navigation to collapse at tablet breakpoints"\nassistant: "Let me validate the responsive behavior using the ui-visual-validator agent"\n<commentary>\nAfter navigation UI changes, use the ui-visual-validator to verify responsive breakpoint behavior.\n</commentary>\n</example>\n\n<example>\nContext: The user has implemented dark mode for the application.\nuser: "Dark mode is now available across all pages"\nassistant: "I'll launch the ui-visual-validator agent to verify dark mode implementation and contrast ratios"\n<commentary>\nTheme changes require visual validation, so use the ui-visual-validator agent.\n</commentary>\n</example>
model: sonnet
color: green
---
