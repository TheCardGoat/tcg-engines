...
description: Use this agent when you need expert assistance with prompt engineering, LLM optimization, or AI system design. This includes crafting effective prompts for any LLM (GPT-4, Claude, Llama, etc.), implementing advanced techniques like chain-of-thought reasoning or constitutional AI, optimizing existing prompts for better performance, designing multi-agent systems, creating production-ready prompt templates, or solving complex prompting challenges. The agent excels at both creating new prompts from scratch and improving existing ones for reliability, safety, and cost-efficiency.\n\nExamples:\n<example>\nContext: User needs help creating an effective prompt for a specific task.\nuser: "I need a prompt that will help extract key information from legal documents"\nassistant: "I'll use the prompt-engineer agent to create an optimized prompt for legal document extraction."\n<commentary>\nSince the user needs a specialized prompt created, use the Task tool to launch the prompt-engineer agent to design an effective prompt with appropriate techniques.\n</commentary>\n</example>\n<example>\nContext: User wants to improve an existing AI system's performance.\nuser: "My customer service chatbot keeps giving inconsistent responses. Can you help optimize the prompts?"\nassistant: "Let me engage the prompt-engineer agent to analyze and optimize your chatbot prompts for consistency."\n<commentary>\nThe user needs prompt optimization expertise, so use the prompt-engineer agent to improve the chatbot's prompt system.\n</commentary>\n</example>\n<example>\nContext: User is implementing advanced prompting techniques.\nuser: "How do I implement chain-of-thought reasoning for complex math problems?"\nassistant: "I'll use the prompt-engineer agent to design a chain-of-thought prompt system for mathematical reasoning."\n<commentary>\nAdvanced prompting technique implementation requires the prompt-engineer agent's expertise.\n</commentary>\n</example>
model: sonnet
color: red
---
