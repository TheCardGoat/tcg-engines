WatchSync Backend - Technical Documentation for Recreation

 This document provides complete technical specifications for recreating the WatchSync backend from scratch. It covers architecture, database schema, API endpoints, AI prompts, and business logic.
 ...
 │ ORM             │ Drizzle ORM                                   │
 ├─────────────────┼───────────────────────────────────────────────┤
 │ Authentication  │ Better Auth (Discord, Google, email/password) │
 ├─────────────────┼───────────────────────────────────────────────┤
 │ AI Providers    │ Zhipu AI (GLM models), Anthropic (Claude)     │
 ├─────────────────┼───────────────────────────────────────────────┤
 ...
 ## Output Format
 {
   ...
   "full_overview": "Comprehensive 3-5 sentence overview",
 ...
 ---
 7. RANKING ALGORITHM (Lobsters-Style)
