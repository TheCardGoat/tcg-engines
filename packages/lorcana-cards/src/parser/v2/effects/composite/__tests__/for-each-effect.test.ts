...
describe("forEachEffectParser", () => {
  describe("text parsing - happy path", () => {
    it("parses 'for each character you control, gain 1 lore' correctly", () => {
      const result = forEachEffectParser.parse("for each character you control, gain 1 lore");
    ...
    it("parses 'for each character, draw 1 card' correctly", () => {
      const result = forEachEffectParser.parse("for each character, draw 1 card");
    ...
    it("parses 'for each card in your hand, gain 1 lore' correctly", () => {
      const result = forEachEffectParser.parse("for each card in your hand, gain 1 lore");
    ...
    it("parses 'for each damage counter, draw 1 card' correctly", () => {
      const result = forEachEffectParser.parse("for each damage counter, draw 1 card");
    ...
    it("parses 'for each item you have in play, gain 2 lore' correctly", () => {
      const result = forEachEffectParser.parse("for each item you have in play, gain 2 lore");
  ...
  describe("text parsing - unparseable effects", () => {
    it("returns null when the effect cannot be parsed", () => {
      const result = forEachEffectParser.parse("for each character, do something invalid");
