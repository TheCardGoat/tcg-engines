  ...
  effects: [
    {
      ...
      type: "CONSTANT",
      description:
        "During your turn, while this Unit is battling an enemy Unit that is Lv.2 or lower, it gains . (While this Unit is attacking, it deals damage before the enemy Unit.)",
      restrictions: [],
      conditions: [],
      action: {
        type: "DAMAGE",
