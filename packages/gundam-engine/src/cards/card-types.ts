...
export type KeywordAbility = {
  keyword: "Repair" | "Breach" | "Support" | "Blocker" | "First-Strike" | "High-Maneuver";
  value?: number;
};

export type ParsedAbility = {
  // Timing/trigger information
  trigger?: "ON_DEPLOY" | "ON_ATTACK" | "ON_DESTROY" | "WHEN_PAIRED" | "DURING_PAIR" | "ON_BURST";
...
export type ResourceCardDefinition = Omit<BaseCardDefinition, "cost" | "level" | "color"> & {
  cardType: "RESOURCE";
