// This file is copied from the Nakama runtime source code which is located at ./node_modules/nakama-runtime/types.d.ts.
// Reason why I copied the file here is because the original file is not exported as a module and I can't import it in my code.
...
declare namespace nkruntime {
  ...
  export interface Initializer {
     ...
     */
    registerRtBefore<T extends Envelope>(
      id: RtHookMessage,
      func: RtBeforeHookFunction<T>,
    ): void;
     ...
     */
    registerRtAfter<T extends Envelope>(
      id: RtHookMessage,
      func: RtAfterHookFunction<T>,
    ): void;
     ...
     * @throws {TypeError}
     */
    registerAfterGetMatchmakerStats(
      fn: AfterHookFunction<MatchmakerStats, void>,
    ): void;
    ...
    registerBeforeUpdateAccount(
      fn: BeforeHookFunction<UserUpdateAccount>,
    ): void;
    ...
    registerAfterUpdateAccount(
      fn: AfterHookFunction<void, UserUpdateAccount>,
    ): void;
    ...
    registerBeforeAuthenticateApple(
      fn: BeforeHookFunction<AuthenticateAppleRequest>,
    ): void;
    ...
    registerAfterAuthenticateApple(
      fn: AfterHookFunction<Session, AuthenticateAppleRequest>,
    ): void;
    ...
    registerAfterAuthenticateCustom(
      fn: AfterHookFunction<Session, AuthenticateCustomRequest>,
    ): void;
    ...
    registerBeforeAuthenticateDevice(
      fn: BeforeHookFunction<AuthenticateDeviceRequest>,
    ): void;
    ...
    registerAfterAuthenticateDevice(
      fn: AfterHookFunction<Session, AuthenticateDeviceRequest>,
    ): void;
    ...
    registerBeforeAuthenticateEmail(
      fn: BeforeHookFunction<AuthenticateEmailRequest>,
    ): void;
    ...
    registerAfterAuthenticateEmail(
      fn: AfterHookFunction<Session, AuthenticateEmailRequest>,
    ): void;
    ...
    registerBeforeAuthenticateFacebook(
      fn: BeforeHookFunction<AuthenticateFacebookRequest>,
    ): void;
    ...
    registerAfterAuthenticateFacebook(
      fn: AfterHookFunction<Session, AuthenticateFacebookRequest>,
    ): void;
    ...
    registerBeforeAuthenticateFacebookInstantGame(
      fn: BeforeHookFunction<AuthenticateFacebookInstantGameRequest>,
    ): void;
    ...
    registerAfterAuthenticateFacebookInstantGame(
      fn: AfterHookFunction<Session, AuthenticateFacebookInstantGameRequest>,
    ): void;
    ...
    registerBeforeAuthenticateGameCenter(
      fn: BeforeHookFunction<AuthenticateGameCenterRequest>,
    ): void;
    ...
    registerAfterAuthenticateGameCenter(
      fn: AfterHookFunction<Session, AuthenticateGameCenterRequest>,
    ): void;
    ...
    registerBeforeAuthenticateGoogle(
      fn: BeforeHookFunction<AuthenticateGoogleRequest>,
    ): void;
    ...
    registerAfterAuthenticateGoogle(
      fn: AfterHookFunction<Session, AuthenticateGoogleRequest>,
    ): void;
    ...
    registerBeforeAuthenticateSteam(
      fn: BeforeHookFunction<AuthenticateSteamRequest>,
    ): void;
    ...
    registerAfterAuthenticateSteam(
      fn: AfterHookFunction<Session, AuthenticateSteamRequest>,
    ): void;
    ...
    registerBeforeListChannelMessages(
      fn: BeforeHookFunction<ListChannelMessagesRequest>,
    ): void;
    ...
    registerAfterListChannelMessages(
      fn: AfterHookFunction<ChannelMessageList, ListChannelMessagesRequest>,
    ): void;
    ...
    registerAfterListFriends(
      fn: AfterHookFunction<FriendList, ListFriendsRequest>,
    ): void;
    ...
    registerBeforeListFriendsOfFriends(
      fn: BeforeHookFunction<ListFriendsOfFriendsRequest>,
    ): void;
     ...
     * @throws {TypeError}
     */
    registerAfterListFriendsOfFriends(
      fn: AfterHookFunction<FriendsOfFriendsList, ListFriendsOfFriendsRequest>,
    ): void;
    ...
    registerAfterAddFriends(
      fn: AfterHookFunction<void, AddFriendsRequest>,
    ): void;
    ...
    registerBeforeDeleteFriends(
      fn: BeforeHookFunction<DeleteFriendsRequest>,
    ): void;
    ...
    registerAfterDeleteFriends(
      fn: AfterHookFunction<void, DeleteFriendsRequest>,
    ): void;
    ...
    registerBeforeBlockFriends(
      fn: BeforeHookFunction<BlockFriendsRequest>,
    ): void;
    ...
    registerAfterBlockFriends(
      fn: AfterHookFunction<void, BlockFriendsRequest>,
    ): void;
    ...
    registerBeforeImportFacebookFriends(
      fn: BeforeHookFunction<ImportFacebookFriendsRequest>,
    ): void;
    ...
    registerAfterImportFacebookFriends(
      fn: AfterHookFunction<void, ImportFacebookFriendsRequest>,
    ): void;
    ...
    registerBeforeImportSteamFriends(
      fn: BeforeHookFunction<ImportSteamFriendsRequest>,
    ): void;
    ...
    registerAfterImportSteamFriends(
      fn: AfterHookFunction<void, ImportSteamFriendsRequest>,
    ): void;
    ...
    registerAfterCreateGroup(
      fn: AfterHookFunction<Group, CreateGroupRequest>,
    ): void;
    ...
    registerAfterUpdateGroup(
      fn: AfterHookFunction<void, UpdateGroupRequest>,
    ): void;
    ...
    registerAfterDeleteGroup(
      fn: AfterHookFunction<void, DeleteGroupRequest>,
    ): void;
    ...
    registerAfterLeaveGroup(
      fn: AfterHookFunction<void, LeaveGroupRequest>,
    ): void;
    ...
    registerBeforeAddGroupUsers(
      fn: BeforeHookFunction<AddGroupUsersRequest>,
    ): void;
    ...
    registerAfterAddGroupUsers(
      fn: AfterHookFunction<void, AddGroupUsersRequest>,
    ): void;
    ...
    registerBeforeBanGroupUsers(
      fn: BeforeHookFunction<BanGroupUsersRequest>,
    ): void;
    ...
    registerAfterBanGroupUsers(
      fn: AfterHookFunction<void, BanGroupUsersRequest>,
    ): void;
    ...
    registerBeforeKickGroupUsers(
      fn: BeforeHookFunction<KickGroupUsersRequest>,
    ): void;
    ...
    registerAfterKickGroupUsers(
      fn: AfterHookFunction<void, KickGroupUsersRequest>,
    ): void;
    ...
    registerBeforePromoteGroupUsers(
      fn: BeforeHookFunction<PromoteGroupUsersRequest>,
    ): void;
    ...
    registerAfterPromoteGroupUsers(
      fn: AfterHookFunction<void, PromoteGroupUsersRequest>,
    ): void;
    ...
    registerBeforeDemoteGroupUsers(
      fn: BeforeHookFunction<DemoteGroupUsersRequest>,
    ): void;
    ...
    registerAfterDemoteGroupUsers(
      fn: AfterHookFunction<void, DemoteGroupUsersRequest>,
    ): void;
    ...
    registerBeforeListGroupUsers(
      fn: BeforeHookFunction<ListGroupUsersRequest>,
    ): void;
    ...
    registerAfterListGroupUsers(
      fn: AfterHookFunction<GroupUserList, ListGroupUsersRequest>,
    ): void;
    ...
    registerBeforeListUserGroups(
      fn: BeforeHookFunction<ListUserGroupsRequest>,
    ): void;
    ...
    registerAfterListUserGroups(
      fn: AfterHookFunction<UserGroupList, ListUserGroupsRequest>,
    ): void;
    ...
    registerAfterListGroups(
      fn: AfterHookFunction<GroupList, ListGroupsRequest>,
    ): void;
    ...
    registerBeforeDeleteLeaderboardRecord(
      fn: BeforeHookFunction<DeleteLeaderboardRecordRequest>,
    ): void;
    ...
    registerAfterDeleteLeaderboardRecord(
      fn: AfterHookFunction<void, DeleteLeaderboardRecordRequest>,
    ): void;
    ...
    registerBeforeDeleteTournamentRecord(
      fn: BeforeHookFunction<DeleteTournamentRecordRequest>,
    ): void;
     ...
     * @throws {TypeError}
     */
    registerAfterDeleteTournamentRecord(
      fn: AfterHookFunction<void, DeleteTournamentRecordRequest>,
    ): void;
    ...
    registerBeforeListLeaderboardRecords(
      fn: BeforeHookFunction<ListLeaderboardRecordsRequest>,
    ): void;
    ...
    registerBeforeWriteLeaderboardRecord(
      fn: BeforeHookFunction<WriteLeaderboardRecordRequest>,
    ): void;
    ...
    registerAfterWriteLeaderboardRecord(
      fn: AfterHookFunction<LeaderboardRecord, WriteLeaderboardRecordRequest>,
    ): void;
    ...
    registerBeforeListLeaderboardRecordsAroundOwner(
      fn: BeforeHookFunction<ListLeaderboardRecordsAroundOwnerRequest>,
    ): void;
    ...
    registerBeforeLinkFacebook(
      fn: BeforeHookFunction<LinkFacebookRequest>,
    ): void;
    ...
    registerAfterLinkFacebook(
      fn: AfterHookFunction<void, LinkFacebookRequest>,
    ): void;
    ...
    registerBeforeLinkFacebookInstantGame(
      fn: BeforeHookFunction<AccountFacebookInstantGame>,
    ): void;
    ...
    registerAfterLinkFacebookInstantGame(
      fn: AfterHookFunction<void, AccountFacebookInstantGame>,
    ): void;
    ...
    registerBeforeLinkGameCenter(
      fn: BeforeHookFunction<AccountGameCenter>,
    ): void;
    ...
    registerAfterLinkGameCenter(
      fn: AfterHookFunction<void, AccountGameCenter>,
    ): void;
    ...
    registerAfterListMatches(
      fn: AfterHookFunction<MatchList, ListMatchesRequest>,
    ): void;
    ...
    registerBeforeListNotifications(
      fn: BeforeHookFunction<ListNotificationsRequest>,
    ): void;
    ...
    registerAfterListNotifications(
      fn: AfterHookFunction<ApiNotificationList, ListNotificationsRequest>,
    ): void;
    ...
    registerBeforeDeleteNotifications(
      fn: BeforeHookFunction<DeleteNotificationsRequest>,
    ): void;
     ...
     * @throws {TypeError}
     */
    registerAfterDeleteNotifications(
      fn: AfterHookFunction<void, DeleteNotificationsRequest>,
    ): void;
    ...
    registerBeforeListStorageObjects(
      fn: BeforeHookFunction<ListStorageObjectsRequest>,
    ): void;
    ...
    registerAfterListStorageObjects(
      fn: AfterHookFunction<StorageObjectList, ListStorageObjectsRequest>,
    ): void;
    ...
    registerBeforeReadStorageObjects(
      fn: BeforeHookFunction<ReadStorageObjectsRequest>,
    ): void;
    ...
    registerAfterReadStorageObjects(
      fn: AfterHookFunction<StorageObjects, ReadStorageObjectsRequest>,
    ): void;
    ...
    registerBeforeWriteStorageObjects(
      fn: BeforeHookFunction<WriteStorageObjectsRequest>,
    ): void;
    ...
    registerAfterWriteStorageObjects(
      fn: AfterHookFunction<StorageObjectAcks, WriteStorageObjectsRequest>,
    ): void;
    ...
    registerBeforeDeleteStorageObjects(
      fn: BeforeHookFunction<DeleteStorageObjectsRequest>,
    ): void;
    ...
    registerAfterDeleteStorageObjects(
      fn: AfterHookFunction<void, DeleteStorageObjectsRequest>,
    ): void;
    ...
    registerBeforeJoinTournament(
      fn: BeforeHookFunction<JoinTournamentRequest>,
    ): void;
    ...
    registerAfterJoinTournament(
      fn: AfterHookFunction<void, JoinTournamentRequest>,
    ): void;
    ...
    registerBeforeListTournamentRecords(
      fn: BeforeHookFunction<ListTournamentRecordsRequest>,
    ): void;
    ...
    registerAfterListTournamentRecords(
      fn: AfterHookFunction<TournamentRecordList, ListTournamentRecordsRequest>,
    ): void;
    ...
    registerBeforeListTournaments(
      fn: BeforeHookFunction<ListTournamentsRequest>,
    ): void;
    ...
    registerAfterListTournaments(
      fn: AfterHookFunction<TournamentList, ListTournamentsRequest>,
    ): void;
    ...
    registerBeforeWriteTournamentRecord(
      fn: BeforeHookFunction<WriteTournamentRecordRequest>,
    ): void;
    ...
    registerAfterWriteTournamentRecord(
      fn: AfterHookFunction<LeaderboardRecord, WriteTournamentRecordRequest>,
    ): void;
    ...
    registerBeforeListTournamentRecordsAroundOwner(
      fn: BeforeHookFunction<ListTournamentRecordsAroundOwnerRequest>,
    ): void;
    ...
    registerAfterUnlinkFacebook(
      fn: AfterHookFunction<void, AccountFacebook>,
    ): void;
    ...
    registerBeforeUnlinkFacebookInstantGame(
      fn: BeforeHookFunction<AccountFacebook>,
    ): void;
    ...
    registerBeforeValidatePurchaseApple(
      fn: BeforeHookFunction<ValidatePurchaseAppleRequest>,
    ): void;
    ...
    registerBeforeValidateSubscriptionApple(
      fn: BeforeHookFunction<ValidateSubscriptionAppleRequest>,
    ): void;
     ...
     * @throws {TypeError}
     */
    registerAfterValidateSubscriptionApple(
      fn: AfterHookFunction<
    ...
    registerBeforeValidatePurchaseGoogle(
      fn: BeforeHookFunction<ValidatePurchaseGoogleRequest>,
    ): void;
     ...
     * @throws {TypeError}
     */
    registerBeforeValidateSubscriptionGoogle(
      fn: BeforeHookFunction<ValidateSubscriptionGoogleRequest>,
    ): void;
     ...
     * @throws {TypeError}
     */
    registerAfterValidateSubscriptionGoogle(
      fn: AfterHookFunction<
        ValidateSubscriptionResponse,
    ...
    registerBeforeValidatePurchaseHuawei(
      fn: BeforeHookFunction<ValidatePurchaseHuaweiRequest>,
    ): void;
     ...
     */
    registerMatch<State = MatchState>(
      name: string,
    ...
    registerPurchaseNotificationApple(
      fn: PurchaseNotificationAppleFunction,
    ): void;
    ...
    registerSubscriptionNotificationApple(
      fn: SubscriptionNotificationAppleFunction,
    ): void;
    ...
    registerPurchaseNotificationGoogle(
      fn: PurchaseNotificationGoogleFunction,
    ): void;
    ...
    registerSubscriptionNotificationGoogle(
      fn: SubscriptionNotificationGoogleFunction,
    ): void;
  ...
  type Envelope =
    ...
    | EnvelopePartyJoin
    | EnvelopePartyLeave
    | EnvelopePartyPromote
    | EnvelopePartyAccept
    | EnvelopePartyRemove
    | EnvelopePartyClose
    | EnvelopePartyJoinRequestList
    | EnvelopePartyMatchmakerAdd
    | EnvelopePartyMatchmakerRemove
    | EnvelopePartyDataSend
  ...
  export type ValidatedPurchaseStore =
    | "APPLE_APP_STORE"
    | "GOOGLE_PLAY_STORE"
    | "HUAWEI_APP_GALLERY";

  export type ValidatedPurchaseEnvironment =
    | "UNKNOWN"
    | "SANDBOX"
    | "PRODUCTION";
  ...
  export interface Nakama {
    ...
    jwtGenerate(
      ...
      signingKey: string,
      claims: { [key: string]: string | number | boolean },
    ): string;
    ...
    multiUpdate(
      ...
      storageObjectsDeletes: StorageDeleteRequest[] | null,
      walletUpdates: WalletUpdate[] | null,
      updateLedger?: boolean,
    ): {
      storageWriteAcks: StorageWriteAck[];
      walletUpdateAcks: WalletUpdateResult[];
    };
  ...
  export interface Satori {
    ...
    authenticate(
      id: string,
      properties?: AuthPropertiesUpdate,
      ipAddress?: string,
    ): Properties;
