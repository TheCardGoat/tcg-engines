...
export type LogEntry =
  ...
  | WinMatchEntry
  | ConcedeMatchEntry
  | RematchRequestedEntry
  | RematchAcceptedEntry
  | RestartingGameEntry
  | LobbyCreated
  | LobbyReady
  | PlayerLeft
  ...
  | EndGameEntry
  | AutoTargetEngaged
  | RequestGameCancellationEntry
  | AcceptGameCancellationEntry
  | RejectGameCancellationEntry
  | TutoringCardEntry
  | TutoredCardEntry
  | QuestWithAllEntry
  | PlayerRequestAnswerEntry
  | UndoMoveEntry
  | UndoTurnEntry
  | UndoTurnRequestEntry
  | UndoMoveRequestEntry
  | ManualModeRequestEntry
  | DrawEmptyDeckEntry
  | LogEntryQuest
  | LogEntryEffectPrevention
  | DropPlayerEntry
  | LogEntrySkipDrawStep;
