...
import {
  allCardsInYourDeck,
  forEachCardInYourDiscard,
  forEachCharYouHaveInPlay,
} from "@lorcanito/lorcana-engine/abilities/amounts";
import {
  atTheEndOfYourTurn,
...
import {
  ...
  ifYouHaveACardInYourDiscardNamed,
  ifYouHaveCharacterNamed,
  whileAnotherDamagedCharacterIsInPlay,
  whileThereAreXOrMoreDamagedCharacter,
...
import {
  ...
  drawXCards,
  entersPlayExerted,
  exertChosenCharacterWithCharacteristics,
  exertChosenOpposingCharacter,
  getStrengthThisChallenge,
  getStrengthThisTurn,
  healEffect,
  lookAtTopCardOfYourDeckAndPutItOnTopOrBottom,
  mayBanish,
  moveDamageEffect,
  opponentCharactersLoseStrengthThisTurn,
  ...
  readyChosenCharacterWithCharacteristics,
...
export const rapunzelHighClimber: LorcanitoCharacterCard = {
  id: "x5i",
  name: "Rapunzel",
  title: "High Climber",
...
export const dormouseEasilyAgitated: LorcanitoCharacterCard = {
  id: "vud",
  name: "Dormouse",
...
export const vanellopeVonSchweetzSpunkySpeedster: LorcanitoCharacterCard = {
  id: "os2",
...
export const thumperYoungBunny: LorcanitoCharacterCard = {
  id: "w1z",
  name: "Thumper",
  title: "Young Bunny",
  characteristics: ["storyborn", "ally"],
...
export const friendOwlCantankerousNeighbor: LorcanitoCharacterCard = {
  id: "vso",
  name: "Friend Owl",
...
export const deweyLovableShowoff: LorcanitoCharacterCard = {
  id: "h8j",
  name: "Dewey",
...
export const minnieMouseDaringDefender: LorcanitoCharacterCard = {
  id: "p0a",
  name: "Minnie Mouse",
...
export const megaraPartOfThePlan: LorcanitoCharacterCard = {
  id: "yxa",
  name: "Megara",
...
export const ryderFleetfootedInfiltrator: LorcanitoCharacterCard = {
  id: "qio",
  name: "Ryder",
...
export const bambiPrinceOfTheForest: LorcanitoCharacterCard = {
  id: "ax8",
  name: "Bambi",
...
export const khanWarHorse: LorcanitoCharacterCard = {
  id: "au3",
  name: "Khan",
  title: "War Horse",
  characteristics: ["storyborn", "ally"],
...
export const calhounHardnosedLeader: LorcanitoCharacterCard = {
  id: "tnp",
  name: "Calhoun",
...
export const jimDearBelovedHusband: LorcanitoCharacterCard = {
  id: "qox",
  name: "Jim Dear",
...
export const camiloMadrigalAtTheCenterOfAttention: LorcanitoCharacterCard = {
  id: "mef",
...
export const mushuFasttalkingDragon: LorcanitoCharacterCard = {
  id: "gii",
  name: "Mushu",
...
export const wasabiAlwaysPrepared: LorcanitoCharacterCard = {
  id: "nzq",
  name: "Wasabi",
...
export const charlotteLaBouffMardiGrasPrincess: LorcanitoCharacterCard = {
  id: "ng9",
...
export const darlingDearBelovedWife: LorcanitoCharacterCard = {
  id: "kfn",
  name: "Darling Dear",
  title: "Beloved Wife",
  characteristics: ["storyborn", "ally"],
...
export const lenaSabrewingPureEnergy: LorcanitoCharacterCard = {
  id: "ix0",
  name: "Lena Sabrewing",
  title: "Pure Energy",
...
export const tipoJuniorChipmunk: LorcanitoCharacterCard = {
  id: "yv7",
  name: "Tipo",
  title: "Junior Chipmunk",
  characteristics: ["storyborn", "ally"],
...
export const billTheLizardChimneySweep: LorcanitoCharacterCard = {
  id: "rga",
...
export const louisEndearingAlligator: LorcanitoCharacterCard = {
  id: "hqv",
  name: "Louis",
...
export const arthurDeterminedSquire: LorcanitoCharacterCard = {
  id: "cto",
  name: "Arthur",
...
export const atitayaFangGeneral: LorcanitoCharacterCard = {
  id: "s8s",
  name: "Atitaya",
  title: "Fang General",
  characteristics: ["storyborn", "ally"],
...
export const genieSatisfiedDragon: LorcanitoCharacterCard = {
  id: "sub",
  name: "Genie",
