...
//  */
// const makeMove = (type: string, args?: unknown, playerID?: string | null) => ({
...
//  * @param {string}  credentials - (optional) The credentials for the player making this action.
//  */
// const gameEvent = (type: string, args?: any, playerID?: string | null) => ({
...
//  */
// const update = (state: CoreEngineState, deltalog: LogEntry[]) => ({
...
//  */
// const reset = (state: CoreEngineState) => ({
...
//  * @param {string}  credentials - (optional) The credentials for the player making this action.
//  */
// const undo = (playerID?: string | null) => ({
...
//  * @param {string}  credentials - (optional) The credentials for the player making this action.
//  */
// const redo = (playerID?: string | null) => ({
