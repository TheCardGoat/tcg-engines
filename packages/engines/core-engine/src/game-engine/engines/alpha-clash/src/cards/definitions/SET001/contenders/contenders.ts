...
import type { ContenderCard } from "../../cardTypes";

export const alphaWarrior: ContenderCard = {
  id: "AC001-001",
  name: "Alpha Warrior",
  type: "contender",
  set: "AC001",
...
export const rougeAssassin: ContenderCard = {
  id: "AC001-002",
  name: "Rogue Assassin",
  type: "contender",
  set: "AC001",
...
export const harbingerMystic: ContenderCard = {
  id: "AC001-003",
...
export const progenitorTitan: ContenderCard = {
  id: "AC001-004",
...
export const discardedOutcast: ContenderCard = {
  id: "AC001-005",
