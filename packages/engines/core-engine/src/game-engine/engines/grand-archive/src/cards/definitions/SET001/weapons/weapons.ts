...
import type { WeaponCard } from "../../cardTypes";

/**
 * Flame Sword - Basic Fire Weapon
 */
export const flameSword: WeaponCard = {
 ...
 */
export const crystalStaff: WeaponCard = {
 ...
 */
export const windBlade: WeaponCard = {
 ...
 */
export const runicHammer: WeaponCard = {
 ...
 */
export const arcaneOrb: WeaponCard = {
  ...
  abilities: [
    {
      type: "triggered",
      effect:
        "When you cast an action, this weapon gains +1 power until end of turn.",
      timing: "On cast",
    },
    {
      type: "activated",
