...
import type { ChampionCard } from "../../cardTypes";

/**
 * Test Fire Champion - Level 0
 */
export const testFireChampion: ChampionCard = {
 ...
 */
export const testWaterChampion: ChampionCard = {
 ...
 */
export const testWindChampion: ChampionCard = {
 ...
 */
export const testDualChampion: ChampionCard = {
  ...
  abilities: [
    ...
    },
    {
      ...
      effect:
        "Deal 1 damage to target champion or ally, then heal 1 damage from another target.",
    },
  ],
  implemented: true,
};
 ...
 */
export const CHAMPIONS: Record<string, ChampionCard> = {
