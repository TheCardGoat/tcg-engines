...
import { card } from "./043-rasid-039-s-maganac";
...
describe("GD01-043: Rasid&#039;s Maganac", () => {
  describe("Card Definition", () => {
    it("should have correct basic properties", () => {
      expect(card.id).toBe("GD01-043");
      expect(card.name).toBe("Rasid&#039;s Maganac");
      expect(card.number).toBe(43);
    ...
    it("should have correct link requirement", () => {
      expect(card.linkRequirement).toEqual(["(maganac corps) trait"]);
    });
