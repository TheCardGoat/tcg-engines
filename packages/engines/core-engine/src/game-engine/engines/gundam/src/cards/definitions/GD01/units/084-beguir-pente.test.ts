...
import { card } from "./084-beguir-pente";
...
describe("GD01-084: Beguir-Pente", () => {
  describe("Card Definition", () => {
    it("should have correct basic properties", () => {
      expect(card.id).toBe("GD01-084");
      expect(card.name).toBe("Beguir-Pente");
      expect(card.number).toBe(84);
    ...
    it("should have correct link requirement", () => {
      expect(card.linkRequirement).toEqual(["-"]);
    });
  });
