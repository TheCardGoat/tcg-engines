...
import { kshatriya } from "./044-kshatriya";

/**
 * Tests for GD01-044: Kshatriya
 *
 * Card Properties:
 * - Cost: 4, Level: 5, AP: 5, HP: 4
 * - Color: red
 * - Type: triggered
 * - Rarity: legendary
 * - Traits: zeon
...
describe("GD01-044: Kshatriya", () => {
  describe("Card Definition", () => {
    it("should have correct basic properties", () => {
      expect(kshatriya.id).toBe("GD01-044");
      expect(kshatriya.name).toBe("Kshatriya");
      expect(kshatriya.number).toBe(44);
      expect(kshatriya.set).toBe("GD01");
      expect(kshatriya.type).toBe("unit");
      expect(kshatriya.rarity).toBe("legendary");
    });

    it("should have correct stats", () => {
      expect(kshatriya.cost).toBe(4);
      expect(kshatriya.level).toBe(5);
      expect(kshatriya.ap).toBe(5);
    ...
    it("should have correct link requirement", () => {
      expect(kshatriya.linkRequirement).toEqual(["marida cruz"]);
    });

    it("should have card text", () => {
      expect(kshatriya.text).toBeTruthy();
      expect(kshatriya.text.length).toBeGreaterThan(0);
    });
  });

  describe("Abilities Definition", () => {
    it("should have abilities array", () => {
      expect(kshatriya.abilities).toBeDefined();
      expect(Array.isArray(kshatriya.abilities)).toBe(true);
    });

    it("should have at least one ability", () => {
      expect(kshatriya.abilities.length).toBeGreaterThan(0);
    });

    it("should have properly structured abilities", () => {
      kshatriya.abilities.forEach((ability) => {
