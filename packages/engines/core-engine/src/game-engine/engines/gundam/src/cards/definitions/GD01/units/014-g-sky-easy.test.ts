...
import { card } from "./014-g-sky-easy";
...
describe("GD01-014: G-Sky Easy", () => {
  describe("Card Definition", () => {
    it("should have correct basic properties", () => {
      expect(card.id).toBe("GD01-014");
      expect(card.name).toBe("G-Sky Easy");
      expect(card.number).toBe(14);
    ...
    it("should have correct link requirement", () => {
      expect(card.linkRequirement).toEqual(["(white base team) trait"]);
    });
