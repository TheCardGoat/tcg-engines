...
import { card } from "./074-chuchu-039-s-demi-trainer";
...
describe("GD01-074: Chuchu&#039;s Demi Trainer", () => {
  describe("Card Definition", () => {
    it("should have correct basic properties", () => {
      expect(card.id).toBe("GD01-074");
      expect(card.name).toBe("Chuchu&#039;s Demi Trainer");
      expect(card.number).toBe(74);
    ...
    it("should have correct traits", () => {
      expect(card.traits).toEqual(["academy"]);
    });
    ...
    it("should have correct link requirement", () => {
      expect(card.linkRequirement).toEqual(["chuatury panlunch"]);
    });
