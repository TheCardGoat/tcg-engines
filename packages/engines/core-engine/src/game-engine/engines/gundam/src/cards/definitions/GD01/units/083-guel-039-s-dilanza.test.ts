...
import { card } from "./083-guel-039-s-dilanza";
...
describe("GD01-083: Guel&#039;s Dilanza", () => {
  describe("Card Definition", () => {
    it("should have correct basic properties", () => {
      expect(card.id).toBe("GD01-083");
      expect(card.name).toBe("Guel&#039;s Dilanza");
      expect(card.number).toBe(83);
    ...
    it("should have correct link requirement", () => {
      expect(card.linkRequirement).toEqual(["(academy) trait"]);
    });
  });
