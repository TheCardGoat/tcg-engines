import { exertedCharCantReadyNextTurn } from "~/game-engine/engines/lorcana/src/abilities/effect";
import type { LorcanaCharacterCardDefinition } from "~/game-engine/engines/lorcana/src/cards/lorcana-card-repository";

export const kingOfHeartsMonarchOfWonderland: LorcanaCharacterCardDefinition = {
  id: "ss4",
