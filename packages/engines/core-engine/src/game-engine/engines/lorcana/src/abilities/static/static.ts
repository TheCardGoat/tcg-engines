...
// **7.6.5. **Some static effects apply outside of the Play zone. These specify the aspect and time they apply to. ***Example:** An effect that reads “For each character card in your discard, you pay 1 *\{I\} * less to play this character” would apply* *outside of play. *
