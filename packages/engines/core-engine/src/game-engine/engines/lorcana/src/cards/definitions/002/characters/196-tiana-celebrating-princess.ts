...
import { opponentCantPlayActions } from "~/game-engine/engines/lorcana/src/abilities/effect";
import type { LorcanaCharacterCardDefinition } from "~/game-engine/engines/lorcana/src/cards/lorcana-card-repository";

export const tianaCelebratingPrincess: LorcanaCharacterCardDefinition = {
  id: "nyj",
  name: "Tiana",
