...
export type EventHandler<State = unknown, Context = unknown> = (event: LobbyEvent<State, Context>) => void | Promise<void>;
...
export declare class LightweightEventBus<State = unknown, Context = unknown> implements EventBus<State, Context> {
    private handlers;
    emit(event: LobbyEvent<State, Context>): void;
    on(handler: EventHandler<State, Context>): () => void;
    off(handler: EventHandler<State, Context>): void;
