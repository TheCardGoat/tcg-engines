...
export type ServerMessages<T, C> = MessageRejectedOutMessage | PlayerJoinedOutMessage<C> | PlayerLeftOutMessage | UpdateStateOutMessage<T, C> | PlayerAcceptedOutMessage | PlayerRejectedOutMessage;
...
//# sourceMappingURL=lobby-messages-type.d.ts.map