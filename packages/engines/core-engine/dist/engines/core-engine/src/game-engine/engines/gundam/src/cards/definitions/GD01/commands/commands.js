...
import { discardACard, drawXCard, } from "~/game-engine/engines/gundam/src/abilities/effects/effects";
...
export const overflowingAffection = {
    id: "GD01-118",
    implemented: true,
    cost: 1,
    level: 2,
...
export const theWitchAndTheBride = {
    id: "GD01-117",
    implemented: true,
    cost: 2,
    level: 5,
...
export const takeAStandCitizens = {
    id: "GD01-100",
    implemented: true,
    set: "GD01",
    rarity: "rare",
