...
import type { BaseCoreCardFilter, DefaultPlayerState } from "./types/game-specific-types";
...
import type { DefaultCardDefinition, DefaultGameState, GameSpecificCardDefinition, GameSpecificCardFilter, GameSpecificGameState, GameSpecificPlayerState } from "./types/game-specific-types";
...
export type FnContext<G extends GameSpecificGameState = DefaultGameState, CardDefinition extends GameSpecificCardDefinition = DefaultCardDefinition, PlayerState extends GameSpecificPlayerState = DefaultPlayerState, CardFilter extends GameSpecificCardFilter = BaseCoreCardFilter, CardInstance extends CoreCardInstance<CardDefinition> = CoreCardInstance<CardDefinition>> = {
    coreOps: CoreOperation<G, CardDefinition, PlayerState, CardFilter, CardInstance>;
    gameOps: CoreEngineInterface;
    playerID?: PlayerID | null;
...
//# sourceMappingURL=game-configuration.d.ts.map