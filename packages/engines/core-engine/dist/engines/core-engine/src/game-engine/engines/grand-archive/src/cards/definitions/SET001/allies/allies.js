...
export const fireSalamander = {
    ...
    abilities: [
        {
            type: "triggered",
            effect: "When this ally enters the field, deal 1 damage to target champion or ally.",
            timing: "On enter",
        },
    ],
    keywords: ["Stealth"],
...
export const arcaneScholar = {
    ...
    abilities: [
        {
            type: "triggered",
            effect: "When this ally enters the field, look at the top 3 cards of your deck. Put one into your hand and the rest on the bottom of your deck.",
            timing: "On enter",
        },
        {
            type: "activated",
...
//# sourceMappingURL=allies.js.map