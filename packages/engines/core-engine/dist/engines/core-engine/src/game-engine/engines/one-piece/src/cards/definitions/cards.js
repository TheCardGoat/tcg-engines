...
export const allOnePieceCardsById = {
...
export const getCardsBySet = (setCode) => {
    return Object.values(allOnePieceCardsById).filter((card) => card.set === setCode);
};
export const getCardsByCategory = (category) => {
    return Object.values(allOnePieceCardsById).filter((card) => card.category === category);
};
export const getCardsByColor = (color) => {
    return Object.values(allOnePieceCardsById).filter((card) => card.colors.some((c) => c === color));
};
export const getCardsByRarity = (rarity) => {
    return Object.values(allOnePieceCardsById).filter((card) => card.rarity === rarity);
};
...
export const getDeckEligibleCards = (leaderColors) => {
...
export const getImplementedCardCount = () => {
