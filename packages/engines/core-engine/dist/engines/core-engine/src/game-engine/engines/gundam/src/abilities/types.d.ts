...
export interface BaseAbility {
    type?: "main" | "action" | "deploy" | "static" | "when-paired" | "destroyed" | "attack" | "burst";
...
export type StaticAbilities = RepairAbility | BlockerAbility | BreachAbility | HighManeuverAbility;
export declare const isBlockerAbility: (ability: Ability) => ability is BlockerAbility;
export type Ability = MainAbility | ActionAbility | DeployAbility | WhenPaired | Destroyed | Attack | BurstAbility | StaticAbilities;
