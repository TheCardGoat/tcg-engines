...
import type { ChatMessage, CoreEngineState, FilteredMetadata, LogEntry, SyncInfo } from "~/game-engine/core-engine/game-configuration";
...
export {};
//# sourceMappingURL=authoritative-client-types.d.ts.map