...
export class OnePieceCardRepository extends CardRepository {
     ...
     */
    getDeckEligibleCards(leaderColors) {
     ...
     */
    validateDeck(leaderPublicId, deckCardIds) {
        const errors = [];
        // Get leader card
        ...
        if (deckCardIds.length !== 50) {
            errors.push(`Deck must contain exactly 50 cards, found ${deckCardIds.length}`);
        }
...
//# sourceMappingURL=one-piece-card-repository.js.map