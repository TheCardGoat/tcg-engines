 ...
 */
function getZoneVisibility(zone) {
    switch (zone) {
        case "hand":
        case "memory":
        case "innerLineage":
 ...
 */
export function getOpponent(playerId, playerOrder) {
...
//   return false;
// }
//# sourceMappingURL=grand-archive-game-definition.js.map