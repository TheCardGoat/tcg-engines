...
export type CardEffects = CardContinuousEffects | DiscardEffect | HealEffect | MoveCardEffect | RestCardEffect;
export type PlayerEffects = DrawEffect | PlayerContinuousEffects;
export type Effect = PlayerEffects | CardEffects;
export declare const isPlayerRestrictionEffect: (effect: Effect) => effect is PlayerRestrictionEffect;
export declare const isAttributeEffect: (effect: Effect) => effect is AttributeEffect;
export declare const isContinuousEffect: (effect: Effect) => effect is CardContinuousEffects | PlayerRestrictionEffect;
export {};
