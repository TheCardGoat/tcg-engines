...
export type GameAction = "deployUnit" | "deployBase" | "pairPilot" | "playCommand" | "activateMain" | "attackWithUnit" | "activateAction" | "playActionCommand" | "pass" | "concede";
...
export type TriggerTiming = "onDeploy" | "onAttack" | "onDestroy" | "onDamage" | "onPair" | "duringPair" | "startOfTurn" | "endOfTurn";
export type ActionType = "deployUnit" | "deployBase" | "pairPilot" | "playCommand" | "activateMain" | "attackWithUnit" | "activateAction" | "playActionCommand" | "pass" | "concede" | "turnStart" | "turnEnd" | "phaseStep" | "phaseTransition" | "draw" | "addResource" | "alterHand";
export type PlayerId = string;
export type InstanceId = string;
export type PublicId = string;
export type GameCards = Record<PlayerId, Record<InstanceId, PublicId>>;
//# sourceMappingURL=gundam-engine-types.d.ts.map