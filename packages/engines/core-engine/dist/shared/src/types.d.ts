...
export type MatchMove = ChangeGameModeMove | AlterHandMove | RequestMove | GenerateOnDemandLayerMove | ConcedeMatchMove | ConcedeGameMove | ShiftMove | ResolveLayerMove | SkipLayerMove | AcceptOptionalLayerMove | DrawCardMove | RevealCardMove | UpdateLoreMove | ShuffleDeckMove | ScryMove | UndoMove | UndoTurnMove | UndoLastTurnMove | ActivateAbilityMove | UpdateCardDamageMove | ChooseWhoGoesFirstMove | QuestMove | QuestWithAllMove | TapCardMove | MoveCardMove | TutorCardMove | SingTogetherMove | SingMove | PassTurnMove | PutCardIntoInkwellMove | EnterLocationMove | MoveToLocationMove | AnswerPlayerRequest | CancelPlayerRequest | ChallengeMove | PlayerJoinedMove | PlayerLeftMove | PlayCardMove | DropPlayerMove;
interface BaseMove {
    type: MatchMove["type"];
    number?: number;
    id?: string;
