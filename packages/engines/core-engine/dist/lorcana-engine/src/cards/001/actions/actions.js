...
import { chosenCharacter, self, } from "@lorcanito/lorcana-engine/abilities/targets";
import { chosenCharacterGainsSupport, dealDamageEffect, mayBanish, readyAndCantQuest, } from "@lorcanito/lorcana-engine/effects/effects";
export const controlYourTemper = {
    id: "eny",
    name: "Control Your Temper!",
    characteristics: ["action"],
    text: "Chosen characters gets -2 {S} this turn.",
    type: "action",
    abilities: [
        {
            type: "resolution",
...
export const justInTime = {
    ...
    flavour: "The best heroes always arrive at the perfect moment− \rwhether they know it or not.",
    colors: ["amber"],
    cost: 3,
...
export const youHaveForgottenMe = {
    id: "z53",
...
export const doItAgain = {
    ...
    flavour: ". . . Then scrub the terrace, sweep the halls and the stairs, clean the chimneys. And of course there's the mending, and the sewing, and the laundry . . . −Lady Tremaine",
    colors: ["emerald"],
    cost: 3,
...
export const stampede = {
    ...
    flavour: "A wildebeest stampede is like a raging river: best experienced from a distance.",
    colors: ["emerald"],
    cost: 1,
...
export const stealFromRich = {
    ...
    flavour: "Wonder how much ol' Prince John spent on all those fancy locks. \n−Little John",
    colors: ["emerald"],
    cost: 5,
...
export const theBeastIsMine = {
    ...
    flavour: "It‘s only fitting that the finest hunter gets the foulest \rbeast!<br />\r− Gaston",
    inkwell: true,
    colors: ["emerald"],
    cost: 3,
...
export const tangle = {
    ...
    flavour: "Stay right here! I mean, you don't have a choice, I guess. But still! Don't move! \n− Rapunzel",
    inkwell: true,
    colors: ["ruby"],
    cost: 2,
...
export const developYourBrain = {
    ...
    flavour: "„Knowledge, wisdom−there‘s the <b>real</b> power!\u0003<br />−Merlin",
    inkwell: true,
    colors: ["sapphire"],
    cost: 1,
...
export const workTogether = {
    ...
    flavour: "Pacha: Put your whole back into it! \nKuzco: This is my whole back!",
    inkwell: true,
    colors: ["sapphire"],
    cost: 1,
...
export const fireTheCannons = {
    ...
    flavour: "Captain Hook: „Double the powder and shorten the\rfuse!<br />Mr. Smee: „Shorten the powder and double the fuse!",
    colors: ["steel"],
    cost: 1,
    illustrator: "Matt Chapman",
    number: 197,
