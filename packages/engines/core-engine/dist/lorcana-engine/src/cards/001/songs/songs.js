export const friendsOnTheOtherSide = {
    id: "rrg",
...
export const suddenChill = {
    ...
    flavour: "Cruella De Vil, Cruella De Vil \nIf she doesn't scare you, no evil thing will",
    inkwell: true,
    colors: ["emerald"],
    cost: 2,
...
export const letItGo = {
    ...
    flavour: "It's time to see what I can do<br />To test the limits and break through",
    inkwell: true,
    colors: ["sapphire"],
    cost: 5,
...
export const oneJumpAhead = {
    ...
    flavour: "Gotta eat to live, gotta steal to eat -\nTell you all about it when I got the time",
    colors: ["sapphire"],
    cost: 2,
