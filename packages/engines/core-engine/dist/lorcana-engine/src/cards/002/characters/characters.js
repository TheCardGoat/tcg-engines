import { bodyguardAbility, challengeReadyCharacters, challengerAbility, duringYourTurnGains, duringYourTurnWheneverBanishesCharacterInChallenge, evasiveAbility, madameMimAbility, protectorAbility, recklessAbility, resistAbility, reverseChallenge, rushAbility, shiftAbility, singerAbility, supportAbility, wardAbility, yourOtherCharactersWithGain, } from "@lorcanito/lorcana-engine/abilities/abilities";
import { atTheEndOfYourTurn, atTheStartOfYourTurn, } from "@lorcanito/lorcana-engine/abilities/atTheAbilities";
import { anotherChosenCharacter, anotherChosenCharOfYours, chosenCharacter, chosenItem, chosenItemOfYours, chosenOpposingCharacter, chosenOpposingDamagedCharacter, itemsYouControl, opposingCharacters, yourOtherCharacters, } from "@lorcanito/lorcana-engine/abilities/target";
import { allYourCharacters, oneOfYourOtherCharacters, opponent, self, targetCard, thisCharacter, } from "@lorcanito/lorcana-engine/abilities/targets";
import { whenChallenged, whenPlayAndWheneverQuests, whenPlayAndWhenLeaves, whenThisCharacterBanished, whenThisCharacterBanishedInAChallenge, } from "@lorcanito/lorcana-engine/abilities/whenAbilities";
import { wheneverAnotherCharIsBanished, wheneverBanishesAnotherCharacterInChallenge, wheneverChallengesAnotherChar, wheneverIsReturnedToHand, wheneverOneOfYourCharChallengesAnotherChar, wheneverOppCharIsDamaged, wheneverOpposingCharIsBanished, wheneverPlays, wheneverQuests, wheneverYouHeal, wheneverYouPlayAFloodBorn, wheneverYouReadyThisCharacter, wheneverYourOpponentDiscardsOneOrMore, } from "@lorcanito/lorcana-engine/abilities/wheneverAbilities";
import { whileConditionThisCharacterGains, whileConditionThisCharacterGets, whileThisCharacterHasNoDamageGets, } from "@lorcanito/lorcana-engine/abilities/whileAbilities";
import { damageDealtRestrictionEffect, discardACard, discardAllCards, drawACard, entersPlayExerted, lookAtTopCardOfYourDeckAndPutItOnTopOrBottom, opponentDrawsACard, putThisCardIntoYourInkwellExerted, readyAndCantQuest, readyThisCharacter, returnCharacterFromDiscardToHand, targetOwnerDrawsXCards, youGainLore, youMayDrawThenChooseAndDiscard, youPayXLessToPlayNextCharThisTurn, } from "@lorcanito/lorcana-engine/effects/effects";
const newVar = {
    type: "static",
    ability: "restriction",
    effect: {
...
export const bashfulHopelessRomantic = {
    id: "iu7",
    name: "Bashful",
...
export const christopherRobinAdventurer = {
    id: "yf4",
    ...
    flavour: "Look, Pooh! Have you ever seen anything so grand? \n−Christopher Robin",
    inkwell: true,
    colors: ["amber"],
    cost: 6,
    strength: 2,
...
export const cinderellaBallroomSensation = {
    id: "rgn",
    name: "Cinderella",
    ...
    flavour: "With a magical dress and a song in her heart, she dazzled everyone at the ball.",
    inkwell: true,
    colors: ["amber"],
    cost: 1,
    strength: 1,
...
export const cobraBubblesSimpleEducator = {
    id: "ygo",
    name: "Cobra Bubbles",
    title: "Just a Social Worker",
    characteristics: ["storyborn", "ally"],
    type: "character",
    flavour: "So if I understand correctly, your magic grimoire was washed away by a flood of magic ink?",
    inkwell: true,
    colors: ["amber"],
    cost: 7,
    strength: 5,
...
export const docLeaderOfTheSevenDwarfs = {
    id: "fek",
    name: "Doc",
...
export const dopeyAlwaysPlayful = {
    id: "zdu",
    name: "Dopey",
...
export const eudoraAccomplishedSeamstress = {
    id: "dgv",
    name: "Eudora",
...
export const gastonBaritoneBully = {
    id: "j47",
    name: "Gaston",
...
export const grandDukeAdvisorToTheKing = {
    id: "uiz",
    name: "Grand Duke",
...
export const grumpyBadTempered = {
    id: "wsw",
    name: "Grumpy",
    title: "Bad-Tempered",
    characteristics: ["storyborn", "ally", "seven dwarfs"],
...
export const kingLouieJungleVip = {
    id: "xiu",
    name: "King Louie",
    title: "Jungle VIP",
...
export const mickeyMouseFriendlyFace = {
    id: "ll5",
    name: "Mickey Mouse",
    title: "Friendly Face",
...
export const mufasaBetrayedLeader = {
    id: "j4z",
    name: "Mufasa",
...
export const nanaDarlingFamilyPet = {
    id: "v76",
    name: "Nana",
...
export const pigletVerySmallAnimal = {
    id: "d7w",
    name: "Piglet",
...
export const rapunzelGiftedArtist = {
    id: "d99",
    name: "Rapunzel",
    title: "Gifted Artist",
    characteristics: ["hero", "floodborn", "princess"],
...
export const sneezyVeryAllergic = {
    id: "aux",
    name: "Sneezy",
    title: "Very Allergic",
    characteristics: ["storyborn", "ally", "seven dwarfs"],
...
export const snowWhiteLostInTheForest = {
    id: "h4k",
    name: "Snow White",
...
export const snowWhiteUnexpectedHouseGuest = {
    id: "pyl",
    name: "Snow White",
...
export const snowWhiteWellWisher = {
    id: "xen",
    name: "Snow White",
    title: "Well Wisher",
    characteristics: ["hero", "floodborn", "princess"],
...
export const theQueenCommandingPresence = {
    id: "lwh",
    name: "The Queen",
...
export const theQueenRegalMonarch = {
    id: "vfj",
    name: "The Queen",
    title: "Regal Monarch",
    characteristics: ["queen", "storyborn", "villain"],
    type: "character",
    flavour: "Don't question her. Don't doubt her. And above all, don't disobey her.",
    inkwell: true,
    colors: ["amber"],
    cost: 1,
    strength: 2,
...
export const arthurWizardsApprentice = {
    id: "rvh",
    name: "Arthur",
...
export const blueFairyRewardingGoodDeeds = {
    id: "aid",
    name: "Blue Fairy",
    ...
    flavour: "To make Geppetto’s wish come true will be entirely up to you. –Blue Fairy",
    inkwell: true,
    colors: ["amethyst"],
    cost: 2,
    strength: 1,
...
export const chipTheTeacupGentleSoul = {
    id: "v6d",
...
export const drFacilierSavvyOpportunist = {
    id: "pda",
    name: "Dr. Facilier",
...
export const elsaGlovesOff = {
    ...
    flavour: "The power of ice may not stop the flood, but it will help protect Lorcana.",
    inkwell: true,
    colors: ["amethyst"],
    cost: 4,
    strength: 3,
...
export const fairyGodmotherHereToHelp = {
    id: "foy",
    name: "Fairy Godmother",
    title: "Here to Help",
    characteristics: ["storyborn", "ally", "fairy"],
    type: "character",
    flavour: "Use a humdrum spell, and you'll end up with humdrum magic. I like my magic to have something special!",
    inkwell: true,
    colors: ["amethyst"],
    cost: 5,
    strength: 3,
...
export const fairyGodmotherPureHeart = {
    id: "e6p",
    name: "Fairy Godmother",
    title: "Pure Heart",
    characteristics: ["storyborn", "ally", "fairy"],
...
export const heiheiPersistentPresence = {
    id: "anm",
    name: "HeiHei",
...
export const jiminyCricketPinocchiosConscience = {
    id: "na1",
    name: "Jiminy Cricket",
...
export const madamMimPurpleDragon = {
    id: "x3t",
    name: "Madam Mim",
    title: "Purple Dragon",
...
export const madamMimRivalOfMerlin = {
    id: "esw",
    name: "Madam Mim",
...
export const merlinShapeshifter = {
    id: "lcu",
    name: "Merlin",
    title: "Shapeshifter",
    characteristics: ["sorcerer", "storyborn", "mentor"],
...
export const peterPansShadowNotSewnOn = {
    id: "si7",
...
export const pinocchioStarAttraction = {
    id: "z8x",
    name: "Pinocchio",
    title: "Star Attraction",
    characteristics: ["hero", "storyborn"],
    type: "character",
    flavour: "With that personality, that profile, that physique . . . \nWhy, I can see your name in lights, lights six feet high. \n−Honest John",
    colors: ["amethyst"],
    cost: 2,
    strength: 1,
    willpower: 1,
...
export const pinocchioOnTheRun = {
    id: "juq",
    name: "Pinocchio",
    title: "On the Run",
...
export const pinocchioTalkativePuppet = {
    id: "gkt",
    name: "Pinocchio",
    ...
    flavour: "A lie keeps growing and growing until it's as plain as the nose on your face. \n−Blue Fairy",
    colors: ["amethyst"],
    cost: 2,
    strength: 1,
    willpower: 1,
...
export const winnieThePoohHunnyWizard = {
    id: "nkw",
    name: "Winnie The Pooh",
    title: "Hunny Wizard",
    characteristics: ["hero", "dreamborn", "sorcerer"],
    type: "character",
    flavour: "He’d always felt a kinship with honey. They were both golden, and sweet, and likely to end up in sticky situations.",
    inkwell: true,
    colors: ["amethyst"],
    cost: 5,
    strength: 5,
...
export const yzmaScaryBeyondAllReason = {
    id: "xdq",
    name: "Yzma",
...
export const yzmaWithoutBeautySleep = {
    id: "doq",
    name: "Yzma",
    title: "Without Beauty Sleep",
    characteristics: ["sorcerer", "storyborn", "villain"],
    type: "character",
    flavour: "Yzma: Llamas! All I see when I close my eyes is llamas! \nKronk: Weird. I just saw one in the flood. Poor little guy.",
    inkwell: true,
    colors: ["amethyst"],
    cost: 3,
    strength: 3,
...
export const arthurTrainedSwordsman = {
    id: "ekd",
    name: "Arthur",
    title: "Trained Swordsman",
    characteristics: ["hero", "dreamborn"],
    type: "character",
    flavour: "It's not just fancy horses and swinging a sword around, you know! A true master must use his brain as well as his blade. \n−Merlin",
    inkwell: true,
    colors: ["emerald"],
    cost: 4,
    strength: 4,
...
export const belleHiddenArcher = {
    id: "y10",
    name: "Belle",
    title: "Hidden Archer",
    characteristics: ["hero", "floodborn", "princess"],
...
export const buckySquirrelSqueakTutor = {
    id: "aci",
    name: "Bucky",
...
export const cheshireCatAlwaysGrinning = {
    id: "ctv",
    name: "Cheshire Cat",
    title: "Always Grinning",
    characteristics: ["storyborn"],
    type: "character",
    flavour: "Alice felt quite confused. But I don’t see much ink here at all. How can the flood still be changing the Inklands? \n\nThings are always changing, you know, said the Cat. It would be quite a change if they didn't.",
    inkwell: true,
    colors: ["emerald"],
    cost: 2,
    strength: 3,
...
export const cheshireCatFromTheShadows = {
    id: "ebw",
    name: "Cheshire Cat",
...
export const daisyDuckSecretAgent = {
    id: "vqt",
    name: "Daisy Duck",
    title: "Secret Agent",
    characteristics: ["dreamborn", "ally"],
...
export const donaldDuckPerfectGentleman = {
    id: "pgk",
    name: "Donald Duck",
...
export const donaldDuckSleepwalker = {
    id: "kjq",
    name: "Donald Duck",
    title: "Sleepwalker",
    characteristics: ["storyborn"],
...
export const drFacilierFortuneTeller = {
    id: "mwx",
    name: "Dr. Facilier",
...
export const enchantressUnexpectedJudge = {
    id: "xmq",
    name: "Enchantress",
...
export const flynnRiderConfidentVagabond = {
    id: "nzv",
    name: "Flynn Rider",
    title: "Confident Vagabond",
    characteristics: ["hero", "storyborn", "prince"],
    type: "character",
    flavour: "I love a good fan club, but they could at least <b>try</b> to get the nose right!",
    inkwell: true,
    colors: ["emerald"],
    cost: 1,
    strength: 1,
...
export const flynnRiderHisOwnBiggestFan = {
    id: "t36",
    name: "Flynn Rider",
...
export const gastonSchemingSuitor = {
    id: "eck",
    name: "Gaston",
...
export const littleJohnLoyalFriend = {
    id: "rk6",
    name: "Little John",
    title: "Loyal Friend",
    characteristics: ["storyborn", "ally"],
    type: "character",
    flavour: "What's the rush, Rob? Take a load off! There's plenty of time to go lookin' for lore lost in that crazy ink.",
    inkwell: true,
    colors: ["emerald"],
    cost: 6,
    strength: 6,
...
export const luciferCunningCat = {
    id: "s0r",
    name: "Lucifer",
    title: "Cunning Cat",
    characteristics: ["storyborn", "ally"],
...
export const painUnderworldImp = {
    id: "hrt",
    name: "Pain",
    ...
    flavour: "Get a move on! I'm a busy god, lots to do−meetings, curses, a little light scheming. \n−Hades",
    inkwell: true,
    colors: ["emerald"],
    cost: 2,
    strength: 1,
...
export const panicUnderworldImp = {
    id: "zro",
    name: "Panic",
    title: "Underworld Imp",
    characteristics: ["storyborn", "ally"],
    ...
    flavour: "Who says it's hard to find good help these days? \nOh, yeah . . . ME! \n−Hades",
    colors: ["emerald"],
    cost: 3,
    strength: 2,
    willpower: 3,
...
export const princeJohnGreediestOfAll = {
    id: "j3m",
    name: "Prince John",
...
export const queenOfHeartsQuickTempered = {
    id: "zbq",
    ...
    flavour: "You know, we could make her really angry. Shall we try?  \n−Cheshire Cat",
    colors: ["emerald"],
    cost: 2,
    strength: 1,
    willpower: 2,
...
export const ratiganCriminalMastermind = {
    id: "r5c",
    name: "Ratigan",
    ...
    type: "character",
    abilities: [evasiveAbility],
    flavour: "I've outdone myself this time! Soon I will have everything I deserve. Riches . . . power . . . an entire kingdom at my feet!",
    inkwell: true,
    colors: ["emerald"],
    cost: 4,
    strength: 4,
...
export const rayEasygoingFirefly = {
    id: "fdk",
    name: "Ray",
...
export const theQueenDisguisedPeddler = {
    id: "htg",
    name: "The Queen",
...
export const tianaTruePrincess = {
    id: "fdi",
    name: "Tiana",
    title: "True Princess",
    characteristics: ["hero", "storyborn", "princess"],
...
export const viranaFangChief = {
    id: "ryo",
    name: "Virana",
    title: "Fang Chief",
    characteristics: ["queen", "storyborn", "villain"],
    type: "character",
    flavour: "I must make the hard decisions to protect my daughter, especially in this unfamiliar world.",
    inkwell: true,
    colors: ["emerald"],
    cost: 5,
    strength: 5,
...
export const balooFunLovingBear = {
    id: "vpf",
    name: "Baloo",
...
export const bounPrecociousEnterpreneur = {
    id: "hz1",
    name: "Boun",
...
export const cardSoldiersFullDeck = {
    id: "x9a",
    name: "Card Soldiers",
    title: "Full Deck",
    characteristics: ["storyborn", "ally"],
...
export const donaldDuckNotAgain = {
    id: "adi",
    name: "Donald Duck",
    title: "Not Again!",
    characteristics: ["hero", "dreamborn"],
...
export const feliciaAlwaysHungry = {
    id: "trb",
    name: "Felicia",
    title: "Always Hungry",
    characteristics: ["dreamborn", "ally"],
    ...
    flavour: "This isn't how most cat-and-mouse games go, is it, Dr. Dawson? \n−Basil",
    inkwell: true,
    colors: ["ruby"],
    cost: 1,
    strength: 3,
...
export const fidgetRatigansHenchman = {
    id: "p8b",
    name: "Fidget",
...
export const honestJohnNotThatHonest = {
    id: "hkq",
    name: "Honest John",
...
export const ladyTremaineImperiousQueen = {
    id: "m9y",
    name: "Lady Tremaine",
    ...
    flavour: "The twelfth Rule of Villainy: If you don't have a throne, take one.",
    colors: ["ruby"],
    cost: 6,
    strength: 3,
    willpower: 4,
...
export const ladyTremaineOverbearingMatriarch = {
    id: "yy6",
    name: "Lady Tremaine",
    ...
    flavour: "Make no mistake: this time I will make certain the key remains safe!",
    colors: ["ruby"],
    cost: 2,
    strength: 2,
    willpower: 2,
...
export const lumiereHotheadedCandelabra = {
    id: "r40",
    name: "Lumiere",
...
export const minnieMouseStylishSurfer = {
    id: "t1b",
    name: "Minnie Mouse",
...
export const minnieMouseWideEyedDiver = {
    id: "whf",
    name: "Minnie Mouse",
...
export const minnieMouseZippingAround = {
    id: "d3n",
    name: "Minnie Mouse",
...
export const motherGothelWitheredAndWicked = {
    id: "dmj",
    name: "Mother Gothel",
...
export const mulanSoldierInTraining = {
    id: "tzn",
    name: "Mulan",
...
export const queenOfHeartsImpulsiveRuler = {
    id: "e84",
    name: "Queen of Hearts",
    ...
    type: "character",
    abilities: [rushAbility],
    flavour: "The glow of lore in the flood cought her eye. The spellbook! she cried. Don't let it get away!",
    inkwell: true,
    colors: ["ruby"],
    cost: 2,
    strength: 2,
...
export const queenOfHeartsSensingWeakness = {
    id: "l3z",
    name: "Queen of Hearts",
...
export const ratiganVeryLargeMouse = {
    id: "vl3",
    name: "Ratigan",
    ...
    abilities: [
        {
            ...
            text: "When you play this character, exert chosen opposing character with 3 {S} or less. Chose one of your characters and ready them. They can't quest for the rest of this turn.",
            resolveEffectsIndividually: true,
            dependentEffects: true,
            effects: [
...
export const rayaHeadstrong = {
    ...
    flavour: "Two parts bravery, one part cleverness, and a whole lot of determination.",
    inkwell: true,
    colors: ["ruby"],
    cost: 3,
    strength: 2,
...
export const rayaLeaderOfHeart = {
    id: "c4z",
    name: "Raya",
...
export const rayaWarriorOfKumandra = {
    id: "goj",
    name: "Raya",
...
export const scarViciousCheater = {
    id: "i4t",
    name: "Scar",
...
export const shereKhanMenacingPredator = {
    id: "uep",
    name: "Shere Khan",
    ...
    flavour: "The sixth Rule of Villainy: Keep your mind sharp and your claws sharper.",
    inkwell: true,
    colors: ["ruby"],
    cost: 3,
    strength: 3,
...
export const tukTukWreckingBall = {
    id: "nqd",
    name: "Tuk Tuk",
    title: "Wrecking Ball",
    characteristics: ["storyborn", "ally"],
...
export const basilGreatMouseDetective = {
    id: "xau",
    name: "Basil",
...
export const basilOfBakerStreet = {
    id: "ne2",
    name: "Basil",
    ...
    type: "character",
    abilities: [supportAbility],
    flavour: "What an ingenious device! If its light is refracted through these, then its images must resolve somewhere below.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 2,
    strength: 2,
...
export const basilPerceptiveInvestigator = {
    id: "j48",
    name: "Basil",
...
export const caterpillarCalmAndCollected = {
    id: "uaw",
    name: "Caterpillar",
...
export const cogsworthGrandfatherClock = {
    id: "kv8",
    name: "Cogsworth",
...
export const cogsworthTalkingClock = {
    id: "ozp",
    name: "Cogsworth",
    title: "Talking Clock",
    characteristics: ["storyborn", "ally"],
...
export const cruellaDeVilFashionableCruiser = {
    id: "b6i",
    name: "Cruella De Vil",
    ...
    type: "character",
    abilities: [
        duringYourTurnGains("Now Get Going", "During your turn, this character gains **Evasive**. _(They can challenge characters with Evasive.)_", evasiveAbility),
    ],
...
export const cruellaDeVilPerfectlyWretched = {
    id: "l1b",
    name: "Cruella De Vil",
...
export const dukeWeaseltonSmallTimeCrook = {
    id: "b5u",
    name: "Duke Weaselton",
...
export const gastonIntellectualPowerhouse = {
    id: "zsp",
    name: "Gaston",
...
export const grandPabbieOldestAndWisest = {
    id: "dy0",
    name: "Grand Pabbie",
...
export const hiramFlavershamToymaker = {
    id: "fap",
    ...
    flavour: "His creations are even more wondrous with the Illuminary's resources at his fingertips.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 4,
    strength: 1,
...
export const jasmineHeirOfAgrabah = {
    id: "tq1",
    name: "Jasmine",
...
export const judyHoppsOptimisticOfficer = {
    id: "xdx",
    name: "Judy Hopps",
    ...
    flavour: "I'll get to the bottom of what happened with that locked lorebook. You can count on me!",
    inkwell: true,
    colors: ["sapphire"],
    cost: 3,
    strength: 2,
...
export const mrsJudsonHousekeeper = {
    id: "rqb",
    name: "Mrs. Judson",
    title: "Housekeeper",
    characteristics: ["storyborn", "ally"],
    ...
    flavour: "I know just the thing. Let me fetch you a pot of tea and some of my fresh cheese crumpets.",
    colors: ["sapphire"],
    cost: 4,
    strength: 1,
    willpower: 5,
...
export const owlLogicalLecturer = {
    id: "iei",
    name: "Owl",
    title: "Logical Lecturer",
    characteristics: ["storyborn", "ally"],
    type: "character",
    flavour: "For instance, based on the quality of the light and the subtle change in wind direction, I can safely say that it is time for tea.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 1,
    strength: 2,
...
export const princeCharmingHeirToTheThrone = {
    id: "nwc",
    name: "Prince Charming",
    title: "Heir to the Throne",
    characteristics: ["hero", "dreamborn", "prince"],
    type: "character",
    flavour: "He'd searched across the Inklands for the young woman who'd stolen his heart at the ball, only to find more mysteries.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 4,
    strength: 3,
...
export const sisuDivineWaterDragon = {
    id: "b3o",
    name: "Sisu",
...
export const theNokkWaterSpirit = {
    id: "vrs",
    name: "The Nokk",
    title: "Water Spirit",
    characteristics: ["storyborn"],
...
export const winnieThePoohHavingAThink = {
    id: "o3g",
    name: "Winnie the Pooh",
    ...
    flavour: "When he thought, he thought in the most thoughtful way he could think.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 3,
    strength: 2,
...
export const beastForbiddingRecluse = {
    id: "j93",
    name: "Beast",
...
export const beastSelflessProtector = {
    id: "njt",
    name: "Beast",
...
export const benjaGuardianOfTheDragonGem = {
    id: "buc",
    name: "Benja",
...
export const chiefBogoRespectedOfficer = {
    id: "qpr",
    name: "Chief Bogo",
    ...
    flavour: "We can confirm the ink flood was caused by an explosion. We have it under control−now clear the area.",
    colors: ["steel"],
    cost: 4,
    strength: 2,
    willpower: 4,
...
export const cinderellaKnightInTraining = {
    id: "y7h",
    name: "Cinderella",
    ...
    flavour: "She's always had the heart of a champion - now she'll have the skills, too.",
    inkwell: true,
    colors: ["steel"],
    cost: 2,
    strength: 2,
...
export const donaldDuckDeepSeaDiver = {
    id: "hoc",
    name: "Donald Duck",
    title: "Deep-Sea Diver",
    characteristics: ["hero", "dreamborn"],
    type: "character",
    flavour: "You go ahead, Minnie! I'm going to see if there's any lore over here.",
    inkwell: true,
    colors: ["steel"],
    cost: 5,
    strength: 6,
...
export const eliLaBouffBigDaddy = {
    id: "t92",
    name: "Eli La Bouff",
    title: "Big Daddy",
    characteristics: ["storyborn", "mentor"],
    type: "character",
    flavour: "I don't suppose y'all could whip up some more magical beignets with them inkcasters?",
    inkwell: true,
    colors: ["steel"],
    cost: 4,
    strength: 2,
...
export const goofyKnightForADay = {
    id: "u0j",
    name: "Goofy",
    title: "Knight for a Day",
    characteristics: ["hero", "dreamborn", "knight"],
    type: "character",
    flavour: "It’s a banner day for Sir Goofy, who is steeled to prove his mettle against anyone courting trouble−joust in case.",
    inkwell: true,
    colors: ["steel"],
    cost: 9,
    strength: 10,
...
export const herculesDivineHero = {
    id: "e0i",
    name: "Hercules",
    title: "Divine Hero",
...
export const herculesHeroInTraining = {
    id: "keh",
    name: "Hercules",
...
export const jafarRoyalVizier = {
    ...
    type: "character",
    abilities: [
        duringYourTurnGains("I don't trust him, sire", "During your turn, this character gains **Evasive**.", evasiveAbility),
    ],
...
export const kronkJuniorChipmunk = {
    id: "hv3",
    name: "Kronk",
...
export const lawrenceJealousManservant = {
    id: "ytl",
    name: "Lawrence",
...
export const liShangArcheryInstructor = {
    id: "vg7",
    name: "Li Shang",
...
export const magicBroomIndustrialModel = {
    id: "ang",
    name: "Magic Broom",
    ...
    flavour: "Even with a hauling weight of seriously, a lot, it can only do so much in a magical flood.",
    inkwell: true,
    colors: ["steel"],
    cost: 3,
    strength: 2,
...
export const namaariMorningMist = {
    id: "mpn",
    name: "Namaari",
    title: "Morning Mist",
    characteristics: ["storyborn", "villain", "princess"],
...
export const pachaVillageLeader = {
    id: "lxx",
    name: "Pacha",
...
export const princeNaveenPennilessRoyal = {
    id: "m7y",
    name: "Prince Naveen",
...
export const queenOfHeartsCapriciousMonarch = {
    id: "m85",
    name: "Queen of Hearts",
...
export const robinHoodCapableFighter = {
    id: "ta2",
    name: "Robin Hood",
...
export const theHuntsmanReluctantEnforcer = {
    id: "f1a",
    name: "The Huntsman",
...
export const thePrinceNeverGivesUp = {
    id: "g5k",
    name: "The Prince",
...
export const tianaCelebratingPrincess = {
    id: "nyj",
    name: "Tiana",
...
export const tianaDiligentWaitress = {
    id: "e3u",
    name: "Tiana",
    title: "Diligent Waitress",
    characteristics: ["hero", "storyborn", "princess"],
    type: "character",
    flavour: "My place is going to be special, with great food to fill people’s bellies an hot jazz to feed their souls!",
    inkwell: true,
    colors: ["steel"],
    cost: 1,
    strength: 1,
