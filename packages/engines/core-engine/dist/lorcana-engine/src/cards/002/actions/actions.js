...
import { discardACard, exertedCharCantReadyNextTurn, opponentRevealHand, readyAndCantQuest, youPayXLessToPlayNextCharThisTurn, } from "@lorcanito/lorcana-engine/effects/effects";
...
export const paintingTheRosesRed = {
    id: "g0a",
...
export const worldsGreatestCriminalMind = {
    id: "c97",
...
export const legendOfTheSwordInTheStone = {
    id: "fjm",
    ...
    flavour: "A legend is sung of when England was young \nAnd knights were brave and bold",
    inkwell: true,
    colors: ["amethyst"],
    cost: 2,
...
export const bibbidiBobbidiBoo = {
    id: "waz",
...
export const packTactics = {
    ...
    flavour: "Pacha: You want to survive the jungle? Start thinking like you belong here. \nKuzco: No problem . . . Grrr, look at me, I'm a jaguar.",
    inkwell: true,
    colors: ["emerald"],
    cost: 4,
...
export const teethAndAmbitions = {
    id: "dvr",
    ...
    flavour: "Of course, quid pro quo, you’re expected \nTo take certain duties on board",
    inkwell: true,
    colors: ["ruby"],
    cost: 2,
...
export const theMostDiabolicalScheme = {
    id: "qad",
...
export const whatDidYouCallMe = {
    ...
    flavour: "No one can have a higher opinion of you than I have, and I think you’re a slimy, contemptible sewer rat! \n−Basil",
    inkwell: true,
    colors: ["ruby"],
    cost: 1,
...
export const fallingDownTheRabbitHole = {
    id: "j9g",
    ...
    flavour: "Down, down, down she went, floating in a swirl of ink. How curious!",
    colors: ["sapphire"],
    cost: 4,
...
export const letTheStormRageOn = {
    id: "dlc",
...
export const strengthOfARagingFire = {
    id: "x5y",
