...
import { chosenCharacter, chosenOpposingCharacter, topCardOfYourDeck, yourCharacters, } from "@lorcanito/lorcana-engine/abilities/targets";
import { whenChallenged, whenYouPlayThisForEachYouPayLess, } from "@lorcanito/lorcana-engine/abilities/whenAbilities";
...
import { chosenCharacterGainsResist, chosenCharacterGainsSupport, chosenCharacterGetsStrength, putTopCardOfYourDeckIntoYourInkwellExerted, readyAndCantQuest, targetCardGainsResist, } from "@lorcanito/lorcana-engine/effects/effects";
export const theNephewsPiggyBank = {
    id: "s8i",
...
const revealTopPuppyAndPutIntoHand = {
...
export const bellesFavoriteBook = {
    id: "yy4",
