...
import { chosenCharacter, chosenItem, chosenOpposingCharacter, self, yourCharacters, } from "@lorcanito/lorcana-engine/abilities/targets";
import { chosenCharacterGainsEvasive, chosenCharacterGetsStrength, drawACard, drawXCards, moveDamageEffect, youPayXLessToPlayNextCharThisTurn, } from "@lorcanito/lorcana-engine/effects/effects";
...
const eachOfYourCharactersWithBodyGuard = {
    type: "card",
    value: "all",
    filters: [
...
export const theyNeverComeBack = {
    id: "dtw",
...
export const everybodysGotAWeakness = {
    id: "j44",
...
export const heWhoStealsAndRunsAway = {
    id: "s8j",
...
export const stoppedChaosInItsTracks = {
    id: "cm3",
...
const walkThePlankGainedAbility = {
    type: "activated",
    costs: [{ type: "exert" }],
    effects: [
        {
