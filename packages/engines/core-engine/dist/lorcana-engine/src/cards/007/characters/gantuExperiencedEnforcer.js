...
import { gainsAbilityEffect, untilTheEndOfYourNextTurn, } from "@lorcanito/lorcana-engine/effects/effects";
export const gantuExperiencedEnforcer = {
    id: "t8l",
    name: "Gantu",
    ...
    abilities: [
        whenYouPlayThis({
            ...
            effects: [
                untilTheEndOfYourNextTurn(gainsAbilityEffect({
...
//# sourceMappingURL=gantuExperiencedEnforcer.js.map