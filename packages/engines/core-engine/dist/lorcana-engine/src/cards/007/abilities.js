...
import { chosenCharacter, chosenCharacterOfYours, chosenDamagedCharacter, chosenOpposingCharacter, chosenPlayer, opponent, self, thisCharacter, } from "@lorcanito/lorcana-engine/abilities/targets";
import { whenThisIsBanished, whenYouPlayThisCharacter, } from "@lorcanito/lorcana-engine/abilities/whenAbilities";
import { wheneverACardIsPutIntoYourInkwell, wheneverYouPlayACharacter, wheneverYouPlayAnActionNotASong, } from "@lorcanito/lorcana-engine/abilities/wheneverAbilities";
import { banishChosenItem, chosenCharacterGainsChallenger, chosenCharacterGainsEvasive, chosenCharacterGetsStrength, drawACard, drawXCards, moveDamageEffect, returnToHand, youGainLore, youMayDrawThenChooseAndDiscard, youPayXLessToPlayNextItemThisTurn, } from "@lorcanito/lorcana-engine/effects/effects";
...
const cardInInkwellYouOwn = [
    { filter: "zone", value: "inkwell" },
    { filter: "owner", value: "self" },
];
const haveMoreThan3CardsInInkwell = {
    type: "filter",
...
export const spaghettiDinnerAbility = {
    type: "activated",
    name: "Fine Dining",
...
export const devilsEyeDiamondAbility = {
    type: "activated",
...
export const trainingStaffAbility = {
    type: "activated",
