import { bodyguardAbility, challengerAbility, duringYourTurnGains, evasiveAbility, exertItemCost, moveDamageAbility, otherCharacterGains, recklessAbility, resistAbility, rushAbility, shiftAbility, singerAbility, supportAbility, wardAbility, yourOtherCharactersGet, yourOtherCharactersWithGain, } from "@lorcanito/lorcana-engine/abilities/abilities";
...
import { anyCard, chosenCharacter, chosenCharacterNamed, chosenCharacterOfYours, chosenCharacterOfYoursAtLocation, chosenCharacterOfYoursIncludingSelf, chosenOtherCharacterOfYours, namedCard, opposingCharacters, self, thisCharacter, yourBanishedLocations, yourOtherCharacters, } from "@lorcanito/lorcana-engine/abilities/targets";
import { whenChallenged, whenChallengedAndBanished, whenThisCharacterBanished, whenThisCharacterBanishedInAChallenge, whenXIsBanished, whenYouPlayThis, whenYouPlayThisForEachYouPayLess, } from "@lorcanito/lorcana-engine/abilities/whenAbilities";
import { wheneverBanishesAnotherCharacterInChallenge, wheneverChallengesAnotherChar, wheneverOpponentDrawsACard, wheneverPlays, wheneverQuests, wheneverTargetPlays, wheneverThisCharacterDealsDamageInChallenge, wheneverThisCharSings, wheneverYouPlayASong, } from "@lorcanito/lorcana-engine/abilities/wheneverAbilities";
import { whileConditionThisCharacterGets, whileNoOtherCharacterHasQuestedThisCharacterGets, whileThisCharacterHasNoDamageGets, whileYouHaveACharacterNamedThisCharGains, whileYouHaveACharacterNamedThisCharGets, whileYouHaveAnotherCharacterInPlayThisCharacterGets, whileYouHaveAnotherCharacterWithCharacteristicThisCharacterGets, whileYouHaveMoreItemsInPlayThanEachOpponentThisCharacterGets, whileYouHaveNoCardsInHandThisCharacterCanChallengeReadyChars, } from "@lorcanito/lorcana-engine/abilities/whileAbilities";
import { dealDamageEffect, discardACard, drawACard, drawXCards, exertAndCantReady, exertChosenCharacter, lookAtTopCardOfYourDeckAndPutItOnTopOrBottom, mayBanish, moveDamageEffect, moveToLocation, opponentRevealHand, putThisCardIntoYourInkwellExerted, putTopCardOfYourDeckIntoYourInkwellExerted, readyAndCantQuest, returnCardToHand, returnThisCardToHand, youGainLore, youPayXLessToPlayNextCharThisTurn, yourOtherCharactersGainStrengthThisTurn, } from "@lorcanito/lorcana-engine/effects/effects";
import { propertyStaticAbilities } from "../../../abilities/propertyStaticAbilities";
export const agustinMadrigalClumsyDad = {
    id: "e63",
...
export const arielSingingMermaid = {
    id: "q8b",
...
export const cinderellaMelodyWeaver = {
    id: "mma",
    name: "Cinderella",
    title: "Melody Weaver",
...
export const cogsworthMajordomo = {
    id: "kfo",
    name: "Cogsworth",
    title: "Majordomo",
...
export const daisyDuckMusketeerSpy = {
    id: "w9s",
    missingTestCase: true,
    name: "Daisy Duck",
    title: "Musketeer Spy",
...
export const donaldDuckMusketeerSoldier = {
    id: "xjt",
    name: "Donald Duck",
...
export const felixMadrigalFunLovingFamilyMan = {
    id: "dpy",
    name: "Félix Madrigal",
...
export const gastonDespicableDealer = {
    id: "fzz",
    name: "Gaston",
    ...
    flavour: "Yes, yes, everything will be ready. Just make sure you do your part.",
    colors: ["amber"],
    cost: 3,
    strength: 2,
    willpower: 4,
...
export const goldenHarpEnchanterOfTheLand = {
    id: "ph6",
    name: "Golden Harp",
...
export const goofyMusketeerSwordsman = {
    id: "moa",
    name: "Goofy",
...
export const julietaMadrigalExcellentCook = {
    id: "ig1",
    missingTestCase: true,
...
export const mickeyMouseLeaderOfTheBand = {
    id: "mpt",
    name: "Mickey Mouse",
...
export const mickeyMouseMusketeerCaptain = {
    id: "pjf",
    missingTestCase: true,
    name: "Mickey Mouse",
...
export const minnieMouseMusketeerChampion = {
    id: "mkk",
    name: "Minnie Mouse",
...
export const mirabelMadrigalGiftOfTheFamily = {
    id: "o01",
    missingTestCase: true,
...
export const mirabelMadrigalProphecyFinder = {
    id: "oqf",
    name: "Mirabel Madrigal",
    ...
    flavour: "Why would Bruno break this prophecy? Could it be something dangerous? We have to find out!",
    inkwell: true,
    colors: ["amber"],
    cost: 2,
    strength: 2,
...
export const princeEricSeafaringPrince = {
    id: "nko",
    name: "Prince Eric",
...
export const princeEricUrsulasGroom = {
    id: "k1b",
    missingTestCase: true,
    name: "Prince Eric",
...
export const stitchAlienDancer = {
    id: "hq5",
    name: "Stitch",
    title: "Alien Dancer",
    characteristics: ["hero", "alien", "storyborn"],
    type: "character",
    flavour: "Moving to the beat of the music, he begins to understand the true meaning of ohana and his place in the family he has found.",
    inkwell: true,
    colors: ["amber"],
    cost: 2,
    strength: 2,
...
export const ursulaEricsBride = {
    ...
    abilities: [
        ...
        ], "ursula", "**Shift: Discard a song card**"),
        wheneverQuests({
...
export const antonioMadrigalAnimalExpert = {
    id: "zij",
    name: "Antonio Madrigal",
    title: "Animal Expert",
    characteristics: ["storyborn", "ally", "madrigal"],
    type: "character",
    flavour: "Once upon a time, there was a casita in the mountains with a very special family. . . .",
    inkwell: true,
    colors: ["amethyst"],
    cost: 3,
    strength: 3,
...
export const belleAccomplishedMystic = {
    id: "j8p",
    missingTestCase: true,
    name: "Belle",
...
export const belleUntrainedMystic = {
    id: "gfw",
    missingTestCase: true,
    name: "Belle",
    ...
    flavour: "No matter what she tried, Belle couldn't \ncompletely heal Beast's wound.",
    inkwell: true,
    colors: ["amethyst"],
    cost: 3,
    strength: 3,
...
export const brunoMadrigalOutOfTheShadows = {
    id: "nsx",
    missingTestCase: true,
    name: "Bruno Madrigal",
...
export const brunoMadrigalUndetectedUncle = {
    id: "le7",
    name: "Bruno Madrigal",
...
export const camiloMadrigalPrankster = {
    id: "oct",
    missingTestCase: true,
...
export const doloresMadrigalEasyListener = {
    id: "ytb",
    missingTestCase: true,
...
export const flotsamUrsulasBaby = {
    id: "ha8",
    missingTestCase: true,
    name: "Flotsam",
    title: 'Ursula\'s "Baby"',
...
export const flotsamAndJetsamEntanglingEels = {
    id: "pgn",
    missingTestCase: true,
    name: "Flotsam & Jetsam",
    ...
    abilities: [
        ...
        ], ["Flotsam", "Jetsam"], "**Shift: Discard 2 cards** _(You may discard 2 cards to play this on top of one of your characters named Flotsam or Jetsam.)_\n\n_(This character counts as being named both Flotsam and Jetsam)_"),
    ],
    inkwell: true,
    colors: ["amethyst"],
    cost: 6,
...
export const isabelaMadrigalGoldenChild = {
    id: "fal",
...
export const jetsamUrsulasBaby = {
    id: "tpe",
    missingTestCase: true,
    name: "Jetsam",
    title: 'Ursula\'s "Baby"',
...
export const luisaMadrigalMagicallyStrongOne = {
    id: "kcf",
    name: "Luisa Madrigal",
...
export const magicBroomIlluminaryKeeper = {
    id: "kgu",
    name: "Magic Broom",
...
export const magicBroomLivelySweeper = {
    id: "hxg",
    name: "Magic Broom",
...
export const magicalMaidFeatherDuster = {
    id: "dx1",
    name: "Magical Maid",
    title: "Feather Duster",
    characteristics: ["storyborn", "ally"],
    type: "character",
    flavour: 'Have you ever seen anything so beautiful?" she asked, marveling at the Amethyst trees.\n"No, cherie," Lumiere replied, never taking his eyes off her. "I have not."',
    inkwell: true,
    colors: ["amethyst"],
    cost: 2,
    strength: 2,
...
export const marshmallowTerrifyingSnowman = {
    id: "np5",
    missingTestCase: true,
    name: "Marshmallow",
...
export const mrsPottsEnchantedTeapot = {
    id: "rxo",
    missingTestCase: true,
    name: "Mrs. Potts",
...
export const pepaMadrigalWeatherMaker = {
    id: "zc5",
    missingTestCase: true,
    name: "Pepa Madrigal",
    title: "Weather Maker",
...
export const peterPanShadowFinder = {
    id: "o7c",
    name: "Peter Pan",
    title: "Shadow Finder",
    characteristics: ["hero", "storyborn"],
...
export const picoHelpfulToucan = {
    id: "xxo",
    name: "Pico",
    title: "Helpful Toucan",
    characteristics: ["storyborn", "ally"],
    type: "character",
    flavour: "He spotted a mysterious glow in the mountains nearby. Could it be the missing piece of the prophecy?",
    inkwell: true,
    colors: ["amethyst"],
    cost: 2,
    strength: 3,
...
export const tickTockEverPresentPursuer = {
    id: "sq0",
    name: "Tick-Tock",
    ...
    flavour: "That cursed beast liked the taste of me so well he's followed me ever since... − Captain Hook",
    inkwell: true,
    colors: ["amethyst"],
    cost: 6,
    strength: 4,
...
export const ursulaMadSeaWitch = {
    id: "l0q",
    name: "Ursula",
    title: "Mad Sea Witch",
    ...
    flavour: "After her, Flotsam! I can't rule Lorcana without the Hexwell Crown!",
    inkwell: true,
    colors: ["amethyst"],
    cost: 2,
    strength: 1,
...
export const ursulaSeaWitchQueen = {
    id: "k0n",
    name: "Ursula",
...
export const criKeeLuckyCricket = {
    id: "ep2",
    missingTestCase: true,
    name: "Cri-Kee",
    title: "Lucky Cricket",
...
export const diabloDevotedHerald = {
    id: "hxs",
    name: "Diablo",
    ...
    abilities: [
        ...
        ], "Diablo", "**Shift: Discard an action card** _(You may discard an action card to play this on top of one of your characters named Diablo.)_"),
...
export const diabloMaleficentsSpy = {
    id: "b9t",
    name: "Diablo",
    ...
    flavour: "Keep an eye on the sea witch, my pet. Tell me everything. −Maleficent",
    inkwell: true,
    colors: ["emerald"],
    cost: 1,
    strength: 1,
...
export const guntherInteriorDesigner = {
    id: "n20",
    missingTestCase: true,
    name: "Gunther",
...
export const gusChampionOfCheese = {
    id: "zja",
    name: "Gus",
...
export const hadesDoubleDealer = {
    id: "pib",
    missingTestCase: true,
    name: "Hades",
    title: "Double Dealer",
...
export const heiheiBumblingRooster = {
    id: "rmn",
    name: "Heihei",
...
export const heraQueenOfTheGods = {
    id: "qp0",
    name: "Hera",
...
export const jaqConnoisseurOfClimbing = {
    id: "d8y",
    name: "Jaq",
...
export const jasmineDesertWarrior = {
    id: "g9b",
    missingTestCase: true,
    name: "Jasmine",
...
export const megaraCaptivatingCynic = {
    id: "spm",
    name: "Megara",
...
export const megaraLiberatedOne = {
    id: "dpb",
    name: "Megara",
    title: "Liberated One",
    characteristics: ["storyborn", "ally"],
...
export const painImmortalSidekick = {
    id: "yj2",
    name: "Pain",
    title: "Immortal Sidekick",
    characteristics: ["storyborn", "ally"],
    type: "character",
    flavour: "We totally took care of that thing you told us to do and definitely did not spend the day in Thebes ticketing chariots and stealing people's laundry.",
    inkwell: true,
    colors: ["emerald"],
    cost: 3,
    strength: 2,
...
export const panicImmortalSidekick = {
    id: "eii",
    missingTestCase: true,
    name: "Panic",
    title: "Immortal Sidekick",
    ...
    flavour: "We absolutely took care of that thing, boss. No problems, just great.",
    inkwell: true,
    colors: ["emerald"],
    cost: 4,
    strength: 3,
...
export const pegasusCloudRacer = {
    id: "p3p",
    name: "Pegasus",
    title: "Cloud Racer",
    characteristics: ["floodborn", "ally"],
...
export const pegasusGiftForHercules = {
    id: "lp3",
    name: "Pegasus",
...
export const princePhillipVanquisherOfFoes = {
    id: "dh6",
    missingTestCase: true,
    name: "Prince Phillip",
...
export const princePhillipWardenOfTheWoods = {
    id: "xq2",
    missingTestCase: true,
    name: "Prince Phillip",
...
export const theFatesOnlyOneEye = {
    id: "k7n",
    missingTestCase: true,
    name: "The Fates",
    title: "Only One Eye",
...
export const theMusesProclaimersOfHeroes = {
    id: "sir",
    missingTestCase: true,
    name: "The Muses",
...
export const zeusMrLightningBolts = {
    id: "qfh",
    name: "Zeus",
...
export const beastWounded = {
    ...
    flavour: "It wasn't the severity of the wounds but the sickly substance that caused such unbearable pain.",
    inkwell: true,
    colors: ["ruby"],
    cost: 3,
    strength: 2,
...
export const faZhouMulansFather = {
    id: "ex8",
    missingTestCase: true,
    name: "Fa Zhou",
...
export const flynnRiderFrenemy = {
    id: "n71",
    name: "Flynn Rider",
    title: "Frenemy",
    characteristics: ["hero", "storyborn", "prince"],
    ...
    flavour: '"You guys look busy − I\'ll just keep an eye on this lore for you."',
    inkwell: true,
    colors: ["ruby"],
    cost: 2,
    strength: 2,
...
export const herculesClumsyKid = {
    id: "gyy",
    name: "Hercules",
    title: "Clumsy Kid",
    characteristics: ["hero", "storyborn", "prince"],
...
export const herculesDaringDemigod = {
    id: "fk3",
    name: "Hercules",
...
export const khanBelovedSteed = {
    id: "e8z",
    name: "Khan",
    title: "Beloved Steed",
    characteristics: ["storyborn", "ally"],
    type: "character",
    flavour: "As silent as a shadow and faster than the wind: brave Khan, the mightiest stallion.",
    inkwell: true,
    colors: ["ruby"],
    cost: 2,
    strength: 3,
...
export const liShangGeneralsSon = {
    id: "e9z",
    name: "Li Shang",
    title: "General's Son",
    characteristics: ["hero", "storyborn"],
    type: "character",
    flavour: "His training was unsurpassed, but it was his courage that would see him through this fight.",
    inkwell: true,
    colors: ["ruby"],
    cost: 1,
    strength: 2,
...
export const liShangValorousGeneral = {
    id: "wyb",
    name: "Li Shang",
    ...
    abilities: [
        ...
        ], "Li Shang", "**Shift: Discard a character card**"),
        {
            type: "static",
            ability: "effects",
...
export const lumiereFieryFriend = {
    id: "tok",
    name: "Lumiere",
    title: "Fiery Friend",
    characteristics: ["dreamborn", "ally"],
    ...
    flavour: "The invaders are at our gates, mes amis! It's time to show them what we're made of.",
    inkwell: true,
    colors: ["ruby"],
    cost: 2,
    strength: 2,
...
export const mulanEnemyOfEntanglement = {
    id: "ums",
    name: "Mulan",
...
export const mulanInjuredSoldier = {
    id: "kry",
    name: "Mulan",
...
export const namaariHeirOfFang = {
    id: "mnr",
    name: "Namaari",
    title: "Heir of Fang",
...
export const nessusRiverGuardian = {
    id: "qof",
    name: "Nessus",
    title: "River Guardian",
    characteristics: ["storyborn", "villain"],
    type: "character",
    flavour: "He sent the eels away when they came with the sea witch's offer. He didn't need her help making trouble.",
    inkwell: true,
    colors: ["ruby"],
    cost: 6,
    strength: 7,
...
export const pegasusFlyingSteed = {
    id: "u8h",
    name: "Pegasus",
    title: "Flying Steed",
...
export const rayaFierceProtector = {
    id: "bcw",
    name: "Raya",
...
export const rayaGuardianOfTheDragonGem = {
    id: "cbs",
    missingTestCase: true,
    name: "Raya",
...
export const sisuDaringVisitor = {
    id: "npe",
    missingTestCase: true,
    name: "Sisu",
...
export const sisuEmboldenedWarrior = {
    id: "m8s",
    name: "Sisu",
    ...
    flavour: "Sometimes the only way to fight the unimaginable is with the incredible.",
    inkwell: true,
    colors: ["ruby"],
    cost: 3,
    strength: 1,
...
export const sisuEmpoweredSibling = {
    id: "vbb",
    name: "Sisu",
...
export const tukTukLivelyPartner = {
    id: "fjt",
    name: "Tuk Tuk",
...
export const annaBravingTheStorm = {
    id: "mij",
    missingTestCase: true,
    name: "Anna",
    ...
    flavour: "After talking to Olaf, Anna marched into the unexpected storm to save Kristoff.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 2,
    strength: 1,
...
export const annaTrueHearted = {
    ...
    flavour: "Make sure you know what's truly important and be willing to fight for it.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 4,
    strength: 2,
...
export const arielTreasureCollector = {
    id: "stn",
    name: "Ariel",
...
export const auroraLoreGuardian = {
    id: "i4c",
    name: "Aurora",
    title: "Lore Guardian",
...
export const auroraTranquilPrincess = {
    id: "pdt",
    name: "Aurora",
...
export const flounderCollectorsCompanion = {
    id: "ti7",
    name: "Flounder",
...
export const hadesMeticulousPlotter = {
    id: "d5u",
    name: "Hades",
    title: "Meticulous Plotter",
    characteristics: ["villain", "deity"],
    type: "character",
    flavour: "On this cute little plot Ursula tentacles are sold a mile away. That sneaky sea witch… Wait! I can use this thing. While you keep those hateful Illumineers busy, I can carry out my plan.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 4,
    strength: 3,
...
export const hansNobleScoundrel = {
    id: "zqc",
    missingTestCase: true,
    name: "Hans",
    ...
    flavour: "Hans was confident he could bring Anna to Ursula — all he needed was something of Kristoff's to lure her in.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 3,
    strength: 3,
...
export const idunaCaringMother = {
    id: "oj8",
    name: "Iduna",
    title: "Caring Mother",
    ...
    flavour: "Come my darling, homeward bound\nWhen all is lost, then all is found.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 4,
    strength: 3,
...
export const johnSilverTerrorOfTheRealm = {
    id: "he7",
    name: "John Silver",
    title: "Terror of the Realm",
    characteristics: ["dreamborn", "alien", "villain", "pirate", "captain"],
    type: "character",
    flavour: "There are strange things on the edge of the map: sea witches, entangled glimmers, and so on. I ll stick with my ship, thank you very much.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 8,
    strength: 8,
...
export const olafCarrotEnthusiast = {
    id: "om0",
    name: "Olaf",
    ...
    abilities: [
        ...
        ], "Olaf", "**Shift: Discard an item card** _(You may discard an item card to play this on top of one of your characters named Olaf.)_"),
        wheneverQuests({
            optional: true,
...
export const olafTrustingCompanion = {
    id: "tln",
    name: "Olaf",
    ...
    type: "character",
    abilities: [supportAbility],
    flavour: "Isn't this Kristoff's hat? If he went this way, he'll be caught in that storm!",
    inkwell: true,
    colors: ["sapphire"],
    cost: 1,
    strength: 1,
...
export const pascalInquisitivePet = {
    id: "smc",
    name: "Pascal",
    ...
    flavour: "If you want to find something hidden, get someone who's an expert at hiding.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 3,
    strength: 3,
...
export const princePhillipGallantDefender = {
    id: "emu",
    missingTestCase: true,
    name: "Prince Phillip",
...
export const rapunzelAppreciativeArtist = {
    id: "jzp",
    missingTestCase: true,
    name: "Rapunzel",
...
export const scuttleExpertOnHumans = {
    id: "r46",
    name: "Scuttle",
...
export const sisuWiseFriend = {
    id: "lgb",
    name: "Sisu",
    title: "Wise Friend",
    characteristics: ["hero", "storyborn", "dragon", "deity"],
    type: "character",
    flavour: "It may feel impossible, but sometimes, you just have to take the first step, even before you're ready.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 6,
    strength: 6,
...
export const transformedChefCastleStove = {
    id: "szw",
    missingTestCase: true,
...
export const tritonChampionOfAtlantica = {
    id: "igf",
    missingTestCase: true,
    name: "Triton",
...
export const tritonDiscerningKing = {
    id: "w33",
    missingTestCase: true,
    name: "Triton",
...
export const tritonYoungPrince = {
    id: "wlm",
    name: "Triton",
    title: "Young Prince",
    ...
    abilities: [
        ...
        duringYourTurnGains("Superior Swimmer", "During your turn, this character gains **Evasive**. _(They can challenge characters with Evasive.)_", evasiveAbility),
    ],
    inkwell: true,
    colors: ["sapphire"],
    cost: 4,
...
export const tukTukCuriousPartner = {
    id: "un6",
    name: "Tuk Tuk",
...
export const aladdinBraveRescuer = {
    id: "gf4",
    name: "Aladdin",
    title: "Brave Rescuer",
    characteristics: ["hero", "floodborn"],
    ...
    abilities: [
        ...
        ], "Aladdin", "**Shift: Discard a location card** _(You may discard a location card to play this on top of one of your characters named Aladdin.)"),
        wheneverQuests({
            optional: true,
...
export const aladdinResoluteSwordsman = {
    id: "i0q",
    name: "Aladdin",
    title: "Resolute Swordsman",
    characteristics: ["hero", "storyborn"],
    type: "character",
    flavour: "How about we get straight to the part where I leave quickly and you scream after me? No? I can't say I didn't give you a chance.",
    inkwell: true,
    colors: ["steel"],
    cost: 1,
    strength: 1,
...
export const argesTheCyclops = {
    id: "gam",
    name: "Arges",
    title: "The Cyclops",
    characteristics: ["storyborn", "titan"],
    type: "character",
    flavour: "Looks like you got some big feelings there, buddy−let's stomp 'em out!",
    inkwell: true,
    colors: ["steel"],
    cost: 2,
    strength: 4,
...
export const arielDeterminedMermaid = {
    id: "ov6",
    name: "Ariel",
...
export const arielSonicWarrior = {
    id: "v5n",
    missingTestCase: true,
    name: "Ariel",
    title: "Sonic Warrior",
...
export const beastThickSkinned = {
    id: "xyo",
    name: "Beast",
    title: "Thick-Skinned",
    characteristics: ["hero", "storyborn", "prince"],
...
export const chiFuImperialAdvisor = {
    id: "jnk",
    missingTestCase: true,
    name: "Chi-Fu",
    ...
    flavour: "You , there! Keep that fighting away from here! It is imperative that I write to the Emperor.",
    inkwell: true,
    colors: ["steel"],
    cost: 3,
    strength: 0,
...
export const chienPoImperialSoldier = {
    id: "ml5",
    name: "Chien-Po",
...
export const donaldDuckBuccaneer = {
    id: "vz0",
    name: "Donald Duck",
    title: "Buccaneer",
...
export const herculesBelovedHero = {
    id: "o9h",
    name: "Hercules",
    title: "Beloved Hero",
    characteristics: ["hero", "storyborn", "prince"],
...
export const lefouOpportunisticFlunky = {
    id: "at9",
    name: "Lefou",
...
export const liShangImperialCaptain = {
    id: "z2e",
    name: "Li Shang",
    title: "Imperial Captain",
    characteristics: ["hero", "dreamborn", "captain"],
    type: "character",
    flavour: "Immovable as a mountain and fierce as a dragon-the Empire's finest warrior.",
    inkwell: true,
    colors: ["steel"],
    cost: 5,
    strength: 5,
...
export const lingImperialSoldier = {
    id: "mp1",
    missingTestCase: true,
    name: "Ling",
    title: "Imperial Soldier",
...
export const luisaMadrigalRockOfTheFamily = {
    id: "yza",
    name: "Luisa Madrigal",
...
export const magicBroomAerialCleaner = {
    id: "t2t",
    missingTestCase: true,
    name: "Magic Broom",
    ...
    type: "character",
    abilities: [
        duringYourTurnGains("WINGED FOR A DAY", "During your turn, this character gains **Evasive**. _(They can challenge characters with Evasive.)_", evasiveAbility),
    ],
    flavour: "It spends its days keeping the treasured glimmers in the Hall of Lorcana sparkling clean.",
    inkwell: true,
    colors: ["steel"],
    cost: 2,
    strength: 2,
...
export const magicBroomBrigadeCommander = {
    id: "arp",
    missingTestCase: true,
    name: "Magic Broom",
...
export const mickeyMousePlayfulSorcerer = {
    id: "i3q",
    name: "Mickey Mouse",
...
export const mickeyMouseStandardBearer = {
    id: "pqw",
    name: "Mickey Mouse",
...
export const mulanArmoredFighter = {
    id: "v1e",
    name: "Mulan",
    title: "Armored Fighter",
    characteristics: ["hero", "storyborn", "princess"],
    type: "character",
    flavour: "Maybe what I really wanted was to prove I could do things right, so when I looked in the mirror, I'd see someone worthwhile.",
    inkwell: true,
    colors: ["steel"],
    cost: 4,
    strength: 3,
...
export const philoctetesNoNonsenseInstructor = {
    id: "onn",
    name: "Philoctetes",
...
export const pigletSturdySwordsman = {
    id: "gau",
    name: "Piglet",
...
export const rajahRoyalProtector = {
    id: "sf3",
    missingTestCase: true,
    name: "Rajah",
...
export const rayaUnstoppableForce = {
    id: "db2",
    missingTestCase: true,
    name: "Raya",
...
export const yaoImperialSoldier = {
    id: "wch",
    name: "Yao",
    title: "Imperial Soldier",
    characteristics: ["storyborn", "ally"],
...
export const yenSidPowerfulSorcerer = {
    id: "hvf",
    name: "Yen Sid",
