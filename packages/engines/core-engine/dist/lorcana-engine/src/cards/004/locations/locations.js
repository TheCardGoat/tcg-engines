...
import { allOpposingCharacters, chosenCharacter, self, thisCharacter, thisLocation, } from "@lorcanito/lorcana-engine/abilities/targets";
import { whenThisCharacterBanishedInAChallenge } from "@lorcanito/lorcana-engine/abilities/whenAbilities";
import { wheneverACharacterQuestsWhileHere, wheneverBanishesAnotherCharacterInChallenge, wheneverChallengesAnotherChar, } from "@lorcanito/lorcana-engine/abilities/wheneverAbilities";
import { healEffect, returnThisCardToHand, youGainLore, } from "@lorcanito/lorcana-engine/effects/effects";
import { propertyStaticAbilities } from "../../../abilities/propertyStaticAbilities";
export const snugglyDucklingDisreputablePub = {
    id: "ut6",
...
export const thebesTheBigOlive = {
    id: "pph",
    name: "Thebes",
    title: "The Big Olive",
    characteristics: ["location"],
...
export const theWallBorderFortress = {
    id: "w4d",
    name: "The Wall",
...
export const arielsGrottoASecretPlace = {
    id: "ip4",
    name: "Ariel's Grotto",
...
export const winterCampMedicalTent = {
    id: "ppi",
...
export const trainingGroundsImpossiblePillar = {
    id: "c0i",
    missingTestCase: true,
...
export const ursulasGardenFullOfTheUnfortunate = {
    id: "bh5",
...
export const hiddenCoveTranquilHaven = {
    id: "s5s",
    name: "Hidden Cove",
...
export const ursulasLairEyeOfTheStorm = {
    id: "tj7",
    missingTestCase: true,
    name: "Ursula's Lair",
...
export const casaMadrigalCasita = {
    id: "x5c",
    missingTestCase: true,
    name: "Casa Madrigal",
    title: "Casita",
...
export const theUnderworldRiverStyx = {
    id: "ez0",
    missingTestCase: true,
    name: "The Underworld",
    title: "River Styx",
...
export const atlanticaConcertHall = {
    id: "xt0",
    name: "Atlantica",
    title: "Concert Hall",
    characteristics: ["location"],
