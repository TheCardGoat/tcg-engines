...
import { chosenCharacter, chosenCharacterItemOrLocation, opposingCharactersWithEvasive, opposingCharactersWithoutEvasive, } from "@lorcanito/lorcana-engine/abilities/target";
import { allYourCharacters, anyNumberOfChosenCharacters, chosenCharacterOfYours, self, thisCharacter, topCardOfYourDeck, yourCharacters, } from "@lorcanito/lorcana-engine/abilities/targets";
import { wheneverChallengesAnotherChar } from "@lorcanito/lorcana-engine/abilities/wheneverAbilities";
import { banishChosenCharacterOfYours, banishChosenOpposingCharacter, chosenCharacterCantChallengeDuringNextTurn, chosenCharacterGainsEvasive, chosenCharacterGainsRecklessDuringNextTurn, chosenCharacterGainsResist, chosenCharacterGainsRush, chosenCharacterOfYoursGainsChallengerX, chosenCharacterOfYoursGainsWhenBanishedReturnToHand, dealDamageEffect, drawACard, drawCardsUntilYouHaveSameNumberOfCardsAsOpponent, drawXCards, putCardFromYourHandOnTheTopOfYourDeck, readyAndCantQuest, youGainLore, } from "@lorcanito/lorcana-engine/effects/effects";
export const tryEverything = {
    id: "vjj",
...
export const healingTouch = {
    ...
    flavour: "The heart is not so easily changed, but the head can be persuaded.\n—Grand Pabbie",
    inkwell: true,
    colors: ["amber"],
    cost: 3,
...
export const blastFromYourPast = {
    id: "zt6",
...
export const invitedToTheBallAction = {
    id: "lnv",
    missingTestCase: true,
...
export const gatheringKnowledgeAndWisdom = {
    id: "uuj",
    missingTestCase: true,
    ...
    flavour: "Just think! All this knowledge was under our noses the whole time. We only had to look in the right place.",
    colors: ["amethyst"],
    cost: 2,
...
export const hypnoticDeduction = {
    id: "z2p",
    ...
    flavour: "A security device! Easily defeated, of course. Once I make room for the crown, I... can... bring... it... to... him.",
    inkwell: true,
    colors: ["emerald"],
    cost: 2,
...
export const nightHowlerRage = {
    ...
    flavour: '"I think someone is targeting predators on purpose and making them go savage!" \n−Judy Hopps',
    inkwell: true,
    colors: ["emerald"],
    cost: 3,
...
export const rememberWhoYouAre = {
    id: "jps",
    missingTestCase: true,
...
export const evilComesPrepared = {
    id: "xc5",
    missingTestCase: true,
...
export const dontLetTheFrostbiteBite = {
    id: "rdl",
    missingTestCase: true,
...
export const glimmerVsGlimmer = {
    ...
    flavour: 'Hades: "Listen, kid. If I’m gettin’ banished back to the lorebook, you’re going with me."\nHercules: "We’ll see about that."',
    colors: ["ruby"],
    cost: 4,
...
export const visionOfTheFuture = {
    id: "aks",
    missingTestCase: true,
    ...
    flavour: "We must repair the Illuminary before it’s too late. And we’ll need these devices, these chromicons, to fix it.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 2,
...
export const whenWillMyLifeBegin = {
    id: "a04",
