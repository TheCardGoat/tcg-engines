import { atTheEndOfOpponentTurn, atTheStartOfYourTurn, } from "@lorcanito/lorcana-engine/abilities/atTheAbilities";
import { chosenItemOfYours } from "@lorcanito/lorcana-engine/abilities/target";
import { chosenCardFromYourHand, chosenCharacter, eachOfYourCharacters, opponent, self, yourCharacters, } from "@lorcanito/lorcana-engine/abilities/targets";
import { whenYouPlayThisForEachYouPayLess, whenYourOtherCharactersIsBanished, } from "@lorcanito/lorcana-engine/abilities/whenAbilities";
import { chosenCharacterGainsResist, chosenCharacterGetLoreThisTurn, dealDamageToChosenCharacter, drawACard, entersPlayExerted, opponentLoseLore, revealTopOfDeckPutInHandOrDeck, youGainLore, } from "@lorcanito/lorcana-engine/effects/effects";
export const healingDecanterItem = {
    id: "t6p",
...
export const queensSensorCoreItem = {
    id: "rj3",
...
export const amberChromiconItem = {
    id: "ny4",
    missingTestCase: true,
...
export const amethystChromicon = {
    id: "onp",
    missingTestCase: true,
...
export const princeJohnsMirror = {
    id: "l9o",
...
export const emeraldChromiconItem = {
    id: "ewm",
...
export const medalOfHeroes = {
    ...
    flavour: "You have etched in the rock of virtue a legacy beyond compare.\n–General Hologram",
    inkwell: true,
    colors: ["sapphire"],
    cost: 2,
...
export const sapphireChromicon = {
    id: "f9o",
    missingTestCase: true,
...
export const shieldOfArendelle = {
    id: "ws0",
...
export const basilsMagnifyingGlass = {
    id: "q09",
    missingTestCase: true,
