import { bodyguardAbility, challengerAbility, charactersWithCostXorLessCantChallenge, duringYourTurnGains, evasiveAbility, madameMimAbility, moveDamageAbility, recklessAbility, resistAbility, reverseChallenge, rushAbility, shiftAbility, singerAbility, supportAbility, voicelessAbility, wardAbility, yourOtherCharactersWithGain, } from "@lorcanito/lorcana-engine/abilities/abilities";
import { atTheEndOfYourTurn, atTheStartOfYourTurn, } from "@lorcanito/lorcana-engine/abilities/atTheAbilities";
import { youHaveItemInPlay, youHaveLocationInPlay, } from "@lorcanito/lorcana-engine/abilities/conditions";
import { chosenCharacter, chosenCharacterOrLocation, chosenOpposingCharacter, yourOtherCharacters, } from "@lorcanito/lorcana-engine/abilities/target";
import { chosenCharacterOfYours, chosenDamagedCharacter, chosenOtherCharacterOfYours, self, thisCharacter, withCostXorLess, } from "@lorcanito/lorcana-engine/abilities/targets";
import { whenMovesToALocation, whenPlayAndWhenLeaves, whenThisCharacterBanished, whenYouPlayThis, whenYouPlayThisForEachYouPayLess, } from "@lorcanito/lorcana-engine/abilities/whenAbilities";
import { wheneverBanishesAnotherCharacterInChallenge, wheneverChallengesAnotherChar, wheneverOneOfYourCharChallengesAnotherChar, wheneverOpposingCharIsBanishedInChallenge, wheneverQuests, wheneverTargetPlays, wheneverYouPlayAnotherPrincess, wheneverYouPlayASong, wheneverYouReadyThisCharacter, } from "@lorcanito/lorcana-engine/abilities/wheneverAbilities";
import { whileConditionThisCharacterGets, whileThisCharacterHasDamageGets, whileYouHaveACharacterNamedThisCharGains, whileYouHaveACharacterNamedThisCharGets, } from "@lorcanito/lorcana-engine/abilities/whileAbilities";
import { banishChosenItem, banishChosenItemOrLocation, banishChosenOpposingCharacter, chosenOpposingCharacterLoseStrengthUntilNextTurn, dealDamageEffect, discardYourHand, drawACard, drawCardsUntilYouHaveSameNumberOfCardsAsOpponent, drawXCards, eachOpponentLosesXLore, exertAllOpposingCharacters, exertedCharCantReadyNextTurn, moveDamageEffect, opponentAsResponderExertOneOfTheirReadyCharacters, opponentCantPlayActions, opponentCharactersLoseStrengthUntilNextTurn, opponentDrawXCards, putChosenCardFromYourHandIntoYourInkwellExerted, putOneOnTheTopAndTheOtherOnTheBottomOfYourDeck, putTopCardOfYourDeckIntoYourInkwellExerted, readyAndCantQuestOrChallenge, readyThisCharacter, returnCardToHand, returnCharacterFromDiscardToHand, returnThisCardToHand, revealTopOfDeckPutInHandOrDeck, untilTheEndOfYourNextTurn, youGainLore, youPayXLessToPlayNextActionThisTurn, } from "@lorcanito/lorcana-engine/effects/effects";
export const kodaTalkativeCub = {
    notImplemented: true,
    id: "ftx",
...
export const nalaMischievousCub = {
    id: "wow",
    name: "Nala",
...
export const princeNaveenUkulelePlayer = {
    id: "mnj",
    name: "Prince Naveen",
...
export const ruttNorthernMoose = {
    id: "l3d",
    name: "Rutt",
...
export const kenaiBigBrother = {
    ...
    flavour: "You have to look after your little brother, no matter how big a pain he is.\n—Kenai",
    inkwell: true,
    colors: ["amber"],
    cost: 2,
    strength: 1,
...
export const vanellopeVonSchweetzSugarRushChamp = {
    id: "huy",
    name: "Vanellope von Schweetz",
    title: "Sugar Rush Champ",
    characteristics: ["hero", "storyborn", "princess", "racer"],
    type: "character",
    flavour: "Look, the code may say I'm a princess, but I know who I really am....",
    inkwell: true,
    colors: ["amber"],
    cost: 1,
    strength: 2,
...
export const tukeNorthernMoose = {
    id: "lu2",
    name: "Tuke",
    title: "Northern Moose",
    characteristics: ["storyborn", "ally"],
...
export const liloJuniorCakeDecorator = {
    id: "yur",
    name: "Lilo",
...
export const vanellopeVonSchweetzCandyMechanic = {
    id: "pvk",
    name: "Vanellope Von Schweetz",
...
export const fixitFelixJrTrustyBuilder = {
    id: "r49",
...
export const gazellePopStar = {
    ...
    flavour: "Good evening, Lorcana! We are here tonight to celebrate the possibilities that open up when we unite.",
    inkwell: true,
    colors: ["amber"],
    cost: 3,
    strength: 2,
...
export const fixitFelixJrNicelandSteward = {
    id: "vqf",
    name: "Fix‐It Felix, Jr.",
...
export const kristoffReindeerKeeper = {
    id: "g08",
    name: "Kristoff",
...
export const mirabelMadrigalFamilyGatherer = {
    id: "bjy",
...
export const minnieMouseDrumMajor = {
    id: "p4a",
    name: "Minnie Mouse",
    title: "Drum Major",
    characteristics: ["hero", "floodborn"],
...
export const daisyDuckDonaldsDate = {
    id: "x3z",
    name: "Daisy Duck",
    title: "Donald's Date",
    characteristics: ["storyborn", "ally"],
...
export const fixitFelixJrDelightedSightseer = {
    id: "m45",
    name: "Fix‐It Felix, Jr.",
...
export const moanaDeterminedExplorer = {
    id: "sc1",
    name: "Moana",
    title: "Determined Explorer",
    characteristics: ["hero", "storyborn", "princess"],
    type: "character",
    flavour: "Investigate every part of the Illuminary, find the chromicons, restore the Illuminary, how hard can it–wait, what was that noise?",
    colors: ["amber"],
    cost: 3,
    strength: 3,
    willpower: 4,
...
export const vanellopeVonSchweetzSugarRushPrincess = {
    id: "tiv",
    name: "Vanellope von Schweetz",
...
export const alanadaleRockinRooster = {
    id: "srn",
    missingTestCase: true,
    name: "Alan-a-Dale",
    ...
    flavour: "Thank you! Now here's a little ditty for our floodborn friends that we call 'Martin and the Flood'.",
    inkwell: true,
    colors: ["amber"],
    cost: 4,
    strength: 2,
...
const targetPrincesInYourDiscard = {
    type: "card",
    value: 1,
    filters: [
        { filter: "type", value: "character" },
...
export const wreckitRalphAdmiralUnderpants = {
    id: "cso",
    name: "Wreck-It Ralph",
...
export const maidMarianLadyOfTheLists = {
    id: "wd5",
    name: "Maid Marian",
...
export const svenReindeerSteed = {
    id: "xe9",
    name: "Sven",
...
export const minnieMouseCompassionateFriend = {
    id: "our",
    missingTestCase: true,
    name: "Minnie Mouse",
...
export const maleficentFearsomeQueen = {
    id: "ffi",
    missingTestCase: true,
    name: "Maleficent",
...
export const theNokkMythicalSpirit = {
    id: "abr",
    missingTestCase: true,
    name: "The Nokk",
...
export const cogsworthIlluminaryWatchman = {
    id: "xha",
    missingTestCase: true,
    name: "Cogsworth",
...
export const archimedesExasperatedOwl = {
    id: "fyr",
    name: "Archimedes",
    ...
    flavour: "Hmph. What does an owl have to do to get a little peace and quite around here?",
    inkwell: true,
    colors: ["amethyst"],
    cost: 3,
    strength: 2,
...
export const bruniFireSalamander = {
    id: "dbe",
    missingTestCase: true,
    name: "Bruni",
...
export const earthGiantLivingMountain = {
    id: "k6x",
    name: "Earth Giant",
...
export const whiteRabbitRoyalHerald = {
    id: "xbh",
    name: "White Rabbit",
    title: "Royal Herald",
    characteristics: ["storyborn", "ally"],
    type: "character",
    flavour: '"Oh me, oh my! Did a piece just fall off the Illuminary?! I’ve got to tell someone before it’s too late, late, late!"',
    inkwell: true,
    colors: ["amethyst"],
    cost: 3,
    strength: 3,
...
export const luisaMadrigalEntertainingMuscle = {
    id: "odc",
    name: "Luisa Madrigal",
...
export const annaMysticalMajesty = {
    id: "e80",
    name: "Anna",
...
export const archimedesElectrifiedOwl = {
    id: "p40",
    name: "Archimedes",
...
export const elsaTheFifthSpirit = {
    id: "pm7",
    name: "Elsa",
...
export const genieMainAttraction = {
    id: "a9u",
    name: "Genie",
...
export const olafHappyPassenger = {
    id: "j4c",
    name: "Olaf",
...
export const maleficentVexedPartygoer = {
    id: "ejq",
    missingTestCase: true,
    name: "Maleficent",
...
export const monstroWhaleOfAWhale = {
    id: "rdj",
    name: "Monstro",
    title: "Whale of a Whale",
    characteristics: ["storyborn"],
    type: "character",
    flavour: "The great beast breached the surface of the Azurite Sea, and the cry went out, Monstro! Monstro!",
    inkwell: true,
    colors: ["amethyst"],
    cost: 5,
    strength: 5,
...
export const magicaDeSpellCruelSorceress = {
    id: "how",
...
export const maleficentVengefulSorceress = {
    id: "may",
    name: "Maleficent",
    title: "Vengeful Sorceress",
    characteristics: ["sorcerer", "storyborn", "villain"],
    type: "character",
    flavour: "Evidently my invitation was lost. How dreadful. Here, let me help with the decorations...",
    inkwell: true,
    colors: ["amethyst"],
    cost: 2,
    strength: 2,
...
export const rafikiShamanDuelist = {
    id: "qke",
    name: "Rafiki",
...
export const annaEagerAcolyte = {
    ...
    flavour: "Okay, I can totally move small stuff. I need something bigger... Where's Kristoff's sled?",
    inkwell: true,
    colors: ["amethyst"],
    cost: 3,
    strength: 1,
...
export const kingOfHeartsMonarchOfWonderland = {
    id: "ss4",
    missingTestCase: true,
    name: "King of Hearts",
...
export const camiloMadrigalFamilyCopycat = {
    id: "oxz",
...
export const robinHoodTimelyContestant = {
    id: "abw",
    name: "Robin Hood",
...
export const shenziScarsAccomplice = {
    id: "b08",
    missingTestCase: true,
    name: "Shenzi",
    ...
    abilities: [
        ...
        challengerAbility(2),
        // {
        //   name: "**EASY PICKINGS** While challenging a damaged character, this character gets +2 {S}.",
        // },
    ],
    inkwell: true,
    colors: ["emerald"],
...
export const littleJohnCampCook = {
    id: "olq",
    name: "Little John",
    title: "Camp Cook",
    characteristics: ["storyborn", "ally"],
    type: "character",
    flavour: "You're in for a real treat, Rob. Tonight's house special is my famous outlaw grub. Made from the finest whatever we could find!",
    inkwell: true,
    colors: ["emerald"],
    cost: 1,
    willpower: 4,
...
export const zazuAdvisorToMufasa = {
    id: "g60",
    name: "Zazu",
...
export const floraGoodFairy = {
    ...
    flavour: "Don't fuss, dear! A flick of the wrist will turn these briars into something beautiful.",
    inkwell: true,
    colors: ["emerald"],
    cost: 3,
    strength: 2,
...
export const merryweatherGoodFairy = {
    id: "xjs",
    name: "Merryweather",
    title: "Good Fairy",
    characteristics: ["storyborn", "ally", "fairy"],
...
export const robinHoodArcheryContestant = {
    id: "by3",
    missingTestCase: true,
    name: "Robin Hood",
...
export const faunaGoodFairy = {
    id: "y9h",
    name: "Fauna",
    title: "Good Fairy",
    characteristics: ["storyborn", "ally", "fairy"],
    type: "character",
    flavour: "The secret to a good cake is combining everything just right. Every ingredient is important, but the magic is in how they work together.",
    inkwell: true,
    colors: ["emerald"],
    cost: 5,
    strength: 3,
...
export const banzaiVoraciousPredator = {
    id: "q8r",
    name: "Banzai",
...
export const edHystericalPartygoer = {
    id: "tsa",
    missingTestCase: true,
    name: "Ed",
...
export const scroopOdiousMutineer = {
    id: "ig9",
    name: "Scroop",
...
export const princePhillipSwordsmanOfTheRealm = {
    id: "yrg",
    missingTestCase: true,
    name: "Prince Phillip",
...
export const clarabelleLightOnHerHooves = {
    id: "xzi",
    name: "Clarabelle",
...
export const annaDiplomaticQueen = {
    id: "x1z",
    name: "Anna",
...
export const clarabelleClumsyGuest = {
    id: "ws8",
    missingTestCase: true,
    name: "Clarabelle",
    title: "Clumsy Guest",
...
export const banzaiTauntingHyena = {
    id: "qgg",
    name: "Banzai",
...
export const robinHoodSneakySleuth = {
    id: "d17",
    missingTestCase: true,
    name: "Robin Hood",
    title: "Sneaky Sleuth",
...
export const motherGothelConceitedManipulator = {
    id: "frm",
    name: "Mother Gothel",
...
export const clarabelleContentedWallflower = {
    id: "qp1",
    missingTestCase: true,
    name: "Clarabelle",
...
export const motherGothelUnwaveringSchemer = {
    id: "uis",
    missingTestCase: true,
    name: "Mother Gothel",
...
export const taffytaMuttonfudgeRuthlessRival = {
    id: "smx",
    name: "Taffyta Muttonfudge",
    title: "Ruthless Rival",
    characteristics: ["storyborn", "ally", "racer"],
    type: "character",
    flavour: "There’s not a glimmer that can keep up with me. You might as well quit now.",
    inkwell: true,
    colors: ["ruby"],
    cost: 2,
    strength: 2,
...
export const wrechitRalphDemolitionDude = {
    id: "lpn",
    name: "Wreck-It Ralph",
...
export const maximusTeamChampion = {
    id: "cw2",
    name: "Maximus",
    title: "Team Champion",
    characteristics: ["storyborn", "ally"],
...
export const donaldDuckPieSlinger = {
    id: "t57",
    name: "Donald Duck",
    title: "Pie Slinger",
...
export const rancisFluggerbutterChocolateCharger = {
    id: "kcc",
    name: "Rancis Fluggerbutter",
    title: "Chocolate Charger",
    characteristics: ["storyborn", "ally", "racer"],
    type: "character",
    flavour: "Ingredients: Butter, sugar, unsweetened chocolate, vanilla, and arrogance.",
    inkwell: true,
    colors: ["ruby"],
    cost: 4,
    strength: 4,
...
export const snowannaRainbeauCoolCompetitor = {
    id: "ibm",
...
export const daisyDuckSpotlessFoodfighter = {
    id: "r79",
    name: "Daisy Duck",
...
export const mickeyMouseEnthusiasticDancer = {
    id: "giv",
    missingTestCase: true,
    name: "Mickey Mouse",
...
export const ratiganRagingRat = {
    ...
    flavour: "The world’s most diabolical genius should never suffer such indignities!",
    inkwell: true,
    colors: ["ruby"],
    cost: 3,
    strength: 1,
...
export const taffytaMuttonfudgeCrowdFavorite = {
    id: "a55",
    name: "Taffyta Muttonfudge",
...
export const denahiAvengingBrother = {
    id: "bt9",
    name: "Denahi",
    title: "Avenging Brother",
    characteristics: ["storyborn"],
    type: "character",
    flavour: "You’ll pay for what you’ve done! I’ll track you all the way to the Azurite Sea if I have to!",
    colors: ["ruby"],
    cost: 5,
    strength: 7,
    willpower: 5,
...
export const peteSteamboatRival = {
    id: "r5l",
    name: "Pete",
...
export const taffytaMuttonfudgeSourSpeedster = {
    id: "hep",
    missingTestCase: true,
    name: "Taffyta Muttonfudge",
...
export const robinHoodSharpshooter = {
    id: "zti",
    name: "Robin Hood",
    title: "Sharpshooter",
    characteristics: ["hero", "storyborn"],
...
export const gastonPureParagon = {
    id: "pzz",
    name: "Gaston",
    title: "Pure Paragon",
    characteristics: ["dreamborn", "villain"],
...
export const petePastryChomper = {
    id: "yv6",
    name: "Pete",
    title: "Pastry Chomper",
    characteristics: ["storyborn", "villain"],
    type: "character",
    flavour: "His half-baked scheme to whisk away the food almost worked. But in the end, he got his just desserts.",
    inkwell: true,
    colors: ["ruby"],
    cost: 3,
    strength: 4,
...
export const arthurNoviceSparrow = {
    id: "b3l",
    name: "Arthur",
...
export const donaldDuckDaisysDate = {
    id: "thl",
    name: "Donald Duck",
    title: "Daisy's Date",
    characteristics: ["storyborn", "ally"],
...
export const ratiganPartyCrasher = {
    id: "enx",
    missingTestCase: true,
    name: "Ratigan",
    title: "Party Crasher",
...
export const vanellopeVonSchweetzRandomRosterRacer = {
    id: "zv7",
    name: "Vanellope von Schweetz",
...
export const simbaAdventurousSuccessor = {
    id: "y3p",
    missingTestCase: true,
    name: "Simba",
...
export const minnieMouseDazzlingDancer = {
    id: "z2q",
    missingTestCase: true,
    name: "Minnie Mouse",
...
export const kingCandySovereignOfSugar = {
    id: "v25",
    name: "King Candy",
    title: "Sovereign of Sugar",
    characteristics: ["storyborn", "villain", "king"],
    type: "character",
    flavour: "My sweet subjects, I can without a pinch of hesitation assure you that I have never been so happy.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 1,
    strength: 2,
...
export const chacaImpressiveDaughter = {
    id: "ioz",
    name: "Chaca",
...
export const theQueenCruelestOfAll = {
    id: "mjg",
    name: "The Queen",
    ...
    flavour: "She’d seen what the ink could do for other glimmers. What could it do for her?",
    inkwell: true,
    colors: ["sapphire"],
    cost: 2,
    willpower: 4,
...
export const scroogeMcduckAficionadoOfAntiquities = {
    id: "vq1",
    name: "Scrooge McDuck",
    title: "Afficionado of Antiquities",
    characteristics: ["hero", "storyborn"],
    type: "character",
    flavour: "The secret room should be right here! Ach, I cannot believe I paid a whole penny for this map.",
    colors: ["sapphire"],
    cost: 4,
    strength: 5,
    willpower: 5,
...
export const princeJohnOpportunisticBriber = {
    id: "xu2",
    name: "Prince John",
...
export const merlinBackFromTheBermudas = {
    id: "tbu",
    name: "Merlin",
...
export const pachaEmperorsGuide = {
    id: "jw7",
    missingTestCase: true,
    name: "Pacha",
...
export const theQueenFairestOfAll = {
    id: "de9",
    name: "The Queen",
...
export const sheriffOfNottinghamBushelBritches = {
    id: "e7d",
...
export const chichaDedicatedMother = {
    id: "lux",
    name: "Chicha",
...
export const princeJohnGoldLover = {
    id: "vxl",
    missingTestCase: true,
    name: "Prince John",
    title: "Gold Lover",
...
export const theQueenCrownOfTheCouncil = {
    id: "lr0",
    name: "The Queen",
...
export const kuzcoSelfishEmperor = {
    id: "v40",
    name: "Kuzco",
...
export const mufasaRulerOfPrideRock = {
    id: "rlb",
    name: "Mufasa",
...
export const ludwigVonDrakeSelfproclaimedGenius = {
    id: "hbw",
    name: "Ludwig Von Drake",
    title: "Self-Proclaimed Genius",
    characteristics: ["storyborn", "ally"],
    type: "character",
    flavour: "So you see, there’s a dark void at the edge of Lorcana. A complete absence of electromagnetic radiation! What’s it made of? I don’t know! The light’s just gone. Kaput!",
    inkwell: true,
    colors: ["sapphire"],
    cost: 5,
    strength: 4,
...
export const minnieMouseQuickthinkingInventor = {
    id: "zsf",
    missingTestCase: true,
    name: "Minnie Mouse",
...
export const basilPracticedDetective = {
    id: "orz",
    name: "Basil",
...
export const kingCandySweetAbomination = {
    id: "puc",
    name: "King Candy",
...
export const donaldDuckFocusedFlatfoot = {
    id: "ulv",
    name: "Donald Duck",
    ...
    flavour: '"There’s just gotta be one of those chromi-thingies around here somewhere!"',
    inkwell: true,
    colors: ["sapphire"],
    cost: 5,
    strength: 3,
...
export const merlinIntellectualVisionary = {
    id: "cmp",
    missingTestCase: true,
    name: "Merlin",
...
export const stitchTeamUnderdog = {
    id: "ovo",
    missingTestCase: true,
    name: "Stitch",
    title: "Team Underdog",
    ...
    flavour: "He's not the biggest glimmer on the team, but he still packs a wallop.",
    colors: ["steel"],
    cost: 4,
    strength: 1,
    willpower: 4,
...
export const jafarTyrannicalHypnotist = {
    id: "c2a",
    name: "Jafar",
...
export const rudyGrooveDisrupter = {
    id: "jrg",
    name: "Rudy",
    title: "Groove Disrupter",
    characteristics: ["storyborn"],
    type: "character",
    flavour: "The Illuminary can’t handle this much groove! We have to keep the noise down or it’ll fall apart for sure!",
    inkwell: true,
    colors: ["steel"],
    cost: 1,
    strength: 2,
...
export const royalGuardBovineProtector = {
    id: "dua",
    name: "Royal Guard",
...
export const mickeyMouseFoodFightDefender = {
    id: "xff",
    name: "Mickey Mouse",
...
export const sleepySluggishKnight = {
    id: "zvc",
    name: "Sleepy",
...
export const kronkUnlicensedInvestigator = {
    id: "ylc",
    name: "Kronk",
    ...
    flavour: "Maybe this one’s a chromicon. Probably not. I really should have paid more attention when that wizard guy was talking . . .",
    inkwell: true,
    colors: ["steel"],
    cost: 2,
    strength: 1,
...
export const heiheiProtectiveRooster = {
    id: "l2b",
    name: "HeiHei",
...
export const sneezyNoisyKnight = {
    id: "tkh",
    missingTestCase: true,
    name: "Sneezy",
    title: "Noisy Knight",
...
export const dopeyKnightApprentice = {
    id: "hwb",
    missingTestCase: true,
    name: "Dopey",
...
export const namaariResoluteDaughter = {
    id: "p4n",
    name: "Namaari",
...
export const snowWhiteFairhearted = {
    id: "s09",
    missingTestCase: true,
    name: "Snow White",
    title: "Fair-Hearted",
...
export const yzmaUnjustlyTreated = {
    id: "pdd",
    missingTestCase: true,
    name: "Yzma",
    ...
    flavour: "What do you mean, 'not on the list'?! I told you to always put me on the list!",
    colors: ["steel"],
    cost: 4,
    strength: 1,
    willpower: 4,
...
export const kronkHeadOfSecurity = {
    id: "y86",
    missingTestCase: true,
    name: "Kronk",
...
export const grumpySkepticalKnight = {
    id: "fmq",
    missingTestCase: true,
    name: "Grumpy",
    ...
    abilities: [
        ...
        // },
        duringYourTurnGains("BURST OF SPEED", "During your turn, this character gains **Evasive**. _(They can challenge characters with Evasive.)_", evasiveAbility),
    ],
    inkwell: true,
    colors: ["steel"],
    cost: 3,
...
export const peteWrestlingChamp = {
    id: "uuo",
    name: "Pete",
...
export const sirEctorCastleLord = {
    id: "q1j",
    name: "Sir Ector",
    title: "Castle Lord",
    characteristics: ["storyborn", "knight"],
    type: "character",
    flavour: "Well, by Jove. Don't just stand there. Raise a glass to my son Kay... and may we be rid of the trickster wizard Marvin, or whatever his blasted name was.",
    colors: ["steel"],
    cost: 7,
    strength: 7,
    willpower: 10,
...
export const bashfulAdoringKnight = {
    id: "q7u",
    missingTestCase: true,
    name: "Bashful",
...
export const arthurWart = {
    id: "szj",
    name: "Arthur",
    title: "Wart",
    characteristics: ["hero", "storyborn"],
    type: "character",
    flavour: "That boy's get real spark. Lots of spirit. Throws himself heart and soul into everything he does.\n−Merlin",
    inkwell: true,
    colors: ["steel"],
    cost: 2,
    strength: 2,
...
export const happyLivelyKnight = {
    id: "kw2",
    name: "Happy",
    title: "Lively Knight",
    characteristics: ["dreamborn", "ally", "knight", "seven dwarfs"],
...
export const arthurKingVictorious = {
    id: "l90",
    name: "Arthur",
