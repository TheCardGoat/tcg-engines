import { bodyguardAbility, challengerAbility, duringYourTurnGains, duringYourTurnWheneverBanishesCharacterInChallenge, evasiveAbility, moveDamageAbility, recklessAbility, resistAbility, rushAbility, shiftAbility, singerAbility, supportAbility, wardAbility, } from "@lorcanito/lorcana-engine/abilities/abilities";
import { atTheEndOfYourTurn, atTheStartOfYourTurn, } from "@lorcanito/lorcana-engine/abilities/atTheAbilities";
import { ifThisCharacterIsExerted, ifYouHaveCharacterNamed, unlessItIsAtALocation, whileCharacterIsAtLocation, whileThisCharacterIsExerted, } from "@lorcanito/lorcana-engine/abilities/conditions/conditions";
import { allOtherCharactersHere, chosenItemOfYours, chosenItemOfYoursInHand, chosenOpposingCharacter, yourOtherCharacters, } from "@lorcanito/lorcana-engine/abilities/target";
import { allOpposingCharacters, chosenCharacter, chosenCharacterOfYours, opponent, self, thisCharacter, withCostXorLess, yourBanishedItems, } from "@lorcanito/lorcana-engine/abilities/targets";
import { whenChallenged, whenChallengedAndBanished, whenMovesToALocation, whenPlayAndWheneverQuests, whenThisCharacterBanished, whenThisCharacterBanishedInAChallenge, whenXIsBanished, whenYouPlayThisForEachYouPayLess, whenYourOtherCharactersIsBanished, } from "@lorcanito/lorcana-engine/abilities/whenAbilities";
import { wheneverBanishesAnotherCharacterInChallenge, wheneverChallengesAnotherChar, wheneverOpposingCharIsBanishedInChallenge, wheneverPlays, wheneverQuests, wheneverThisCharIsDamaged, wheneverThisCharSings, wheneverYouDiscardACard, wheneverYouDrawACard, wheneverYouPlayALocation, wheneverYouPlayASong, } from "@lorcanito/lorcana-engine/abilities/wheneverAbilities";
import { thisMissionIsCursed, whileCharacterIsAtLocationItGains, whileCharacterIsAtLocationItGets, whileConditionThisCharacterGets, whileThisCharacterHasDamageGets, whileThisCharacterHasNoDamageGets, whileYouHaveACharacterNamedThisCharGets, } from "@lorcanito/lorcana-engine/abilities/whileAbilities";
import { banishChallengingCharacter, banishChosenCharacter, chosenCharacterCantChallengeDuringNextTurn, dealDamageEffect, discardACard, discardTwoCards, drawACard, drawXCards, entersPlayExerted, exertChosenCharacter, exertedCharCantReadyNextTurn, healEffect, lookAtTopCardOfYourDeckAndPutItOnTopOrBottom, opponentRevealHand, putOneOnTheTopAndTheOtherOnTheBottomOfYourDeck, putThisCardIntoYourInkwellExerted, putTopCardOfYourDeckIntoYourInkwellExerted, readyAndCantQuest, readyChosenCharacter, readyThisCharacter, removeDamageEffect, returnChosenOpposingCharacterWithStrength, revealTopOfDeckPutInHandOrDeck, shuffleThisCardIntoYourDeck, youGainLore, youPayXLessToPlayNextCharThisTurn, youPayXLessToPlayNextItemThisTurn, } from "@lorcanito/lorcana-engine/effects/effects";
import { propertyStaticAbilities } from "../../../abilities/propertyStaticAbilities";
export const pigletPoohPirateCaptain = {
    id: "ojq",
    name: "Piglet",
...
export const mamaOdieVoiceOfWisdom = {
    id: "l0k",
...
export const peterPanLostBoyLeader = {
    id: "twu",
    name: "Peter Pan",
    ...
    flavour: "The Illumineers needed someone to find a missing spellbook, and Peter was the first to volunteer.",
    inkwell: true,
    colors: ["emerald"],
    cost: 4,
    strength: 3,
...
export const wendyDarlingAuthorityOnPeterPan = {
    id: "s1z",
    name: "Wendy Darling",
...
export const eeyoreOverstuffedDonkey = {
    id: "jrd",
    name: "Eeyore",
...
export const minnieMouseFunkySpelunker = {
    id: "h35",
    name: "Minnie Mouse",
...
export const bernardBrandNewAgent = {
    id: "bzq",
    missingTestCase: true,
    name: "Bernard",
...
export const joshuaSweetTheDoctor = {
    id: "xtr",
    missingTestCase: true,
    name: "Joshua Sweet",
    title: "The Doctor",
    ...
    flavour: "Heading out to the Inklands? Come on back if youu need patching up.",
    inkwell: true,
    colors: ["amber"],
    cost: 4,
    strength: 1,
...
export const kidaProtectorOfAtlantis = {
    id: "v6h",
    name: "Kida",
...
export const missBiancaInternationalRescueAidSocietyAgent = {
    id: "a8k",
    name: "Miss Bianca",
    ...
    flavour: "Our society has never failed to answer a call for help.\nThe Chairman",
    inkwell: true,
    colors: ["amber"],
    cost: 2,
    strength: 2,
...
export const naniProtectiveSister = {
    id: "nyd",
    name: "Nani",
...
export const orvilleFlyingAce = {
    id: "e1z",
    name: "Orville",
    title: "Ace Pilot",
    characteristics: ["storyborn", "ally"],
    type: "character",
    flavour: "Damn, look at the speed of these machines!\nWhat do you call that again? Ink Runners?\nI wish I could fly like that.",
    inkwell: true,
    colors: ["amber"],
    cost: 2,
    strength: 1,
...
export const patchIntimidatingPup = {
    id: "inf",
    missingTestCase: true,
    name: "Patch",
...
export const perditaDevotedMother = {
    id: "sl2",
    name: "Perdita",
...
export const plutoDeterminedDefender = {
    id: "oqn",
    missingTestCase: true,
    name: "Pluto",
...
export const plutoFriendlyPooch = {
    id: "rp5",
    name: "Pluto",
...
export const pongoDeterminedFather = {
    id: "eo3",
    name: "Pongo",
...
export const queenOfHeartsWonderlandEmpress = {
    id: "art",
...
export const tinkerBellGenerousFairy = {
    id: "rnw",
    name: "Tinker Bell",
...
export const wendyDarlingTalentedSailor = {
    id: "f05",
    name: "Wendy Darling",
    title: "Talented Sailor",
    characteristics: ["hero", "dreamborn"],
    type: "character",
    flavour: "With Tink's upgrades in place, Wendy took them to the skies to find the missing mermaid.",
    inkwell: true,
    colors: ["amber"],
    cost: 2,
    strength: 1,
...
export const aliceTeaAlchemist = {
    id: "c9l",
    name: "Alice",
    title: "Tea Alchemist",
    ...
    flavour: "With the right tea leaves and a little magic, she creates the perfect cup for any party guest.",
    inkwell: true,
    colors: ["amethyst"],
    cost: 6,
    strength: 4,
...
export const diabloLoyalFamiliar = {
    id: "gz4",
    missingTestCase: true,
    name: "Diablo",
    title: "Faithful Pet",
...
export const genieSupportiveFriend = {
    id: "u24",
    name: "Genie",
    ...
    flavour: "Right here, direct from the lamp, right here for your very much wish fulfillment.",
    colors: ["amethyst"],
    cost: 4,
    strength: 3,
    willpower: 5,
...
export const jafarStrikingIllusionist = {
    id: "wle",
    name: "Jafar",
...
export const chernabogsFollowersCreaturesOfEvil = {
    id: "qjz",
...
export const lenaSabrewingRebelliousTeenager = {
    id: "u44",
    name: "Lena Sabrewing",
...
export const magicBroomDancingDuster = {
    id: "bvg",
    missingTestCase: true,
    name: "Magic Broom",
...
export const magicBroomSwiftCleaner = {
    id: "iwx",
    name: "Magic Broom",
    title: "Swift Cleaner",
    characteristics: ["dreamborn", "broom"],
...
export const magicaDeSpellAmbitiousWitch = {
    id: "nia",
    name: "Magica De Spell",
    title: "Ambitious Witch",
    characteristics: ["sorcerer", "storyborn", "villain"],
    type: "character",
    flavour: "Feed my power, Dark Eclipse. Free my form from the abyss. Dormant magic now unchain, the Shadow Queen be whole again!",
    inkwell: true,
    colors: ["amethyst"],
    cost: 2,
    strength: 2,
...
export const magicaDeSpellTheMidasTouch = {
    id: "i5n",
    name: "Magica De Spell",
    ...
    flavour: "I can feel my powers growing the closer I get to Scrooge's precious dime!",
    colors: ["amethyst"],
    cost: 7,
    strength: 4,
    lore: 0,
...
export const magicaDeSpellThievingSorceress = {
    id: "ioe",
    missingTestCase: true,
    name: "Magica De Spell",
...
export const maleficentMistressOfEvil = {
    id: "su0",
    missingTestCase: true,
    name: "Maleficent",
...
export const puaPotbelliedBuddy = {
    id: "eni",
    missingTestCase: true,
    name: "Pua",
...
export const balooVonBruinwaldXiii = {
    id: "p52",
    missingTestCase: true,
    name: "Baloo",
...
export const chernabogEvildoer = {
    id: "zif",
    name: "Chernabog",
    title: "Evildoer",
...
export const luckyThe_15thPuppy = {
    id: "n2h",
    missingTestCase: true,
    name: "Lucky",
...
export const minnieMouseMusicalArtist = {
    id: "ptc",
    name: "Minnie Mouse",
...
export const mrSnoopsIneptBusinessman = {
    id: "d9e",
    name: "Mr. Snoops",
    title: "Inept Businessman",
    characteristics: ["dreamborn", "ally"],
    type: "character",
    flavour: "This is simple, Snoops! I want that lore! The one that shines like a diamond! \n–Madame Medusa",
    inkwell: true,
    colors: ["amber"],
    strength: 4,
    willpower: 8,
...
export const magicBroomTheBigSweeper = {
    id: "huj",
    name: "Magic Broom",
...
export const magicCarpetFlyingRug = {
    id: "a0f",
    name: "Magic Carpet",
    title: "Flying Rug",
    characteristics: ["storyborn", "ally"],
    ...
    flavour: "Carpet and I can swoop in, grab the lore, and be back before anyone knows it! \n–Aladdin",
    inkwell: true,
    colors: ["amethyst"],
    strength: 2,
    willpower: 1,
...
export const rafikiMysticalFighter = {
    id: "foa",
    missingTestCase: true,
    name: "Rafiki",
...
export const stratosTornadoTitan = {
    id: "rck",
    missingTestCase: true,
    name: "Stratos",
    title: "Tornado Titan",
...
export const treasureGuardianProtectorOfTheCave = {
    id: "bma",
    missingTestCase: true,
...
export const friarTuckPriestOfNottingham = {
    id: "hlb",
    name: "Friar Tuck",
...
export const kitCloudkickerToughGuy = {
    id: "dgd",
    missingTestCase: true,
...
export const stitchCovertAgent = {
    id: "i0l",
    missingTestCase: true,
    name: "Stitch",
    title: "Covert Agent",
...
export const billyBonesKeeperOfTheMap = {
    id: "e3j",
    name: "Billy Bones",
    title: "Keeper of the Map",
    characteristics: ["alien", "storyborn", "pirate"],
    type: "character",
    flavour: "He's after me chest, that fiendish cyborg and his band of cutthroats.",
    inkwell: true,
    colors: ["ruby"],
    strength: 6,
    willpower: 5,
...
export const captainAmeliaFirstInCommand = {
    id: "efm",
    missingTestCase: true,
    name: "Captain Amelia",
    ...
    type: "character",
    abilities: [
        duringYourTurnGains("Discipline", "During your turn, this character gains **Evasive**. _(They can challenge characters with Evasive.)_", evasiveAbility),
    ],
    flavour: "I've spotted a strange structure on the horizon. Hard to port, helmsman!",
    inkwell: true,
    colors: ["sapphire"],
    strength: 1,
    willpower: 5,
...
export const genieCrampedInTheLamp = {
    id: "wg4",
    name: "Genie",
...
export const kitCloudkickerNavigator = {
    id: "j9c",
    name: "Kit Cloudkicker",
    title: "Navigator",
    characteristics: ["floodborn", "ally"],
...
export const kitCloudkickerSpunkyBearCub = {
    id: "f03",
    name: "Kit Cloudkicker",
...
export const plutoMickeysCleverFriend = {
    id: "es5",
    name: "Pluto",
    title: "Mickey's Clever Friend",
    characteristics: ["dreamborn", "ally"],
    type: "character",
    flavour: "Pluto's job was to keep Gustav's attention so Minnie could get to the cave.",
    inkwell: true,
    colors: ["sapphire"],
    strength: 3,
    willpower: 4,
...
export const scroogeMcduckUncleMoneybags = {
    id: "twh",
    missingTestCase: true,
    name: "Scrooge McDuck",
    ...
    flavour: "A strange new world is the perfect place to make a strange new fortune!",
    inkwell: true,
    colors: ["sapphire"],
    strength: 1,
    willpower: 3,
...
export const theQueenMirrorSeeker = {
    id: "hmg",
    name: "The Queen",
    title: "Mirror Seeker",
...
export const gustavTheGiantTerrorOfTheKingdom = {
    id: "irs",
...
export const johnSilverGreedyTreasureSeeker = {
    id: "lzb",
    name: "John Silver",
...
export const mickeyMouseStalwartExplorer = {
    id: "pon",
    missingTestCase: true,
    name: "Mickey Mouse",
    ...
    flavour: "Mickey knew just where to start searching for the Sorcerer's Hat, but he didn't expect it to be guarded.",
    inkwell: true,
    colors: ["steel"],
    strength: 3,
    willpower: 3,
...
export const mufasaChampionOfThePrideLands = {
    id: "er8",
    name: "Mufasa",
...
export const razoulPalaceGuard = {
    id: "mui",
    name: "Razoul",
    title: "Palace Guard",
...
export const cubbyMightyLostBoy = {
    id: "zfd",
    missingTestCase: true,
    name: "Cubby",
    ...
    flavour: "With Peter holding off Hook, Cubby did what he does best: break stuff.",
    inkwell: true,
    colors: ["emerald"],
    cost: 4,
    strength: 3,
...
export const cursedMerfolkUrsulasHandiwork = {
    id: "pr9",
    missingTestCase: true,
    name: "Cursed Merfolk",
    ...
    flavour: "Now it’s happened once or twice, someone couldn’t pay the price . . . \n–Ursula",
    colors: ["emerald"],
    cost: 1,
    willpower: 1,
    lore: 2,
...
export const donKarnagePiratePrince = {
    id: "d3j",
    name: "Don Karnage",
    ...
    type: "character",
    abilities: [evasiveAbility],
    flavour: "You never thought you’d find me here, right? To be honest, neither did I.",
    inkwell: true,
    colors: ["emerald"],
    cost: 5,
    strength: 4,
...
export const helgaSinclairFemmeFatale = {
    id: "y4a",
    missingTestCase: true,
    name: "Helga Sinclair",
    title: "Femme Fatale",
...
export const helgaSinclairVengefulPartner = {
    id: "ytw",
    missingTestCase: true,
    name: "Helga Sinclair",
...
export const lyleTiberiusRourkeCunningMercenary = {
    id: "ssp",
...
export const miloThatchCleverCartographer = {
    id: "gpo",
    name: "Milo Thatch",
...
export const miloThatchKingOfAtlantis = {
    id: "vpk",
    missingTestCase: true,
    name: "Milo Thatch",
...
export const princeJohnFalseKing = {
    id: "aw4",
    name: "Prince John",
    title: "Phony King",
    ...
    flavour: "Incredible as he is inept, whenever the history books are kept… \n–Sheriff of Nottingham",
    colors: ["emerald"],
    cost: 5,
    strength: 2,
    willpower: 4,
...
export const robinHoodDaydreamer = {
    id: "la4",
    name: "Robin Hood",
    title: "Daydreamer",
    characteristics: ["hero", "dreamborn"],
...
export const shenziHyenaPackLeader = {
    id: "jm3",
    missingTestCase: true,
    name: "Shenzi",
...
export const sirHissAggravatingAsp = {
    id: "ymp",
    name: "Sir Hiss",
...
export const skippyEnergeticRabbit = {
    id: "q7c",
    name: "Skippy",
...
export const starkeyDeviousPirate = {
    id: "x83",
    name: "Starkey",
...
export const ursulaDeceiverOfAll = {
    id: "igx",
    name: "Ursula",
...
export const zazuPrideLandsManager = {
    id: "a8c",
    name: "Zazu",
    ...
    flavour: "I’d be lying if I said I was in charge here, but the Pride Lands still welcomes you!",
    inkwell: true,
    colors: ["emerald"],
    cost: 1,
    strength: 2,
...
export const arielAdventurousCollector = {
    id: "ix1",
    name: "Ariel",
...
export const captainHookMasterSwordsman = {
    id: "ult",
    name: "Captain Hook",
...
export const dellaDuckUnstoppableMom = {
    id: "e2w",
    name: "Della Duck",
...
export const heiheiAccidentalExplorer = {
    id: "mjn",
    missingTestCase: true,
    name: "HeiHei",
...
export const hydraDeadlySerpent = {
    id: "ppz",
    name: "Hydra",
    ...
    abilities: [
        wheneverThisCharIsDamaged({
            ...
            effects: [
                dealDamageEffect({ dynamic: true, getAmountFromTrigger: true }, chosenOpposingCharacter),
            ],
        }),
    ],
...
export const jimHawkinsSpaceTraveler = {
    id: "s51",
    name: "Jim Hawkins",
...
export const jimHawkinsThrillSeeker = {
    id: "lmu",
    name: "Jim Hawkins",
    title: "Thrill Seeker",
    characteristics: ["hero", "dreamborn"],
...
export const kakamoraMenacingSailor = {
    id: "zi5",
    name: "Kakamora",
...
export const madameMedusaTheBoss = {
    id: "pp1",
    name: "Madame Medusa",
    title: "The Boss",
    characteristics: ["storyborn", "villain"],
...
export const mauiWingedDemigod = {
    id: "joc",
    name: "Maui",
...
export const miloThatchSpiritedScholar = {
    id: "ork",
    name: "Milo Thatch",
...
export const moanaUndeterredVoyager = {
    id: "shd",
    name: "Moana",
...
export const nutsyVultureHenchman = {
    id: "vqo",
    name: "Nutsy",
...
export const peterPanNeverLandHero = {
    id: "ufv",
    missingTestCase: true,
    name: "Peter Pan",
...
export const princeEricExpertHelmsman = {
    id: "faa",
    missingTestCase: true,
    name: "Prince Eric",
    ...
    flavour: "The storm came out of nowhere, forcing Eric to turn back before he reached the mysterious structure at the edge of Lorcana.",
    colors: ["ruby"],
    cost: 4,
    strength: 2,
    willpower: 2,
...
export const scroopBackstabber = {
    id: "ca8",
    missingTestCase: true,
    name: "Scroop",
    title: "Backstabber",
...
export const stitchLittleRocket = {
    id: "pv2",
    name: "Stitch",
    title: "Little Rocket",
    characteristics: ["hero", "dreamborn", "alien"],
...
export const triggerImpreciseShooter = {
    id: "bjr",
    missingTestCase: true,
    name: "Trigger",
    ...
    flavour: "Criminently, Trigger! Point that peashooter the other way. \n–Sheriff of Nottingham",
    inkwell: true,
    colors: ["ruby"],
    cost: 2,
    strength: 3,
...
export const webbyVanderquackEnthusiasticDuck = {
    id: "t7c",
...
export const audreyRamirezTheEngineer = {
    id: "duu",
    name: "Audrey Ramirez",
    title: "The Engineer",
    characteristics: ["storyborn", "ally"],
...
export const flintheartGlomgoldLoneCheater = {
    id: "z4e",
    missingTestCase: true,
    ...
    type: "character",
    abilities: [
        duringYourTurnGains("THEY'LL NEVER SEE IT COMING!", "During your turn, this character gains **Evasive**. _(They can challenge characters with Evasive.)_", evasiveAbility),
    ],
...
export const grammaTalaKeeperOfAncientStories = {
    id: "e89",
    name: "Gramma Tala",
...
export const grammaTalaSpiritOfTheOcean = {
    id: "ei5",
    name: "Gramma Tala",
    ...
    flavour: "She will always be with you, no matter how far your journey takes you.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 7,
    strength: 4,
...
export const gyroGearlooseGadgetGenius = {
    id: "j4d",
    missingTestCase: true,
    name: "Gyro Gearloose",
    title: "Gadget Whiz",
...
export const kingLouieBandleader = {
    id: "i0k",
    name: "King Louie",
    title: "Bandleader",
...
export const ladyMarianAdorableDreamer = {
    id: "rd4",
    name: "Maid Marian",
...
export const mamaOdieMysticalMaven = {
    id: "c31",
    name: "Mama Odie",
...
export const rufusOrphanageCat = {
    id: "zvd",
    missingTestCase: true,
    name: "Rufus",
    title: "Orphanage Cat",
...
export const scroogeMcduckRichestDuckInTheWorld = {
    id: "cdd",
    missingTestCase: true,
    name: "Scrooge McDuck",
    ...
    abilities: [
        ...
        duringYourTurnGains("I'M GOING HOME!", "During your turn, this character gains **Evasive**. _(They can challenge characters with Evasive.)_", evasiveAbility),
    ],
...
export const tinkerBellVeryCleverFairy = {
    id: "lvr",
    missingTestCase: true,
    name: "Tinker Bell",
...
export const chiefTuiProudOfMotunui = {
    id: "kg5",
    name: "Chief Tui",
...
export const hadesWrathfulRuler = {
    id: "qqe",
    missingTestCase: true,
    name: "Hades",
    ...
    flavour: "Brothers! Titans! Look at you, in your miserable prison. Who put you down there?",
    inkwell: true,
    colors: ["steel"],
    cost: 6,
    strength: 5,
...
export const helgaSinclairRightHandWoman = {
    id: "mag",
    name: "Helga Sinclair",
...
export const littleJohnResourcefulOutlaw = {
    id: "ai0",
    missingTestCase: true,
    name: "Little John",
...
export const littleJohnRobinsCompanion = {
    id: "lkk",
    missingTestCase: true,
    name: "Little John",
    title: "Robin's Pal",
    ...
    abilities: [
        bodyguardAbility,
        duringYourTurnGains("Disguised", "During your turn, this character gains **Evasive**. _(They can challenge characters with Evasive.)_", evasiveAbility),
    ],
    inkwell: true,
    colors: ["steel"],
    cost: 3,
...
export const mickeyMouseTrumpeter = {
    id: "zep",
    missingTestCase: true,
    name: "Mickey Mouse",
    title: "Trumpeter",
...
export const mrSmeeBumblingMate = {
    id: "gpk",
    name: "Mr. Smee",
    title: "Bumbling Mate",
    characteristics: ["storyborn", "pirate", "ally"],
...
export const robinHoodBelovedOutlaw = {
    id: "n4x",
    name: "Robin Hood",
...
export const robinHoodChampionOfSherwood = {
    id: "f1t",
    name: "Robin Hood",
...
export const sheriffOfNottinghamCorruptOfficial = {
    id: "mjo",
    missingTestCase: true,
    ...
    flavour: "The thirteenth Rule of Villainy: Take everything you can, but do it with a smile.",
    colors: ["steel"],
    cost: 4,
    strength: 2,
    willpower: 4,
...
export const simbaFightingPrince = {
    id: "gm1",
    missingTestCase: true,
    name: "Simba",
...
export const simbaRightfulKing = {
    id: "fgi",
    missingTestCase: true,
    name: "Simba",
    title: "Rightful King",
...
export const thaddeusEKlangMetalHead = {
    id: "uvv",
    missingTestCase: true,
...
export const peterPanPiratesBane = {
    id: "wzh",
    missingTestCase: true,
    name: "Peter Pan",
    title: "Pirate’s Bane",
