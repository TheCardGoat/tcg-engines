import { evasiveAbility, gainAbilityWhileHere, resistAbility, rushAbility, wardAbility, } from "@lorcanito/lorcana-engine/abilities/abilities";
import { atTheStartOfYourTurn } from "@lorcanito/lorcana-engine/abilities/atTheAbilities";
import { thisCharacter } from "@lorcanito/lorcana-engine/abilities/targets";
import { whenChallengedAndBanished, whenThisCharacterBanished, } from "@lorcanito/lorcana-engine/abilities/whenAbilities";
import { wheneverQuests } from "@lorcanito/lorcana-engine/abilities/wheneverAbilities";
import { banishChallengingCharacter, putThisCardIntoYourInkwellExerted, youMayDrawThenChooseAndDiscard, } from "@lorcanito/lorcana-engine/effects/effects";
...
export const neverLandMermaidLagoon = {
    id: "waj",
    type: "location",
    name: "Never Land",
    title: "Mermaid Lagoon",
    characteristics: ["location"],
    flavour: "The mermaids told Peter they'd seen some items floating by several days earlier, but they were more concerned that one of their sisters had gone missing.",
    inkwell: true,
    colors: ["amber"],
    cost: 1,
    moveCost: 1,
...
export const prideLandsPrideRock = {
    id: "e1l",
    type: "location",
...
export const tianasPalaceJazzRestaurant = {
    id: "sfq",
    type: "location",
    name: "Tiana's Palace",
...
export const theQueensCastleMirrorChamber = {
    ...
    flavour: "Those who visit the mirror can choose their question−but not the answer.",
    inkwell: true,
    colors: ["amethyst"],
    cost: 4,
    willpower: 7,
...
export const theSorcerersTowerWondrousWorkspace = {
    id: "sen",
    type: "location",
    missingTestCase: true,
...
export const deVilManorCruellasEstate = {
    id: "p6j",
    type: "location",
    name: "De Vil Manor",
    title: "Cruella's Estate",
    characteristics: ["location"],
    flavour: "They say the ol' place is haunted, or bewitched, or some such fiddle-faddle.\n–Colonel",
    inkwell: true,
    colors: ["emerald"],
    cost: 1,
    willpower: 4,
...
export const fangRiverCity = {
    ...
    flavour: "A nation protected by fierce assassins and their even fiercer cats.",
    inkwell: true,
    colors: ["emerald"],
    cost: 4,
    willpower: 6,
...
export const kuzcosPalaceHomeOfTheEmperor = {
    id: "d8d",
    type: "location",
    missingTestCase: true,
    name: "Kuzco's Palace",
...
export const agrabahMarketplace = {
    id: "hjx",
    type: "location",
    name: "Agrabah",
    title: "Marketplace",
    characteristics: ["location"],
    flavour: "Welcome to Agrabah, city of mystery, of enchantment, and the finest merchandise this side of the river. \n–Merchant",
    inkwell: true,
    colors: ["ruby"],
    cost: 3,
    willpower: 5,
...
export const jollyRogerHooksShip = {
    id: "g68",
    type: "location",
    name: "Jolly Roger",
    title: "Hook's Ship",
...
export const rlsLegacySolarGalleon = {
    id: "ok0",
    type: "location",
    name: "RLS Legacy",
    title: "Solar Galleon",
...
export const bellesHouseMauricesWorkshop = {
    id: "rnn",
    type: "location",
    name: "Belle's House",
...
export const motunuiIslandParadise = {
    id: "rqt",
    type: "location",
    missingTestCase: true,
    name: "Motunui",
...
export const mauisPlaceOfExileHiddenIsland = {
    id: "cpd",
    type: "location",
    missingTestCase: true,
...
export const nottinghamPrinceJohnsCastle = {
    id: "jc5",
    type: "location",
    name: "Nottingham",
    title: "Prince John's Castle",
    characteristics: ["location"],
    flavour: "Sir Hiss: I say, ssssire, your mother's castle would be the perfect place to bring our plan to life! \nPrince John: Mummy!",
    inkwell: true,
    colors: ["steel"],
    cost: 2,
    willpower: 6,
...
export const theBayouMysteriousSwamp = {
    id: "tu0",
    type: "location",
    missingTestCase: true,
    name: "The Bayou",
...
export const mcduckManorScroogesMansion = {
    id: "qyj",
    name: "McDuck Manor",
