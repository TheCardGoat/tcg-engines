import { challengerAbility, resistAbility, yourCharactersNamedGain, yourOtherCharactersGet, } from "@lorcanito/lorcana-engine/abilities/abilities";
import { ifYouHaveCharacterNamed } from "@lorcanito/lorcana-engine/abilities/conditions/conditions";
import { chosenCharacter, chosenCharacterOfYours, } from "@lorcanito/lorcana-engine/abilities/target";
import { anyCard, namedCard, self, yourLocationCards, } from "@lorcanito/lorcana-engine/abilities/targets";
import { wheneverACharacterQuests, wheneverOneOfYourCharactersIsBanishedInAChallenge, wheneverOneOfYourCharsQuests, wheneverOpposingCharIsBanishedInChallenge, } from "@lorcanito/lorcana-engine/abilities/wheneverAbilities";
import { discardACard, drawACard, lookAtTopCardOfYourDeckAndPutItOnTopOrBottom, putTopCardOfYourDeckIntoYourInkwellExerted, readyThisItem, returnChosenCharacterWithCostLess, youPayXLessToPlayNextActionThisTurn, youPayXLessToPlayNextCharThisTurn, youPayXLessToPlayNextItemThisTurn, youPayXLessToPlayNextLocationThisTurn, } from "@lorcanito/lorcana-engine/effects/effects";
export const cleansingRainwater = {
    id: "vlr",
...
export const theSorcerersHat = {
    ...
    flavour: "Minnie approached it cautiously. Whoever had placed it here might have prepared traps.",
    inkwell: true,
    colors: ["amethyst"],
    cost: 2,
...
export const sumerianTalisman = {
    ...
    flavour: "Summoned spirit from the dark \nShow thyself before this arc. \n−Lena Sabrewing",
    inkwell: true,
    colors: ["ruby"],
    cost: 3,
...
export const aurelianGyrosensor = {
    id: "zc9",
    missingTestCase: true,
...
export const vaultDoor = {
    ...
    flavour: "Only Scrooge knows about this vault. And he’s going to keep it that way.",
    inkwell: true,
    colors: ["sapphire"],
    cost: 4,
...
export const captainHooksRapier = {
    id: "wmj",
    missingTestCase: true,
...
export const gizmosuit = {
    ...
    flavour: "It stands in the Hall of Lorcana, waiting for someone to speak the secret words.",
    inkwell: true,
    colors: ["steel"],
    cost: 3,
...
export const mapOfTreasurePlanet = {
    id: "x73",
