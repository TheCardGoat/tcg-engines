...
import { duringOpponentsTurn, ifYouHaveACharacterHere, } from "@lorcanito/lorcana-engine/abilities/conditions/conditions";
import { actionCardsInHand } from "@lorcanito/lorcana-engine/abilities/target";
import { allOpposingCharacters, anyCardTargetYouOwn, chosenCharacter, chosenCharacterOrLocation, chosenOpposingCharacter, self, thisCard, thisCharacter, } from "@lorcanito/lorcana-engine/abilities/targets";
import { whenChallenged, whenThisCharacterBanished, whenYouMoveACharacterHere, } from "@lorcanito/lorcana-engine/abilities/whenAbilities";
...
import { dealDamageEffect, discardACard, drawXCards, mayBanish, moveDamageEffect, opponentLoseLore, putTopCardOfYourDeckIntoYourInkwellExerted, youGainLore, } from "@lorcanito/lorcana-engine/effects/effects";
export const galacticCouncilChamber = {
    id: "yrd",
...
export const fairyShipRoyalVessel = {
    id: "bi4",
    name: "Fairy Ship",
    title: "Royal Vessel",
    characteristics: [],
...
export const mysticalTreeMamaOdiesHome = {
    id: "ghp",
...
export const rescueRangersSubmarineMobileHeadquarters = {
    id: "hwj",
...
export const owlIslandSecludedEntrance = {
    id: "ox9",
    name: "Owl Island",
...
export const flotillaCoconutArmada = {
    id: "twz",
    missingTestCase: true,
    name: "Flotilla",
...
export const instituteOfTechnologyPrestigiousUniversity = {
    id: "hsg",
...
export const hundredAcreIslandPoohsHome = {
    id: "qkp",
    missingTestCase: true,
...
export const skullRockIsolatedFortress = {
    id: "sv6",
    missingTestCase: true,
    name: "Skull Rock",
...
export const treasureMountainAzuriteSeaIsland = {
    id: "nmj",
...
export const perilousMazeWateryLabyrinth = {
    id: "jrf",
    name: "Perilous Maze",
