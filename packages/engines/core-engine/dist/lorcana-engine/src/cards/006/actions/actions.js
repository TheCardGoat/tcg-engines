import { chosenCharacter, chosenCharacterOfYours, chosenCharacterOrLocation, chosenOpposingCharacter, self, sourceTarget, thisCharacter, yourCharacters, } from "@lorcanito/lorcana-engine/abilities/targets";
import { whenYouPlayThisForEachYouPayLess } from "@lorcanito/lorcana-engine/abilities/whenAbilities";
import { banishChosenItem, chosenCharacterGainsSupport, chosenOpposingCharacterCantQuestNextTurn, dealDamageEffect, discardACard, discardAllCardsInOpponentsHand, drawACard, drawXCards, exertChosenCharacter, mayBanish, millOpponentXCards, moveDamageEffect, opponentLoseLore, putDamageEffect, readyAndCantQuest, readyChosenCharacter, readyChosenItem, youGainLore, youMayPutAnAdditionalCardFromYourHandIntoYourInkwell, } from "@lorcanito/lorcana-engine/effects/effects";
export const energyBlast = {
    id: "e8s",
...
export const theIslandsIPulledFromTheSea = {
    id: "bnu",
    missingTestCase: true,
...
export const rescueRangersAway = {
    id: "fhc",
...
export const weCouldBeImmortals = {
    id: "nb5",
...
export const aVeryMerryUnbirthday = {
    id: "pfv",
    missingTestCase: true,
...
export const heffalumpsAndWoozles = {
    id: "kml",
...
export const unfortunateSituation = {
    id: "wcu",
    missingTestCase: true,
...
export const seekingTheHalfCrown = {
    id: "fdo",
    missingTestCase: true,
...
export const sailTheAzuriteSea = {
    id: "dwo",
