import { challengerAbility, exertCharCost, resistAbility, yourOtherCharactersGet, } from "@lorcanito/lorcana-engine/abilities/abilities";
...
import { anyTarget, chosenCharacter, chosenCharacterOfYours, chosenDamagedCharacter, eachOfYourCharacters, oneOfYourOpponentsCharactersItemsOrLocations, } from "@lorcanito/lorcana-engine/abilities/targets";
import { wheneverIsReturnedToHand } from "@lorcanito/lorcana-engine/abilities/wheneverAbilities";
import { banishChosenItem, drawACard, enterPlaysExerted, mayBanish, millOpponentXCards, moveToLocation, readyAndCantQuest, removeDamageEffect, returnChosenCharacterWithStrength, revealTopOfDeckPutInHandOrDeck, youGainLore, youMayDrawThenChooseAndDiscard, } from "@lorcanito/lorcana-engine/effects/effects";
export const noRoomNoRoom = {
    type: "activated",
...
export const tenThousandMedicalProcedures = {
    type: "activated",
    costs: [{ type: "exert" }],
    effects: [
        {
...
export const limitlessApplications = {
    type: "resolution",
    name: "Inspired Tech",
