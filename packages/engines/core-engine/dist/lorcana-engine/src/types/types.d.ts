...
import type { HowType, GameEffect as OGGameEffect, Match as OGMatch, Zones } from "@lorcanito/shared/lorcana-engine";
import type { Ability, FloatingTriggeredAbility } from "../abilities/abilities";
import type { ContinuousEffect, ScryEffectPayload } from "../effects/effectTypes";
...
export type Match = OGMatch<Ability, ContinuousEffect, FloatingTriggeredAbility>;
