...
export function whileThisCharacterHasNoDamageGets({ name, text, effects, }) {
    return {
        type: "static",
        ability: "effects",
        effects,
...
export function whileThisCharacterHasNoDamageGains({ name, text, ability, }) {
    return {
        type: "static",
        ability: "gain-ability",
...
export function whileThisCharacterHasDamageGets({ name, text, effects, }) {
    return {
        type: "static",
        ability: "effects",
        effects,
...
export function whileConditionThisCharacterGets({ name, text, effects, conditions, attribute, amount, }) {
    if (attribute && amount) {
        return {
            type: "static",
            ability: "effects",
...
export function whileConditionThisCharacterGains({ name, text, ability, conditions, }) {
...
export function whileNoOtherCharacterHasQuestedThisCharacterGets({ name, text, attribute = "lore", amount = 3, }) {
    return {
        type: "static",
        ability: "effects",
        name,
...
export function whileYouHaveMoreItemsInPlayThanEachOpponentThisCharacterGets({ name, text, attribute, amount, }) {
    return {
        type: "static",
        ability: "effects",
        name,
...
export function whileYouHaveAnotherCharacterInPlayThisCharacterGets({ name, text, attribute = "strength", amount = 2, }) {
    return {
        type: "static",
        ability: "effects",
        name,
...
export function whileYouHaveAnotherCharacterWithCharacteristicThisCharacterGets({ name, text, attribute = "lore", amount = 1, characteristics = ["hero"], minAmount = 2, }) {
    return {
        type: "static",
        ability: "effects",
        name,
...
export function whileConditionOnThisCharacterTargetsGain({ name, text, ability, target, conditions, }) {
...
export function targetCardsGains({ name, text, ability, target, conditions, }) {
    return {
        type: "static",
        ability: "gain-ability",
        gainedAbility: ability,
...
export function whileYouHaveAnotherXCharacteristicInPlayThisCharacterGains({ name, text, ability, characteristics = [], }) {
    return {
        type: "static",
        ability: "gain-ability",
        name: name,
...
export function whileYouHaveNoCardsInHandThisCharacterCanChallengeReadyChars({ name, text, }) {
    return {
        type: "static",
...
export function whileYouHaveNOrMoreCharactersWithNameInPlayThisCharacterGets({ name, text, characterName, amount = 2, attribute = "lore", attributeAmount = 2, }) {
    return {
        type: "static",
        ability: "effects",
        name,
...
export function whileYouHaveACharacterNamedThisCharGains({ name, text, characterName, ability, conditions = [], }) {
    return {
        type: "static",
        ability: "gain-ability",
        target: thisCharacter,
...
export function whileYouHaveACharacterNamedThisCharGets({ name, text, characterName, effects, conditions = [], }) {
    return {
        type: "static",
        ability: "effects",
        name,
...
export function whileYouHaveCharactersHere({ ability, name, text, conditions = [], }) {
    return {
        type: "static",
        ability: "gain-ability",
        target: thisCharacter,
...
export function whileYouHaveNoCaptainsInPlay({ name, text, ability, conditions = [], }) {
    return {
        type: "static",
        ability: "gain-ability",
        target: thisCard,
...
export const thisMissionIsCursed = {
    type: "static",
    ability: "restriction",
    target: thisCharacter,
...
//# sourceMappingURL=whileAbilities.js.map