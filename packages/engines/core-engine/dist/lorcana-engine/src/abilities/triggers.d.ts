...
import type { CardEffectTarget, EffectTargets, PlayerEffectTarget } from "../effects/effectTargets";
import type { TargetFilter } from "../store/resolvers/filters";
export type Trigger = QuestTrigger | ReadyTrigger | ExertTrigger | DiscardTrigger | SingTrigger | DamageTrigger | HealTrigger | OnShiftTrigger | MovesToLocationTrigger | StartTurnTrigger | EndTurnTrigger | OnMoveTrigger | BanishAnotherTrigger | BanishTrigger | DrawTrigger | ChallengeTrigger;
